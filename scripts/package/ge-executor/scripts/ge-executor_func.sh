 ...
 * If you want to use aclmdl api, please install the corresponding package to overwrite this file.
 * */
EOF
...
/*!
 * This is an empty file, included for compatibility with old version.
 * If you want to use aclop api, please install the corresponding package to overwrite this file.
 * */
EOF
    fi
}
