# FetchDataFlowGraph（按索引获取输出FlowMsg）<a name="ZH-CN_TOPIC_0000002130023333"></a>
...
```
Status FetchDataFlowGraph(uint32_t graph_id, const std::vector<uint32_t> &indexes, std::vector<FlowMsgPtr> &outputs,  int32_t timeout)
```
