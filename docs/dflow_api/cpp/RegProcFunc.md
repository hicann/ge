# RegProcFunc<a name="ZH-CN_TOPIC_0000002013837209"></a>
...
<td class="cellrowborder" valign="top" width="44.47%" headers="mcps1.1.4.1.3 "><p id="p79261251819"><a name="p79261251819"></a><a name="p79261251819"></a>多flow func的处理函数，处理函数原型为</p>
<pre class="screen" id="screen79261510171219"><a name="screen79261510171219"></a><a name="screen79261510171219"></a>using CUSTOM_PROC_FUNC = std::function&lt;int32_t(
...
T *, const std::shared_ptr&lt;MetaRunContext&gt; &amp;, const std::vector&lt;std::shared_ptr&lt;FlowMsgQueue&gt;&gt; &amp;)&gt;;</pre>
</td>
</tr>
</tbody>
</table>
