# ResetFlowFuncState（MetaMultiFunc类）<a name="ZH-CN_TOPIC_0000002060369306"></a>
...
<tbody><tr id="zh-cn_topic_0000001304385296_zh-cn_topic_0000001265240866_zh-cn_topic_0182636394_row20315681"><td class="cellrowborder" valign="top" width="27.63%" headers="mcps1.1.4.1.1 "><p id="p14180551208"><a name="p14180551208"></a><a name="p14180551208"></a>params</p>
</td>
...
此接口为虚函数，当用户的FlowFunc未实现ResetFlowFuncState函数时，框架默认返回FLOW\_FUNC\_ERR\_NOT\_SUPPORT（认为当前FlowFunc不支持此操作），把原来创建的FlowFunc删除掉，重新创建一个新的FlowFunc，然后再调用[Init](Init（MetaMultiFunc类）.md)接口进行初始化。
