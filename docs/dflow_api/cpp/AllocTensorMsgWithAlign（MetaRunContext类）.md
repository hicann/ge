# AllocTensorMsgWithAlign（MetaRunContext类）<a name="ZH-CN_TOPIC_0000001977157158"></a>

## 产品支持情况<a name="zh-cn_topic_0000002013837145_section8178181118225"></a>
...
根据shape、data type和对齐大小申请Tensor类型的FlowMsg，与[AllocTensorMsg](AllocTensorMsg（MetaRunContext类）.md)函数区别是AllocTensorMsg默认申请以64字节对齐，此函数可以指定对齐大小，方便性能调优。
