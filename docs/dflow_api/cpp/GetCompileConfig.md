# GetCompileConfig<a name="ZH-CN_TOPIC_0000001977152510"></a>
...
## 函数功能<a name="zh-cn_topic_0000001484611753_zh-cn_topic_0000001265240866_section3729174918713"></a>

获取ProcessPoint编译配置的文件。

## 函数原型<a name="zh-cn_topic_0000001484611753_zh-cn_topic_0000001265240866_section84161445741"></a>

```
const char *GetCompileConfig() const
```

## 参数说明<a name="zh-cn_topic_0000001484611753_zh-cn_topic_0000001265240866_zh-cn_topic_0182636394_section63604780"></a>

无

## 返回值<a name="zh-cn_topic_0000001484611753_zh-cn_topic_0000001265240866_section413535858"></a>

返回ProcessPoint编译配置的文件。

## 异常处理<a name="zh-cn_topic_0000001484611753_zh-cn_topic_0000001265240866_section1548781517515"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001484611753_zh-cn_topic_0000001265240866_section2021419196520"></a>
