# GetDataSize<a name="ZH-CN_TOPIC_0000002013837189"></a>
...
## 函数功能<a name="zh-cn_topic_0000001357384993_zh-cn_topic_0000001265399802_section62999330"></a>

获取Tensor中的数据大小。

## 函数原型<a name="zh-cn_topic_0000001357384993_zh-cn_topic_0000001265399802_section11572115914156"></a>

```
uint64_t *GetDataSize() const
```

## 参数说明<a name="zh-cn_topic_0000001357384993_zh-cn_topic_0000001265399802_section30123063"></a>

无。

## 返回值<a name="zh-cn_topic_0000001357384993_zh-cn_topic_0000001265399802_section2672115"></a>

返回Tensor的数据大小。

## 异常处理<a name="zh-cn_topic_0000001357384993_zh-cn_topic_0000001265399802_section24049039"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001357384993_zh-cn_topic_0000001265399802_section15114764"></a>
