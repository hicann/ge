# Init（MetaMultiFunc类）<a name="ZH-CN_TOPIC_0000002013796693"></a>
...
## 函数功能<a name="zh-cn_topic_0000001304225456_zh-cn_topic_0000001312640893_section3729174918713"></a>

用户自定义flow func的初始化函数。

## 函数原型<a name="zh-cn_topic_0000001304225456_zh-cn_topic_0000001312640893_section84161445741"></a>

```
int32_t Init(const std::shared_ptr<MetaParams> &params)
```

## 参数说明<a name="zh-cn_topic_0000001304225456_zh-cn_topic_0000001312640893_zh-cn_topic_0182636394_section63604780"></a>
...
<tbody><tr id="zh-cn_topic_0000001359389150_zh-cn_topic_0000001312720989_row32073719"><td class="cellrowborder" valign="top" width="27.63%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0000001359389150_zh-cn_topic_0000001312720989_p47834478"><a name="zh-cn_topic_0000001359389150_zh-cn_topic_0000001312720989_p47834478"></a><a name="zh-cn_topic_0000001359389150_zh-cn_topic_0000001312720989_p47834478"></a>MetaParams</p>
</td>
...
<td class="cellrowborder" valign="top" width="46.77%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001359389150_zh-cn_topic_0000001312720989_p29612923"><a name="zh-cn_topic_0000001359389150_zh-cn_topic_0000001312720989_p29612923"></a><a name="zh-cn_topic_0000001359389150_zh-cn_topic_0000001312720989_p29612923"></a>多func处理函数使用的参数信息。</p>
</td>
</tr>
</tbody>
</table>

## 返回值<a name="zh-cn_topic_0000001304225456_zh-cn_topic_0000001312640893_section413535858"></a>

-   0：SUCCESS。
-   other：FAILED，具体请参考[UDF错误码](UDF错误码.md)。

## 异常处理<a name="zh-cn_topic_0000001304225456_zh-cn_topic_0000001312640893_section1548781517515"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001304225456_zh-cn_topic_0000001312640893_section2021419196520"></a>
