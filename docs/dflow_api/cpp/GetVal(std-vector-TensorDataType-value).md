# GetVal\(std::vector<TensorDataType\> &value\)<a name="ZH-CN_TOPIC_0000002013796581"></a>
...
## 函数功能<a name="zh-cn_topic_0000001408818817_zh-cn_topic_0000001312399913_zh-cn_topic_0235751031_section15686020"></a>

获取list TensorDataType类型的属性值。

## 函数原型<a name="zh-cn_topic_0000001408818817_zh-cn_topic_0000001312399913_zh-cn_topic_0235751031_section1610715016501"></a>

```
int32_t GetVal(std::vector<TensorDataType> &value) const = 0
```

## 参数说明<a name="zh-cn_topic_0000001408818817_zh-cn_topic_0000001312399913_zh-cn_topic_0235751031_section6956456"></a>

<a name="zh-cn_topic_0000001408818817_table15371192192515"></a>
<table><thead align="left"><tr id="zh-cn_topic_0000001408818817_row103715232512"><th class="cellrowborder" valign="top" width="32.63%" id="mcps1.1.4.1.1"><p id="zh-cn_topic_0000001408818817_p1537162162513"><a name="zh-cn_topic_0000001408818817_p1537162162513"></a><a name="zh-cn_topic_0000001408818817_p1537162162513"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="26.530000000000005%" id="mcps1.1.4.1.2"><p id="zh-cn_topic_0000001408818817_p8372102182517"><a name="zh-cn_topic_0000001408818817_p8372102182517"></a><a name="zh-cn_topic_0000001408818817_p8372102182517"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="40.84%" id="mcps1.1.4.1.3"><p id="zh-cn_topic_0000001408818817_p163721225254"><a name="zh-cn_topic_0000001408818817_p163721225254"></a><a name="zh-cn_topic_0000001408818817_p163721225254"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0000001408818817_row637212192515"><td class="cellrowborder" valign="top" width="32.63%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0000001408818817_p11729112421011"><a name="zh-cn_topic_0000001408818817_p11729112421011"></a><a name="zh-cn_topic_0000001408818817_p11729112421011"></a>Value</p>
</td>
<td class="cellrowborder" valign="top" width="26.530000000000005%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0000001408818817_p193727215255"><a name="zh-cn_topic_0000001408818817_p193727215255"></a><a name="zh-cn_topic_0000001408818817_p193727215255"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="40.84%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001408818817_p1964710258271"><a name="zh-cn_topic_0000001408818817_p1964710258271"></a><a name="zh-cn_topic_0000001408818817_p1964710258271"></a>获取的list TensorDataType类型属性值。</p>
</td>
</tr>
</tbody>
</table>

## 返回值<a name="zh-cn_topic_0000001408818817_zh-cn_topic_0000001312399913_zh-cn_topic_0235751031_section62608109"></a>

-   0：SUCCESS。
-   other：FAILED，具体请参考[UDF错误码](UDF错误码.md)。

## 异常处理<a name="zh-cn_topic_0000001408818817_zh-cn_topic_0000001264921046_zh-cn_topic_0204328224_zh-cn_topic_0182636384_section51713556"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001408818817_zh-cn_topic_0000001264921046_zh-cn_topic_0204328224_zh-cn_topic_0182636384_section62768825"></a>
