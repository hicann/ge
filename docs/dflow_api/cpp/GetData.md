# GetData<a name="ZH-CN_TOPIC_0000002013796673"></a>
...
## 函数功能<a name="zh-cn_topic_0000001304065496_zh-cn_topic_0000001265399790_section230999"></a>

获取Tensor中的数据。

## 函数原型<a name="zh-cn_topic_0000001304065496_zh-cn_topic_0000001265399790_section13787192971720"></a>

```
void *GetData() const
```

## 参数说明<a name="zh-cn_topic_0000001304065496_zh-cn_topic_0000001265399790_section2078992"></a>

无。

## 返回值<a name="zh-cn_topic_0000001304065496_zh-cn_topic_0000001265399790_section18710936"></a>

返回Tensor中的数据。

## 异常处理<a name="zh-cn_topic_0000001304065496_zh-cn_topic_0000001265399790_section34180703"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001304065496_zh-cn_topic_0000001265399790_section39190879"></a>
