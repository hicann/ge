# GetDataType<a name="ZH-CN_TOPIC_0000001977157114"></a>
...
## 函数功能<a name="zh-cn_topic_0000001304225448_zh-cn_topic_0000001265240878_section28644761"></a>

获取Tensor中的数据类型。

## 函数原型<a name="zh-cn_topic_0000001304225448_zh-cn_topic_0000001265240878_section13475936115113"></a>

```
TensorDataType GetDataType() const
```

## 参数说明<a name="zh-cn_topic_0000001304225448_zh-cn_topic_0000001265240878_section56476259"></a>

无。

## 返回值<a name="zh-cn_topic_0000001304225448_zh-cn_topic_0000001265240878_section38524289"></a>

返回Tensor的数据类型。

## 异常处理<a name="zh-cn_topic_0000001304225448_zh-cn_topic_0000001265240878_section11174282"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001304225448_zh-cn_topic_0000001265240878_section33459681"></a>
