# GetOutputNum（MetaParams类）<a name="ZH-CN_TOPIC_0000001977316858"></a>

## 产品支持情况<a name="zh-cn_topic_0000002013837137_section8178181118225"></a>
...
## 函数功能<a name="zh-cn_topic_0000002013837137_zh-cn_topic_0000001468175517_zh-cn_topic_0000001264921066_section51668594"></a>

获取Flowfunc的输出个数。该函数供[Init（MetaFlowFunc类）](Init（MetaFlowFunc类）.md)调用。

## 函数原型<a name="zh-cn_topic_0000002013837137_zh-cn_topic_0000001468175517_zh-cn_topic_0000001264921066_section45209275152"></a>

```
size_t GetOutputNum() const
```

## 参数说明<a name="zh-cn_topic_0000002013837137_zh-cn_topic_0000001468175517_zh-cn_topic_0000001264921066_section62364163"></a>

无

## 返回值<a name="zh-cn_topic_0000002013837137_zh-cn_topic_0000001468175517_zh-cn_topic_0000001264921066_section24406563"></a>

返回Flowfunc的输出个数。

## 异常处理<a name="zh-cn_topic_0000002013837137_zh-cn_topic_0000001468175517_zh-cn_topic_0000001264921066_section18332482"></a>

无。

## 约束说明<a name="zh-cn_topic_0000002013837137_zh-cn_topic_0000001468175517_zh-cn_topic_0000001264921066_section30774618"></a>
