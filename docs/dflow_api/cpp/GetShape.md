# GetShape<a name="ZH-CN_TOPIC_0000001977316822"></a>
...
## 函数功能<a name="zh-cn_topic_0000001304385288_zh-cn_topic_0000001265240890_section31291646"></a>

获取Tensor的Shape。

## 函数原型<a name="zh-cn_topic_0000001304385288_zh-cn_topic_0000001265240890_section1931219371242"></a>

```
const std::vector<int64_t> &GetShape() const
```

## 参数说明<a name="zh-cn_topic_0000001304385288_zh-cn_topic_0000001265240890_section13189358"></a>

无。

## 返回值<a name="zh-cn_topic_0000001304385288_zh-cn_topic_0000001265240890_section51595365"></a>

返回Tensor的Shape。

## 异常处理<a name="zh-cn_topic_0000001304385288_zh-cn_topic_0000001265240890_section61705107"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001304385288_zh-cn_topic_0000001265240890_section18475057"></a>
