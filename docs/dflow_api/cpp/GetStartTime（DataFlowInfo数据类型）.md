# GetStartTime（DataFlowInfo数据类型）<a name="ZH-CN_TOPIC_0000002013792117"></a>
...
## 函数功能<a name="zh-cn_topic_0000001489189321_zh-cn_topic_0000001409228617_zh-cn_topic_0000001264921066_section51668594"></a>

获取数据的开始时间戳。

## 函数原型<a name="zh-cn_topic_0000001489189321_zh-cn_topic_0000001409228617_zh-cn_topic_0000001264921066_section45209275152"></a>

```
uint64_t GetStartTime() const
```

## 参数说明<a name="zh-cn_topic_0000001489189321_zh-cn_topic_0000001409228617_zh-cn_topic_0000001264921066_section62364163"></a>

无

## 返回值<a name="zh-cn_topic_0000001489189321_zh-cn_topic_0000001409228617_zh-cn_topic_0000001264921066_section24406563"></a>

返回数据的开始时间戳。

## 异常处理<a name="zh-cn_topic_0000001489189321_zh-cn_topic_0000001409228617_zh-cn_topic_0000001264921066_section18332482"></a>

无。

## 约束说明<a name="zh-cn_topic_0000001489189321_zh-cn_topic_0000001409228617_zh-cn_topic_0000001264921066_section30774618"></a>
