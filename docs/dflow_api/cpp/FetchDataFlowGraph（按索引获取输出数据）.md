# FetchDataFlowGraph（按索引获取输出数据）<a name="ZH-CN_TOPIC_0000002013832609"></a>
...
<tr id="zh-cn_topic_0000001365193284_row250143872"><td class="cellrowborder" valign="top" width="27.63%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0000001365193284_p9501431672"><a name="zh-cn_topic_0000001365193284_p9501431672"></a><a name="zh-cn_topic_0000001365193284_p9501431672"></a>indexes</p>
</td>
<td class="cellrowborder" valign="top" width="14.469999999999999%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0000001365193284_p9502331713"><a name="zh-cn_topic_0000001365193284_p9502331713"></a><a name="zh-cn_topic_0000001365193284_p9502331713"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="57.9%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001365193284_p172621356813"><a name="zh-cn_topic_0000001365193284_p172621356813"></a><a name="zh-cn_topic_0000001365193284_p172621356813"></a>输出数据的索引，不可以重复。取值范围是【0~N-1】，N表示输出数据个数。支持一个或者多个。</p>
<p id="zh-cn_topic_0000001365193284_p850213777"><a name="zh-cn_topic_0000001365193284_p850213777"></a><a name="zh-cn_topic_0000001365193284_p850213777"></a>示例：{0,2}，表示获取第一个和第三个输出数据。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.9%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001365193284_p192820481795"><a name="zh-cn_topic_0000001365193284_p192820481795"></a><a name="zh-cn_topic_0000001365193284_p192820481795"></a>计算图输出Tensor，用户无需分配内存空间，执行完成后GE会分配内存并赋值。</p>
</td>
</tr>
<tr id="zh-cn_topic_0000001365193284_row528217481496"><td class="cellrowborder" valign="top" width="27.63%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0000001365193284_p12821648692"><a name="zh-cn_topic_0000001365193284_p12821648692"></a><a name="zh-cn_topic_0000001365193284_p12821648692"></a>info</p>
</td>
<td class="cellrowborder" valign="top" width="14.469999999999999%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0000001365193284_p1528304815918"><a name="zh-cn_topic_0000001365193284_p1528304815918"></a><a name="zh-cn_topic_0000001365193284_p1528304815918"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="57.9%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001365193284_p628374811914"><a name="zh-cn_topic_0000001365193284_p628374811914"></a><a name="zh-cn_topic_0000001365193284_p628374811914"></a>输出数据流标志（flow flag）。具体请参考<a href="DataFlowInfo数据类型.md">DataFlowInfo数据类型</a>。</p>
</td>
</tr>
