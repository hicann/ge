# SetBalanceWeight<a name="ZH-CN_TOPIC_0000001977316898"></a>
...
<td class="cellrowborder" valign="top" width="25.6%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0000001439153142_zh-cn_topic_0000001304065500_zh-cn_topic_0000001312720989_p49387472"><a name="zh-cn_topic_0000001439153142_zh-cn_topic_0000001304065500_zh-cn_topic_0000001312720989_p49387472"></a><a name="zh-cn_topic_0000001439153142_zh-cn_topic_0000001304065500_zh-cn_topic_0000001312720989_p49387472"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="46.77%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001439153142_zh-cn_topic_0000001304065500_zh-cn_topic_0000001312720989_p29612923"><a name="zh-cn_topic_0000001439153142_zh-cn_topic_0000001304065500_zh-cn_topic_0000001312720989_p29612923"></a><a name="zh-cn_topic_0000001439153142_zh-cn_topic_0000001304065500_zh-cn_topic_0000001312720989_p29612923"></a>均衡分发权重信息。</p>
<a name="screen9964812646"></a><a name="screen9964812646"></a><pre class="screen" codetype="Cpp" id="screen9964812646">struct BalanceWeight {
int32_t rowNum = 0;  // 权重矩阵行数
int32_t colNum = 0;   // 权重矩阵列数
const int32_t *matrix = nullptr;  // 权重矩阵，有rowNum行、colNum列的数组，如果值为null，表示是值全为1的矩阵
};</pre>
</td>
</tr>
</tbody>
