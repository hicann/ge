# numpy<a name="ZH-CN_TOPIC_0000001976834066"></a>
...
<td class="cellrowborder" valign="top" width="62.72%" headers="mcps1.1.4.1.3 "><p id="p26941919174210"><a name="p26941919174210"></a><a name="p26941919174210"></a>默认值为False，表示从tensor转换到numpy.ndarray，且数据不做拷贝，如果取值为True，则表示需要对数据进行拷贝。</p>
<p id="p7172700591"><a name="p7172700591"></a><a name="p7172700591"></a>如果tensor是string类型的数据，该参数需要用户设置成True，否则会抛出异常。</p>
</td>
</tr>
</tbody>
</table>
