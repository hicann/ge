# get\_ret\_code<a name="ZH-CN_TOPIC_0000001976840834"></a>
...
## 函数功能<a name="zh-cn_topic_0000001489269369_zh-cn_topic_0000001408829017_zh-cn_topic_0000001264921066_section51668594"></a>

获取输入FlowMsg消息中的错误码。

## 函数原型<a name="zh-cn_topic_0000001489269369_zh-cn_topic_0000001408829017_zh-cn_topic_0000001264921066_section45209275152"></a>

```
get_ret_code() -> int
```

## 参数说明<a name="zh-cn_topic_0000001489269369_zh-cn_topic_0000001408829017_zh-cn_topic_0000001264921066_section62364163"></a>

无

## 返回值<a name="zh-cn_topic_0000001489269369_zh-cn_topic_0000001408829017_zh-cn_topic_0000001264921066_section24406563"></a>

返回FlowMsg消息中的错误码。0表示正常，非0表示异常。

## 异常处理<a name="zh-cn_topic_0000001489269369_zh-cn_topic_0000001408829017_zh-cn_topic_0000001264921066_section18332482"></a>

无

## 约束说明<a name="zh-cn_topic_0000001489269369_zh-cn_topic_0000001408829017_zh-cn_topic_0000001264921066_section30774618"></a>
