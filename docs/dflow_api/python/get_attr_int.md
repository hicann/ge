# get\_attr\_int<a name="ZH-CN_TOPIC_0000002013400953"></a>
...
```
get_attr_int(self, name: str) -> Tuple[int, int]
```
...
-   如果该属性存在，返回的Tuple中第一个元素为FLOW\_FUNC\_SUCCESS，第二个元素为int类型的属性值。
