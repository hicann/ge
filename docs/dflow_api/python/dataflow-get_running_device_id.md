# dataflow.get\_running\_device\_id<a name="ZH-CN_TOPIC_0000002094628340"></a>
...
UDF执行时获取当前UDF的运行device\_id，该信息来源于data\_flow\_deploy\_info.json中的logic\_device\_list配置。
