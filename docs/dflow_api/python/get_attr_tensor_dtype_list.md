# get\_attr\_tensor\_dtype\_list<a name="ZH-CN_TOPIC_0000001976840862"></a>
...
```
get_attr_tensor_dtype_list(self, name: str) -> Tuple[int, List[numpy.dtype]]
```
...
获取返回码及numpy dtype数组类型的属性值。

-   如果该属性存在，返回的Tuple中第一个元素为FLOW\_FUNC\_SUCCESS，第二个元素为numpy dtype数组类型的属性值。
-   如果属性不存在，Tuple中仅包含错误码一个元素。

## 异常处理<a name="zh-cn_topic_0000001481404214_zh-cn_topic_0000001488949573_zh-cn_topic_0000001357384997_zh-cn_topic_0000001312399929_section3121152"></a>
