# get\_attr\_int\_list\_list<a name="ZH-CN_TOPIC_0000001976840858"></a>
...
```
get_attr_int_list_list(self, name: str) -> Tuple[int, List[List[int]]]
```
...
-   如果该属性存在，返回的Tuple中第一个元素为FLOW\_FUNC\_SUCCESS，第二个元素为int二维数组类型的属性值。
