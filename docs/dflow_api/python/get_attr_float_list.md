# get\_attr\_float\_list<a name="ZH-CN_TOPIC_0000001977000590"></a>
...
```
get_attr_float_list(self, name: str) -> Tuple[int, List[float]]
```
...
-   如果该属性存在，返回的Tuple中第一个元素为FLOW\_FUNC\_SUCCESS，第二个元素为float数组类型的属性值。
