# feed<a name="ZH-CN_TOPIC_0000002094788184"></a>
...
<td class="cellrowborder" valign="top" width="34.449999999999996%" headers="mcps1.1.4.1.2 "><p id="p2458258142614"><a name="p2458258142614"></a><a name="p2458258142614"></a>Dict[FlowData, Any]</p>
</td>
<td class="cellrowborder" valign="top" width="49.54%" headers="mcps1.1.4.1.3 "><p id="p1345715810261"><a name="p1345715810261"></a><a name="p1345715810261"></a>key为FlowData节点，value可以是可序列化的任意的输入。</p>
<p id="p12298229101215"><a name="p12298229101215"></a><a name="p12298229101215"></a>输入与npu模型相连接时必须是dataflow的Tensor类型。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="49.54%" headers="mcps1.1.4.1.3 "><p id="p1520316355910"><a name="p1520316355910"></a><a name="p1520316355910"></a>每次调用feed接口时，feed_dict是否支持模型的部分输入，取值如下。</p>
