# get\_attr\_tensor\_dtype<a name="ZH-CN_TOPIC_0000002013520461"></a>
...
获取返回码及numpy dtype类型的属性值。

-   如果该属性存在，返回的Tuple中第一个元素为FLOW\_FUNC\_SUCCESS，第二个元素为numpy dtype类型的属性值。
