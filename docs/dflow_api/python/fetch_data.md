# fetch\_data<a name="ZH-CN_TOPIC_0000002013394141"></a>
...
<tbody><tr id="zh-cn_topic_0000001417673572_zh-cn_topic_0000001359609816_row35581048202018"><td class="cellrowborder" valign="top" width="16.009999999999998%" headers="mcps1.1.4.1.1 "><p id="p845914589265"><a name="p845914589265"></a><a name="p845914589265"></a>indexes</p>
</td>
<td class="cellrowborder" valign="top" width="34.449999999999996%" headers="mcps1.1.4.1.2 "><p id="p19263959103114"><a name="p19263959103114"></a><a name="p19263959103114"></a>List[int]</p>
</td>
<td class="cellrowborder" valign="top" width="49.54%" headers="mcps1.1.4.1.3 "><p id="p1256610863215"><a name="p1256610863215"></a><a name="p1256610863215"></a>输出数据的索引，不可以重复。取值范围是【0~N-1】，N表示输出数据个数。支持一个或者多个。默认为None，表示取出所有输出。</p>
<p id="p5566118153211"><a name="p5566118153211"></a><a name="p5566118153211"></a>示例：[0,2]，表示获取第一个和第三个输出数据。</p>
</td>
</tr>
<tr id="zh-cn_topic_0000001417673572_zh-cn_topic_0000001359609816_row6558548162013"><td class="cellrowborder" valign="top" width="16.009999999999998%" headers="mcps1.1.4.1.1 "><p id="p9459151643219"><a name="p9459151643219"></a><a name="p9459151643219"></a>timeout</p>
</td>
<td class="cellrowborder" valign="top" width="34.449999999999996%" headers="mcps1.1.4.1.2 "><p id="p18458716103217"><a name="p18458716103217"></a><a name="p18458716103217"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="49.54%" headers="mcps1.1.4.1.3 "><p id="p19456151643216"><a name="p19456151643216"></a><a name="p19456151643216"></a>数据提取超时时间，单位：ms，取值范围[0, 2147483647), 取值为-1时表示从不超时。</p>
</td>
</tr>
</tbody>
</table>
...
返回Tuple\[List\["Tensor"\], FlowInfo, int\]。
