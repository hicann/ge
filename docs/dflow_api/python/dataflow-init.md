# dataflow.init<a name="ZH-CN_TOPIC_0000002013513653"></a>
...
<tbody><tr id="zh-cn_topic_0000001417673572_zh-cn_topic_0000001359609816_row35581048202018"><td class="cellrowborder" valign="top" width="22.220000000000002%" headers="mcps1.1.4.1.1 "><p id="p122371954194611"><a name="p122371954194611"></a><a name="p122371954194611"></a>flow_options</p>
</td>
<td class="cellrowborder" valign="top" width="15.06%" headers="mcps1.1.4.1.2 "><p id="p8236115464612"><a name="p8236115464612"></a><a name="p8236115464612"></a>Dict[str, str]</p>
</td>
<td class="cellrowborder" valign="top" width="62.72%" headers="mcps1.1.4.1.3 "><p id="p11359182032814"><a name="p11359182032814"></a><a name="p11359182032814"></a>初始化dataflow时的options。options当前支持全局和session级别的。</p>
<p id="p023535494612"><a name="p023535494612"></a><a name="p023535494612"></a>其中的配置示例请按照Python语言进行适配。</p>
</td>
</tr>
</tbody>
</table>
