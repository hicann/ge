# get\_attr\_str<a name="ZH-CN_TOPIC_0000002013400961"></a>
...
```
get_attr_str(self, name: str) -> Tuple[int, str]
```
...
-   如果该属性存在，返回的Tuple中第一个元素为FLOW\_FUNC\_SUCCESS，第二个元素为string类型的属性值。
