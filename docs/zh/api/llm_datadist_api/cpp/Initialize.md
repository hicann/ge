...
| OPTION_BUF_POOL_CFG | 可选 | 配置内存池大小与档位信息，提高内存申请性能和使用率。格式为json string，字段含义见表2，使用示例如下所示。<br>{<br>"buf_cfg":[{"total_size":2097152,"blk_size":256,"max_buf_size":8192}],<br>"buf_pool_size": 2147483648<br>} |
