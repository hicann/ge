...
- IPV350：支持
<!-- end id887 -->
<!-- @ref: ge/res/docs/zh/api/graph_engine_api/c/acl/aclmdlGetAttribute_res.md#id1 -->
...
| attrValue | 输出 | 指向属性值的指针，attr对应的属性取值。类型定义请参见[aclmdlAttrValue_t](aclmdlAttrValue_t.md)。 |
