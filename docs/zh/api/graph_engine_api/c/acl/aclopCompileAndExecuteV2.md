...
- IPV350：不支持
<!-- end id315 -->
<!-- @ref: ge/res/docs/zh/api/graph_engine_api/c/acl/aclopCompileAndExecuteV2_res.md#id1 -->
...
<!-- end id2 -->
- 对于动态Shape的算子，无法明确算子输出Shape时，可调用[aclopInferShape](aclopInferShape.md)接口获取算子的输出Shape：
