...
- IPV350：不支持
<!-- end id566 -->
<!-- @ref: ge/res/docs/zh/api/graph_engine_api/c/acl/aclblasCreateHandleForHgemv_res.md#id1 -->

## 功能说明

创建矩阵-向量乘的handle，输入数据和输出数据的数据类型为aclFloat16。创建handle成功后，需调用[aclopExecWithHandle](aclopExecWithHandle.md)接口执行算子。
