# RunGraphAsync<a name="ZH-CN_TOPIC_0000001265404762"></a>
...
<td class="cellrowborder" valign="top" width="81.89999999999999%" headers="mcps1.1.4.1.3 "><p id="p1088102316362"><a name="p1088102316362"></a><a name="p1088102316362"></a>当前子图对应的输入数据。</p>
<p id="p337701072418"><a name="p337701072418"></a><a name="p337701072418"></a>使用std::vector&lt;Tensor&gt;类型的inputs作为输入，用户输入进入数据队列时，需要对每个输入做一次内存的申请和拷贝，输入较大或者较多时可能存在性能瓶颈。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="81.89999999999999%" headers="mcps1.1.4.1.3 "><p id="p10751123519246"><a name="p10751123519246"></a><a name="p10751123519246"></a>当前子图对应的回调函数。</p>
...
using RunAsyncCallback = std::function&lt;void(Status, std::vector&lt;ge::Tensor&gt; &amp;)&gt;;</pre>
</td>
</tr>
</tbody>
</table>
