# RegisterExternalAllocator<a name="ZH-CN_TOPIC_0000002476237574"></a>
...
此接口需要配合[LoadGraph](LoadGraph-6.md)、[RunGraphWithStreamAsync](RunGraphWithStreamAsync-12.md)接口使用，并且需要在LoadGraph接口调用前注册。
