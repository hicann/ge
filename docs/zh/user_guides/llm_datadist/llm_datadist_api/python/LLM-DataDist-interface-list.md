...
| 接口名称 | 简介 |
| --- | --- |
| [LLMDataDist-constructor](LLMDataDist-constructor.md) | 构造LLMDataDist。 |
...
| 接口名称 | 简介 |
| --- | --- |
| [LLMConfig-constructor](LLMConfig-constructor.md) | 构造LLMConfig。 |
...
| 接口名称 | 简介 |
| --- | --- |
| [KvCacheManager-constructor](KvCacheManager-constructor.md) | 介绍KvCacheManager-constructor。 |
...
| 接口名称 | 简介 |
| --- | --- |
| [KvCache-constructor](KvCache-constructor.md) | 构造KVCache。 |
...
| 接口名称 | 简介 |
| --- | --- |
| [LLMClusterInfo-constructor](LLMClusterInfo-constructor.md) | 构造LLMClusterInfo。 |
...
| 接口名称 | 简介 |
| --- | --- |
| [CacheTask-constructor](CacheTask-constructor.md) | 构造CacheTask。 |
...
| [LLMException](LLMException.md) | 获取异常的error-code。error-code列表详见[LLMStatusCode](LLMStatusCode.md)。 |
