...
已经安装CANN软件，详细操作请参见[《CANN软件安装》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/920beta2/softwareinst/instg/instg_0000.html?OS=openEuler&InstallType=netyum)。
...
- 可选环境变量
    ...
    具体说明请参考[《环境变量参考》](https://gitcode.com/cann/docs/blob/9.2.0-beta.2/docs/zh/env-vars/README.md)。
