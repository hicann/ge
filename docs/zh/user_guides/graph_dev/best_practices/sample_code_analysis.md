...
1. 调用《[Runtime运行时 API](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/920beta2/API/runtimeapi/aclcppdevg_03_1952.html)》中的“初始化和去初始化 \> aclInit”接口，初始化acl，调用《Runtime运行时 API》中的“Device管理 \> aclrtSetDevice”指定运行的Device。
