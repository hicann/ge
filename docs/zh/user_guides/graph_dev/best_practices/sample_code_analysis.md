...
1. 调用《[Runtime运行时API](https://gitcode.com/cann/runtime/blob/9.2.0/docs/zh/api_ref/README.md)》中的“初始化和去初始化 \> aclInit”接口，初始化acl，调用《Runtime运行时API》中的“Device管理 \> aclrtSetDevice”指定运行的Device。
