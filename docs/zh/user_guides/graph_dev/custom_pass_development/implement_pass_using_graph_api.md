...
>
>通过Ascend C自定义该算子，详情请参见[《Ascend C算子开发》](https://gitcode.com/cann/asc-devkit/blob/9.2.0-beta.1/docs/zh/guide/index.md)。
>
>通过TBE自定义该算子，详情请参见[《TBE&AI CPU算子开发》](https://hiascend.com/document/redirect/CannCommunityOpdevWizard)。
>
