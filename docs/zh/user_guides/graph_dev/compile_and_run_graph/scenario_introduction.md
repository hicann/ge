...
|场景|功能说明|
|--|--|
|[编译Graph为离线模型](#编译graph为离线模型)|**将Graph编译并保存为om离线模型**，编译生成的离线模型通过模型加载接口加载，然后通过模型执行接口进行推理。详细介绍请参考《[应用开发](https://gitcode.com/cann/docs/blob/9.2.0/docs/zh/app-dev/00_acl_cpp_dev.md)》中的“模型推理”章节。|
