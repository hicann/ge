...
如下融合规则关闭后可能会有功能使用上的风险；更多融合规则请参见《[图融合和UB融合规则参考](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/920/maintenref/graphubfusionref/atlasrr_30_0003.html)》。
