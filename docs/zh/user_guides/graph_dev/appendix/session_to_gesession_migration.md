...
aclrtMallocHost、aclrtMalloc、aclrtFreeHost、aclrtFree等接口详细说明请参见《[Runtime运行时API](https://gitcode.com/cann/runtime/blob/9.2.0/docs/zh/api_ref/README.md)》中的“内存管理”。
