...
- [图开发指南](./user_guides/graph_dev/README.md)

  面向单卡的图编译和执行，提供GE基本概念、原理介绍、以及如何使用GE图引擎接口进行图的构建，编译和运行等。

- [DataFlow开发指南](./user_guides/dflow/index.md)

  面向异构和集群的图编译和执行，介绍如何通过DataFlow接口构建、修改、编译和执行计算图。

- [LLM DataDist开发指南](./user_guides/llm_datadist/index.md)
...
- DataFlow API
  - [C++接口](./user_guides/dflow/dflow_api/README_cpp.md)
  - [Python接口](./user_guides/dflow/dflow_api/README_python.md)
- LLM DataDist API
  - [C++接口](./user_guides/llm_datadist/llm_datadist_api/README_cpp.md)
  - [Python接口](./user_guides/llm_datadist/llm_datadist_api/README_python.md)

## 架构与开发指南

- [架构文档](./design/README.md)
