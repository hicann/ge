# PullKvCache<a name="ZH-CN_TOPIC_0000002374103454"></a>
...
<td class="cellrowborder" valign="top" width="41.89%" headers="mcps1.1.4.1.3 "><p id="p37063585311"><a name="p37063585311"></a><a name="p37063585311"></a>设置为&gt;0的整数，表示要拉取的大小。</p>
...
<td class="cellrowborder" valign="top" width="41.89%" headers="mcps1.1.4.1.3 "><p id="p201241217175212"><a name="p201241217175212"></a><a name="p201241217175212"></a><span id="ph65832182617"><a name="ph65832182617"></a><a name="ph65832182617"></a>当前支持ext_param中src_layer_range</span><span id="ph11217175019252"><a name="ph11217175019252"></a><a name="ph11217175019252"></a>的</span><span id="ph7692750112514"><a name="ph7692750112514"></a><a name="ph7692750112514"></a>sencond与first的差值</span><span id="ph8588217268"><a name="ph8588217268"></a><a name="ph8588217268"></a>和dst_layer_range</span><span id="ph1476819551246"><a name="ph1476819551246"></a><a name="ph1476819551246"></a>的sencond与first的差值</span><span id="ph1158102152620"><a name="ph1158102152620"></a><a name="ph1158102152620"></a>一致</span>。src_layer_range和dst_layer_range的first和second默认值都是-1，表示全部的层。取值范围都是[0, 最大可用层索引]，且first小于等于second。 最大可用层索引值的计算公式如下。</p>
