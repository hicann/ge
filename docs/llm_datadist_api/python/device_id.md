# device\_id<a name="ZH-CN_TOPIC_0000002374410888"></a>
...
<td class="cellrowborder" valign="top" width="46.04%" headers="mcps1.1.4.1.3 "><p id="p12594101817295"><a name="p12594101817295"></a><a name="p12594101817295"></a>设置当前进程的Device ID。支持配置为一个或者列表，配置为列表时以半角逗号间隔。</p>
<a name="ul18565478296"></a><a name="ul18565478296"></a><ul id="ul18565478296"><li>单进程单卡场景下，需要配置为一个，例如：0</li><li>单进程多卡场景下，需要配置为列表，例如：[0, 1]</li></ul>
</td>
</tr>
</tbody>
</table>
