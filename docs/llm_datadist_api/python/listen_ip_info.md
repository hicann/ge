# listen\_ip\_info<a name="ZH-CN_TOPIC_0000002374251044"></a>
...
<td class="cellrowborder" valign="top" width="62.74999999999999%" headers="mcps1.1.4.1.3 "><p id="p89481716246"><a name="p89481716246"></a><a name="p89481716246"></a>设置为Device侧的IP地址和端口，支持配置为一个或者多个，配置多个时用英文分号分割。</p>
<a name="ul18565478296"></a><a name="ul18565478296"></a><ul id="ul18565478296"><li>单进程单卡场景下，需要配置为一个，例如："192.168.1.1:26000"</li><li>单进程多卡场景下，需要配置为多个，例如："192.168.1.1:26000;192.168.1.2:26000"</li></ul>
</td>
</tr>
</tbody>
</table>
