# init<a name="ZH-CN_TOPIC_0000002408010569"></a>
...
<td class="cellrowborder" valign="top" width="35.85%" headers="mcps1.1.4.1.2 "><p id="p9541205974512"><a name="p9541205974512"></a><a name="p9541205974512"></a>Dict[str, str]</p>
</td>
<td class="cellrowborder" valign="top" width="41.93%" headers="mcps1.1.4.1.3 "><p id="p7172700591"><a name="p7172700591"></a><a name="p7172700591"></a>配置项。</p>
<p id="p13763174313494"><a name="p13763174313494"></a><a name="p13763174313494"></a>传入的options可以通过<a href="LLMConfig.md">LLMConfig</a>来生成。</p>
<p id="p17726172614159"><a name="p17726172614159"></a><a name="p17726172614159"></a>必填字段：device_id和listen_ip_info（由于Prompt作为Server，必填；Decode作为Client无需填充listen_ip_info信息）。</p>
</td>
</tr>
</tbody>
</table>
...
## 约束说明<a name="section1391611144104"></a>
