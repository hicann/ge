# ge\_options<a name="ZH-CN_TOPIC_0000002374410860"></a>
...
<p id="p19907288261"><a name="p19907288261"></a><a name="p19907288261"></a>其中ge.flowGraphMemMaxSize比较重要，表示所有KV cache占用的最大内存，如果设置的过大，会压缩模型的可用内存，需根据实际情况指定。</p>
</td>
</tr>
</tbody>
</table>
