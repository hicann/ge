# numpy<a name="ZH-CN_TOPIC_0000002407890449"></a>
...
<tbody><tr id="zh-cn_topic_0000001417673572_zh-cn_topic_0000001359609816_row35581048202018"><td class="cellrowborder" valign="top" width="22.220000000000002%" headers="mcps1.1.4.1.1 "><p id="p6621349454"><a name="p6621349454"></a><a name="p6621349454"></a>copy</p>
</td>
...
<td class="cellrowborder" valign="top" width="62.72%" headers="mcps1.1.4.1.3 "><p id="p18323810182311"><a name="p18323810182311"></a><a name="p18323810182311"></a>取值为False或者True。</p>
<p id="p26941919174210"><a name="p26941919174210"></a><a name="p26941919174210"></a>默认值为False，表示从tensor转换到numpy.ndarray，且数据不做拷贝，如果取值为True，则表示需要对数据进行拷贝。</p>
<p id="p7172700591"><a name="p7172700591"></a><a name="p7172700591"></a>如果是tensor是string类型的数据，该参数需要用户设置成True，否则会抛出异常。</p>
</td>
</tr>
</tbody>
</table>
