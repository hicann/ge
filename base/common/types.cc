...
const std::string DUMP_WATCHER_MODEL = "WATCHER_MODEL_NEED_DUMP_AND_IT_IS_NOT_A_MODEL_NAME";
...
REGISTER_OPTYPE_DEFINE(REFDATA, "RefData");
...
REGISTER_OPTYPE_DEFINE(DROPOUTGENMASKV3, "DropOutGenMaskV3");
...
REGISTER_OPTYPE_DEFINE(SLICEWITHAXES, "SliceWithAxes");
...
REGISTER_OPTYPE_DEFINE(STRIDEDSLICED, "StridedSliceD");
...
REGISTER_OPTYPE_DEFINE(SPLITD, "SplitD");
REGISTER_OPTYPE_DEFINE(SPLITVD, "SplitVD");
...
REGISTER_OPTYPE_DEFINE(DYNAMICGETNEXT, "DynamicGetNext");
REGISTER_OPTYPE_DEFINE(DYNAMICGETNEXTV2, "DynamicGetNextV2");
...
REGISTER_OPTYPE_DEFINE(CONSTPLACEHOLDER, "ConstPlaceHolder");
...
REGISTER_OPTYPE_DEFINE(HCOMALLGATHERV, "HcomAllGatherV");
REGISTER_OPTYPE_DEFINE(HCOMALLREDUCE, "HcomAllReduce");
REGISTER_OPTYPE_DEFINE(HCOMREDUCESCATTER, "HcomReduceScatter");
REGISTER_OPTYPE_DEFINE(HCOMREDUCESCATTERV, "HcomReduceScatterV");
...
REGISTER_OPTYPE_DEFINE(HCOMGATHER, "HcomGather");
...
REGISTER_OPTYPE_DEFINE(SENDNOTIFY, "SendNotify");
REGISTER_OPTYPE_DEFINE(RECVNOTIFY, "RecvNotify");
...
REGISTER_OPTYPE_DEFINE(NPUGETFLOATDEBUGSTATUS, "NPUGetFloatDebugStatus");
REGISTER_OPTYPE_DEFINE(NPUCLEARFLOATDEBUGSTATUS, "NPUClearFloatDebugStatus");
...
REGISTER_OPTYPE_DEFINE(EXPONENTIAL_DECAY_LR, "ExponentialDecayLR");
...
// Phony
REGISTER_OPTYPE_DEFINE(PHONYCONCAT, "PhonyConcat");
REGISTER_OPTYPE_DEFINE(PHONYSPLIT, "PhonySplit");

REGISTER_OPTYPE_DEFINE(CMO, "Cmo");
...
const std::string COMPILED_INFERENCE_RULE_BINARY = "_inference_rule_binary";
