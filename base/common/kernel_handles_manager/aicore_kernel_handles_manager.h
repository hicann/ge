...
#ifndef BASE_COMMON_KERNEL_HANDLES_MANAGER_AICORE_KERBEL_HANDLES_MANAGER_H
#define BASE_COMMON_KERNEL_HANDLES_MANAGER_AICORE_KERBEL_HANDLES_MANAGER_H
...
#endif // BASE_COMMON_KERNEL_HANDLES_MANAGER_AICORE_KERBEL_HANDLES_MANAGER_H