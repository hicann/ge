...
#ifndef BASE_COMMON_KERNEL_HANDLES_MANAGER_KERNEL_HANDLE_UTILS_H
#define BASE_COMMON_KERNEL_HANDLES_MANAGER_KERNEL_HANDLE_UTILS_H
...
class KernelHandleUtils {
 public:
  ...
  static aclrtFuncHandle GetCustAicpuFuncHandle(const aclrtBinHandle &bin_handle, const std::string &op_type,
...
#endif  // #ifndef BASE_COMMON_KERNEL_HANDLES_MANAGER_KERNEL_HANDLE_UTILS_H
