  ...
  switch (id) {
    ...
    case StablePartId::kLoadAndRunExternalApis:
      output =
          ...
          "void **var_addrs, void *work_ptr, uint64_t *session_id, uint32_t model_id, void *instance_handle, void "
          "*executor_handle, int32_t priority) {\n"
          ...
          "work_ptr, session_id, model_id, instance_handle, executor_handle, priority);\n"
          "  if (obj == nullptr) {\n"
