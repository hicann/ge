  ...
  switch (id) {
    ...
    case StablePartId::kCustomTaskHelpers:
      output =
          ...
          "};\n"
          "\n"
          "uint32_t LaunchEagerExecuteOp(void *eager_op, void *eager_op_context) {\n"
          "  auto custom_op = reinterpret_cast<ge::EagerExecuteOp *>(eager_op);\n"
          "  if (custom_op == nullptr) {\n"
          "    OM2_LOGE(\"Input eager_op is invalid\");\n"
          "    return ACL_ERROR_FAILURE;\n"
          "  }\n"
          "  auto op_context = reinterpret_cast<gert::EagerOpExecutionContext *>(eager_op_context);\n"
          "  if (op_context == nullptr) {\n"
          "    OM2_LOGE(\"Input eager_op_context is invalid\");\n"
          "    return ACL_ERROR_FAILURE;\n"
          "  }\n"
          "  return custom_op->Execute(op_context);\n"
          "}\n"
          "\n"
