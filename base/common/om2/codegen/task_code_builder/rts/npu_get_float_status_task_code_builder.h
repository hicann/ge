...
#ifndef AIR_CXX_BASE_COMMON_OM2_CODEGEN_TASK_CODE_BUILDER_RTS_NPU_GET_FLOAT_STATUS_TASK_CODE_BUILDER_H_
#define AIR_CXX_BASE_COMMON_OM2_CODEGEN_TASK_CODE_BUILDER_RTS_NPU_GET_FLOAT_STATUS_TASK_CODE_BUILDER_H_
