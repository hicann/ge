...
std::vector<BodyItem> KernelTaskCodeBuilder::RenderAicpuLaunchAndReport(const VarRef &op, const VarRef &ctx) {
  ...
  return {
      ...
      ast_.VarDecl(launch_kernel_v2_params, ast_.InitList({})),
      ast_.Assign(launch_kernel_v2_params.Attr("func_handle"), ctx.Attr("func_handles")[aicpu.Attr("func_idx")]),
      ast_.Assign(launch_kernel_v2_params.Attr("block_dim"), aicpu.Attr("block_dim")),
      ast_.Assign(launch_kernel_v2_params.Attr("args_data"), args_info.Arrow("dev_addr")),
      ast_.Assign(launch_kernel_v2_params.Attr("args_size"), args_info.Arrow("size")),
      ast_.Assign(launch_kernel_v2_params.Attr("config"), ast_.Var("", "aicpu_cfg_holder").Attr("cfg").Addr()),
      ast_.Assign(launch_kernel_v2_params.Attr("stream"), stream),
      ast_.VarDecl(launch_params, ast_.InitList({})),
      ast_.Assign(launch_params.Attr("launch_kernel_v2_params"), launch_kernel_v2_params),
      ast_.VarDecl(launch_info, ast_.InitList({})),
      ast_.Assign(launch_info.Attr("launch_type"), ast_.Var("", "ACL_RT_LAUNCH_KERNEL_V2")),
      ast_.Assign(launch_info.Attr("task_info"), task_info.Addr()),
      ast_.Assign(launch_info.Attr("launch_params"), launch_params.Addr()),
...
std::vector<BodyItem> KernelTaskCodeBuilder::RenderDistribution(const VarRef &op, const VarRef &ctx) {
  ...
  auto kernel_params = ast_.Var("GertModelLaunchKernelV2Params", "kernel_params");
  ...
  return {
      ...
      ast_.Assign(task_info.Attr("task_raw_info"), ast_.Var("", "task_raw_info").Addr()),
      ast_.VarDecl(kernel_params, ast_.InitList({})),
      ast_.Assign(kernel_params.Attr("func_handle"), ctx.Attr("func_handles")[aicore.Attr("func_idx")]),
      ast_.Assign(kernel_params.Attr("block_dim"), aicore.Attr("block_dim")),
      ast_.Assign(kernel_params.Attr("args_data"), ast_.Var("", "args_info").Arrow("dev_addr")),
      ast_.Assign(kernel_params.Attr("args_size"), ast_.Var("", "args_info").Arrow("size")),
      ast_.Assign(kernel_params.Attr("config"), ast_.Var("", "cfg_holder").Attr("cfg").Addr()),
      ast_.Assign(kernel_params.Attr("stream"), stream),
      ast_.VarDecl(launch_params, ast_.InitList({})),
      ast_.Assign(launch_params.Attr("launch_kernel_v2_params"), kernel_params),
      ast_.VarDecl(launch_info, ast_.InitList({})),
      ast_.Assign(launch_info.Attr("launch_type"), ast_.Var("", "ACL_RT_LAUNCH_KERNEL_V2")),
      ast_.Assign(launch_info.Attr("task_info"), task_info.Addr()),
      ast_.Assign(launch_info.Attr("launch_params"), launch_params.Addr()),
      ChkStatus(
          ast_.Call("KernelTaskDistribute", {launch_info.Addr(), ctx.Attr("launch_func"), ctx.Attr("instance_handle"),
