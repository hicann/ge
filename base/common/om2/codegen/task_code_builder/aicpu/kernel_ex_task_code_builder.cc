...
FunctionDef *KernelExTaskCodeBuilder::RenderTfAicpuKernelTaskDistribute() const {
  ...
  return ast_.DefineFunction(
      ...
      "aclError",
      {
          ...
          ast_.Assign(kernel_params.Attr("func_handle"), func_handle),
          ast_.Assign(kernel_params.Attr("block_dim"), block_dim),
          ast_.Assign(kernel_params.Attr("args_data"), kernel_buf),
          ast_.Assign(kernel_params.Attr("args_size"), kernel_buf_size),
          ast_.Assign(kernel_params.Attr("config"), config),
          ...
          ast_.Assign(launch_info.Attr("task_info"), task_info),
