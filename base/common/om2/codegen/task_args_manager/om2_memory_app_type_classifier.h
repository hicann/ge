...
#ifndef AIR_CXX_BASE_COMMON_OM2_CODEGEN_OM2_MEMORY_APP_TYPE_CLASSIFIER_H_
#define AIR_CXX_BASE_COMMON_OM2_CODEGEN_OM2_MEMORY_APP_TYPE_CLASSIFIER_H_
#include <cstdint>
#include <map>
#include <vector>
#include <set>
...
class MemoryAppTypeClassifier {
 public:
  ...
  // return key: <memory-type,logical-addr>, value: memory-app-type
...
#endif  // AIR_CXX_BASE_COMMON_OM2_CODEGEN_OM2_MEMORY_APP_TYPE_CLASSIFIER_H_
