...
IMPL_OP(Adds).InputsDataDependency({});
...
IMPL_OP(Expand).InputsDataDependency({1});
IMPL_OP(Pad).InputsDataDependency({1});
IMPL_OP(StridedSlice).InputsDataDependency({1, 2, 3});
IMPL_OP(StridedSliceV2).InputsDataDependency({1, 2, 3, 4});
IMPL_OP(StridedSliceV3).InputsDataDependency({1, 2, 3, 4});
...
IMPL_OP(Flatten).InputsDataDependency({});
IMPL_OP(Shape).InputsDataDependency({});
IMPL_OP(RmsNorm).InputsDataDependency({});
IMPL_OP(ApplyRotaryPosEmb).InputsDataDependency({});
...
IMPL_OP(SelectV2).InputsDataDependency({});
IMPL_OP(SoftmaxV2).InputsDataDependency({});
IMPL_OP(TensorScatterUpdate).InputsDataDependency({});
