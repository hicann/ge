...
*@li Dtype bfloat16, uint32, uint64 only support Ascend 910_95 AI Processor. \n
...
*@par Attributes:
*@li out_idx: An optional DType from: "int32, int64". Defaults to "int64".
*@li sorted: An optional DType from "bool". Defaults to False.
...
*@par Inputs:
*Inputs "x" and "y" are 1D vectors.
* @li x: A tensor of type int8, uint8, int16, uint16, int32, int64, float16, float,
...
* @li descending: An optional bool. Controls the sorting order (ascending or descending).
...
* @li The upper limit of data on Atlas Training Series Product is 2000K.
*/
REG_OP(SortV2)
...
/**
*@brief Returns a tensor with updated shape from NonZeroWithValue. \n
