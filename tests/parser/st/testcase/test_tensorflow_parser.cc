...
TEST_F(STestTensorflowParser, parser_ParseProtoWithSubgraphV2)
{
  ...
  std::size_t idx = caseDir.find_last_of("/");
  caseDir = caseDir.substr(0, idx);
  std::string root_proto = caseDir + "/origin_models/tf_add.pb";
...
TEST_F(STestTensorflowParser, tensorflow_UpdateEdgesControlInfo_test)
{
  ...
  EXPECT_EQ(model_parser.edges_control_map[info.fusion_node_name].size(), 0U);
}
...
TEST_F(STestTensorflowParser, ProtoFileParser_CombineProtoFileMultiCustomProto_not_exists) {
...
TEST_F(STestTensorflowParser, ProtoFileParser_CombineProtoFileMultiCustomProto_exists_01) {
  std::string proto_dir = __FILE__;
  proto_dir = proto_dir.substr(0, proto_dir.rfind("/") + 1) + "proto_dir/";
...
TEST_F(STestTensorflowParser, ProtoFileParser_CombineProtoFileMultiCustomProto_exists_02) {
  std::string proto_dir = __FILE__;
  proto_dir = proto_dir.substr(0, proto_dir.rfind("/") + 1) + "proto_dir/";
  system(("mkdir -p " + proto_dir).c_str());
...
TEST_F(STestTensorflowParser, ProtoFileParser_CombineProtoFileMultiCustomProto_exists_03) {
  std::string proto_dir = __FILE__;
  proto_dir = proto_dir.substr(0, proto_dir.rfind("/") + 1) + "proto_dir/";
  system(("mkdir -p " + proto_dir).c_str());
...
TEST_F(STestTensorflowParser, ProtoFileParser_CombineProtoFileMultiCustomProto_exists_04) {
  std::string proto_dir = __FILE__;
  proto_dir = proto_dir.substr(0, proto_dir.rfind("/") + 1) + "proto_dir/";
  system(("mkdir -p " + proto_dir).c_str());
...
TEST_F(STestTensorflowParser, tensorflow_FP16_parser_test)
{
 ...
 float f_val1= 2139095000.2;
  ...
  fp16_3.val = 1;
  fp16_4.val = 2;
  EXPECT_EQ(fp16_4.operator/(fp16_3), fp16_4);
...
TEST_F(STestTensorflowParser, parser_LinkInnerAnchor_test)
{
  ...
  ParserGraphOptimizer graphOptimizer(subGraph, domi::TENSORFLOW);
  EXPECT_NE(graphOptimizer.LinkInnerAnchor(node_map), SUCCESS);
}
...
TEST_F(STestTensorflowParser, test_plugin_manager_getopp_plugin_vendors_05) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetOpsProtoPath_07) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path = opp_path + "custom_opp_path";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetOpsProtoPath_08) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path_01 = opp_path + "custom_opp_path_01";
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetOpsProtoPath_09) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path_01 = opp_path + "custom_opp_path_01";
  std::string custom_opp_path_02 = opp_path + "custom_opp_path_02";
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomOpPath_07) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path = opp_path + "custom_opp_path";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomOpPath_08) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path_01 = opp_path + "custom_opp_path_01";
  std::string custom_opp_path_invalid_01 = opp_path + "custom_opp_path_invalid_01";
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomOpPath_09) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path_01 = opp_path + "custom_opp_path_01";
  std::string custom_opp_path_02 = opp_path + "custom_opp_path_02";
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_01) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_02) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_03) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_04) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path = opp_path + "custom_opp_path";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_05) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path = opp_path + "custom_opp_path";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_06) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path_01 = opp_path + "custom_opp_path_01";
  std::string custom_opp_path_02 = opp_path + "custom_opp_path_02";
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_07) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path = opp_path + "custom_opp_path";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_08) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path_01 = opp_path + "custom_opp_path_01";
  std::string custom_opp_path_invalid_01 = opp_path + "custom_opp_path_invalid_01";
...
TEST_F(STestTensorflowParser, test_plugin_manager_GetCustomCaffeProtoPath_09) {
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  std::string custom_opp_path_01 = opp_path + "custom_opp_path_01";
  std::string custom_opp_path_02 = opp_path + "custom_opp_path_02";
...
TEST_F(STestTensorflowParser, tensorflow_parser_ParserInitializeOk)
{
  std::string opp_path = __FILE__;
  opp_path = opp_path.substr(0, opp_path.rfind("/") + 1) + "opp_path/";
  setenv("ASCEND_OPP_PATH", opp_path.c_str(), 1);
  ...
  dl_flag = 0;
  options[ge::OPTION_EXEC_ENABLE_SCOPE_FUSION_PASSES] = "some_pass";
  Status ret = ParserInitialize(options);
  EXPECT_EQ(ret, SUCCESS);
  system(("rm -rf " + opp_path).c_str());
}

TEST_F(STestTensorflowParser, tensorflow_parser_input_shape_success) {
  RegisterCustomOp();
  std::string case_dir = __FILE__;
  case_dir = case_dir.substr(0, case_dir.find_last_of("/"));
  std::string model_file = case_dir + "/origin_models/tf_add.pb";
  std::map<ge::AscendString, ge::AscendString> parser_params = {
    {ge::AscendString(ge::ir_option::INPUT_SHAPE), ge::AscendString("Placeholder:1,2;Placeholder_1:3,4")},
  };
...
TEST_F(STestTensorflowCustomOpParser, ParseCustomOpWithNullNode_NormalCase_ReturnSuccess) {
