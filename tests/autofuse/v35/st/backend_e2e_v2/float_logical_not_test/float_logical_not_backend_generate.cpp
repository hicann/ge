...
class TestBackendFloatLogicalNotE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendFloatLogicalNotE2e, LoadLogicalNotStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadLogicalNotStoreFusedGraph(2, ge::DT_FLOAT, ge::DT_UINT8);
