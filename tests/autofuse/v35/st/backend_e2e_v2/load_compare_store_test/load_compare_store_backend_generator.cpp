...
class TestBackendLoadCompareStoreE2e : public testing::Test {
  protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadCompareStoreE2e, LoadCompareStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadCompareStoreFusedGraph(2);
