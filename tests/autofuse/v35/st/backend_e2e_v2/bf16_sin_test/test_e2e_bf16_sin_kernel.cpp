...
extern "C" __global__ __aicore__ void sin_bf16_test(GM_ADDR x1, GM_ADDR y1, GM_ADDR workspace, GM_ADDR tiling);
...
class E2E_BackendBf16Sin_Code : public testing::Test, public testing::WithParamInterface<std::vector<int>> {};

TEST_P(E2E_BackendBf16Sin_Code, CalculateCorrect) {
