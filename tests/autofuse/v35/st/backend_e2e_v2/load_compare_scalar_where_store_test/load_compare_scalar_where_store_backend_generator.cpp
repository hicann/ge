...
class TestBackendLoadCompareScalarWhereStoreE2e : public testing::Test {
  protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadCompareScalarWhereStoreE2e, LoadCompareScalarWhereStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadCompareScalarWhereFusedGraph();
