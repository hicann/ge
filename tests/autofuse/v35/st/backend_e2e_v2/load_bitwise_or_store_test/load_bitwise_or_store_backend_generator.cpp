...
class TestBackendLoadBitwiseOrStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadBitwiseOrStoreE2e, LoadBitwiseOrStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadBitwiseOrStoreFusedGraph(3, ge::DT_UINT8, ge::DT_UINT8);
