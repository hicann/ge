...
class TestBackendHalfLogicalNotE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendHalfLogicalNotE2e, LoadLogicalNotStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadLogicalNotStoreFusedGraph(2, ge::DT_FLOAT16, ge::DT_UINT8);
