...
class TestBackendLoadBitwiseNotStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadBitwiseNotStoreE2e, LoadBitwiseNotStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadBitwiseNotStoreFusedGraph(3, ge::DT_UINT8, ge::DT_UINT8);
