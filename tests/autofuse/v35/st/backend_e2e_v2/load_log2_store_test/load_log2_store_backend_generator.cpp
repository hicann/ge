...
class TestBackendLoadLog2StoreE2e : public testing::Test {
  protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadLog2StoreE2e, LoadLog2StoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadLog2StoreFusedGraph(2);
