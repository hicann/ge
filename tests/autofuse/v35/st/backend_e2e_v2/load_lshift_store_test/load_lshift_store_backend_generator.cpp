...
class TestBackendLoadLShiftStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadLShiftStoreE2e, LoadLShiftStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadLShiftStoreFusedGraph(3, ge::DT_INT8, ge::DT_INT8);
