...
class TestBackendLoadBitwiseXorStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadBitwiseXorStoreE2e, LoadBitwiseXorStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadBitwiseXorStoreFusedGraph(3, ge::DT_UINT8, ge::DT_UINT8);
