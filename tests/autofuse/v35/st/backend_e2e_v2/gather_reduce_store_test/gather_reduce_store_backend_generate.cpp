...
class TestBackendGatherReduceStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendGatherReduceStoreE2e, GatherReduceStoreCodegen) {
  bool gen_success = true;
  std::string tilig_stub = R"(
#define REGISTER_TILING_DEFAULT(tiling)
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
)";
  auto graph = ascir::ShareGraph::GatherReduceStore(0, ge::DT_FLOAT);
