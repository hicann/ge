...
class TestBackendLoadBitwiseAndStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadBitwiseAndStoreE2e, LoadBitwiseAndStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadBitwiseAndStoreFusedGraph(3, ge::DT_UINT8, ge::DT_UINT8);
