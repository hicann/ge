...
class TestBackendBinaryApiScalarE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendBinaryApiScalarE2e, BinaryApiScalarE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::BinaryApiScalarFusedGraph();
