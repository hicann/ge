...
TEST_F(LoadSubStoreTest, LoadSubStoreCodegen) {
  ...
  ge::AscGraph test_graph("load_sub_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<ge::AscGraph> test_impl_graphs = {ge::AscGraph("load_sub_store_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = ge::AscendString("load_sub_store");
