...
#include "codegen.h"
#include "e2e_load_switch_scalar_sub_store.h"
...
class LoadSwitchScalarSubStoreTest : public testing::Test {
 protected:
  void SetUp() override {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  LoadSwitchScalarSubStore_BeforeAutofuse(test_graph, ge::DT_FLOAT, ge::DT_FLOAT);
  LoadSwitchScalarSubStore_AfterInferOutput(test_graph, ge::DT_FLOAT, ge::DT_FLOAT);
  ...
  LoadSwitchScalarSubStore_AfterGetApiInfo(test_impl_graphs[0]);
  LoadSwitchScalarSubStore_AfterScheduler(test_impl_graphs[0]);
  LoadSwitchScalarSubStore_AfterQueBufAlloc(test_impl_graphs[0]);
