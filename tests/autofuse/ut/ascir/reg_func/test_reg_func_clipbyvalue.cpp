...
namespace ge{
namespace ascir{
extern std::vector<std::unique_ptr<ge::TmpBufDesc>> CalcClipByValueTmpSize(const ge::AscNode &node);
...
TEST_F(CalcClipByValueTmpSizeTest, CalcClipByValueTmpSize_ShouldReturnCorrectSize_WhenNodelsValid)
{
    ...
    std::vector<std::unique_ptr<ge::TmpBufDesc>> result = CalcClipByValueTmpSize(*node);
