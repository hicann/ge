...
namespace ge {
namespace ascir {
extern std::vector<std::unique_ptr<ge::TmpBufDesc>> CalcTanhTmpSizeV2(const ge::AscNode &node);
...
TEST_F(CalcTanhTmpSizeV2Test, CalcTanhTmpSizeV2_ShouldReturnCorrectSize_WhenInputsIsFLOAT)
{
    ...
    *y.y.strides = {s1, Symbol(1)};
    ...
    std::vector<std::unique_ptr<ge::TmpBufDesc>> result = CalcTanhTmpSizeV2(*node);
