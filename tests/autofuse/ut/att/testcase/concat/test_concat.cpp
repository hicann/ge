...
void PrintResult(AscGraph0ScheduleResult0G0TilingData& tilingData0,AscGraph0ScheduleResult1G0TilingData& tilingData1) {
  ...
  std::cout << "tmp_tbuf_size"<< " = " << tilingData0.get_tmp_tbuf_size() << std::endl;
  std::cout << "tmp_tbuf_0_size"<< " = " << tilingData0.get_tmp_tbuf_0_size() << std::endl;
  ...
  std::cout << "tmp_tbuf_0_size"<< " = " << tilingData1.get_tmp_tbuf_0_size() << std::endl;
