...
TEST_F(UTestAscirPerfV2, TestLoadApiForTypev1) {
  ...
  input_shapes[0].repeats = {z0t_size, z1t_size, CreateExpr(512)};
  ...
  output_shapes[0].repeats = {z0t_size, z1t_size, CreateExpr(512)};
  ...
  EXPECT_EQ(Str(res.Replace(ret)),
            "((2048 * z0t_size * z1t_size / (((6.61549997329712 / (block_dim)) + 11.8291997909546))) + 160.0)");
}
...
TEST_F(UTestAscirPerfV2, TestStoreApiForType) {
  ...
  auto tenary_ops = perf_res.tenary_ops;
  auto ret = ConcursiveReplaceVars(tenary_ops);
  EXPECT_EQ(Str(res.Replace(ret)), "((1904 * z0z1t_size * z6t_size / (((10.2650003433228 / (block_dim)) + 11.7740001678467))) + (63.8714996539056 * z0z1t_size * z6t_size) + 160.0)");
}
...
TEST_F(UTestAscirPerfV2, TestGetMicroApiPerf) {
  AbsAscIrAttImplV2 default_ir_att_v2;
  EXPECT_TRUE(strcmp(ge::PtrToPtr<void, ge::char_t>(default_ir_att_v2.GetMicroApiPerf()), "AbsV2") == 0);
}
...
TEST_F(UTestAscirPerfV2, TestGetAddApiPerf) {
  ...
  EXPECT_TRUE(strcmp(ge::PtrToPtr<void, ge::char_t>(add_ir_att_v2.GetMicroApiPerf()), "AddV2") == 0);
