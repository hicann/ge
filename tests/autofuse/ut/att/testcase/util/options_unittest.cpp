...
TEST_F(OptionsUnitTest, TestValidateAttScenarioType) {
  EXPECT_EQ(ValidateAttScenarioType(kAttToolsScenario), true);
  EXPECT_EQ(ValidateAttScenarioType(kAutofuseScenario), true);
  EXPECT_EQ(ValidateAttScenarioType(""), false);
}
}  // namespace att