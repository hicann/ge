 ...
 *  netoutput
 */
TEST_F(UtestFusionStrategySolver, Fuse_gather_reduce) {
 ...
 *  netoutput
 */
TEST_F(UtestFusionStrategySolver, Fuse_gather_reduce_broadcast) {
  PlatformContext::GetInstance().Reset();
  auto stub_v2 = std::make_shared<RuntimeStubV2Common>();
  RuntimeStub::SetInstance(stub_v2);
  class MockFusionDecider : public AscBackendFusionDecider {
 ...
 *    netoutput
 */
TEST_F(UtestFusionStrategySolver, Fuse_concat_backward) {
  PlatformContext::GetInstance().Reset();
  auto stub_v2 = std::make_shared<RuntimeStubV2Common>();
  RuntimeStub::SetInstance(stub_v2);
  class ConcatFusionDecider : public AscBackendFusionDecider {
...
TEST_F(UtestFusionStrategySolver, Concat_Fuse_For_CacheGraph) {
  ...
  FusionStrategySolver fusion_strategy_solver;
  EXPECT_EQ(fusion_strategy_solver.Fuse(graph), SUCCESS);
  (void)setenv("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST", "Abs,Sqrt,Rsqrt,Sum;", 0);
  (void)setenv("EXPERIMENTAL_DUMP_CACHE_GRAPHS", "F_complete_asc_io_index_before,F,fused_graph_1444,fused_graph_1454;", 0);
  AutoFuseConfig::MutableConfig().GetMutableFusionStrategySolver().improve_precision_blacklist =
  ...
  (void)unsetenv("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST");
  (void)unsetenv("EXPERIMENTAL_DUMP_CACHE_GRAPHS");
