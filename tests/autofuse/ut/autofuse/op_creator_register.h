...
void RegisterConv2DAndBNOps() {
  RegisterVecInputTypeOpCreatorV2(
      "Conv2D", {"x", "filter", "bias", "offset_w"},
      {ge::kIrInputRequired, ge::kIrInputRequired, ge::kIrInputOptional, ge::kIrInputOptional}, {"y"},
      kIrOutputRequired, {"strides", "pads", "dilations", "groups", "data_format", "offset_x"});
  RegisterVecInputTypeOpCreatorV2(
      "Conv2DBias", {"x", "filter", "bias"}, {ge::kIrInputRequired, ge::kIrInputRequired, ge::kIrInputOptional}, {"y"},
      kIrOutputRequired, {"strides", "pads", "dilations", "groups", "data_format", "offset_x"});
  RegisterVecInputTypeOpCreatorV2(
      "Conv2DOffset", {"x", "filter", "offset_w"}, {ge::kIrInputRequired, ge::kIrInputRequired, ge::kIrInputOptional},
      {"y"}, kIrOutputRequired, {"strides", "pads", "dilations", "groups", "data_format", "offset_x"});
  RegisterVecInputTypeOpCreatorV2(
      "Conv2DOffsetBias", {"x", "filter", "bias", "offset_w"},
      {ge::kIrInputRequired, ge::kIrInputRequired, ge::kIrInputOptional, ge::kIrInputOptional}, {"y"},
      kIrOutputRequired, {"strides", "pads", "dilations", "groups", "data_format", "offset_x"});
  RegisterVecInputTypeOpCreatorV2(
