...
TEST_F(LoopNodeLoweringUT, LoweringReluGrad) {
  ...
  EXPECT_EQ(kernel.Readable(),
            ...
            "tmp2 = ops.Load(\"features:0\")\n"
            "tmp3 = ops.Scalar(\"DT_FLOAT(0.00000000000000000000000000000000000001175494350822)\")\n"
            "tmp4 = ops.Scalar(\"DT_FLOAT(274877906944.000)\")\n"
            "tmp5 = ops.Scalar(\"DT_FLOAT(17592186044416.000)\")\n"
            "tmp6 = ops.Scalar(\"DT_FLOAT(17592186044416.000)\")\n"
            "tmp7 = ops.Broadcast(tmp3, \"[]->[d0, d1, d2]\")\n"
            "tmp8 = ops.Broadcast(tmp4, \"[]->[d0, d1, d2]\")\n"
            "tmp9 = ops.Broadcast(tmp6, \"[]->[d0, d1, d2]\")\n"
            "tmp10 = ops.Broadcast(tmp6, \"[]->[d0, d1, d2]\")\n"
            "tmp11 = ops.Scalar(\"DT_FLOAT(0)\")\n"
            "tmp12 = ops.Scalar(\"DT_FLOAT(0)\")\n"
            "tmp13 = ops.Broadcast(tmp12, \"[]->[d0, d1, d2]\")\n"
            "tmp14 = ops.Broadcast(tmp12, \"[]->[d0, d1, d2]\")\n"
            "tmp15 = ops.IsNan(tmp2)\n"
            "tmp16 = ops.Where(tmp15, tmp14, tmp2)\n"
            "tmp17 = ops.Minimum(tmp16, tmp7)\n"
            "tmp18 = ops.Maximum(tmp17, tmp14)\n"
            "tmp19 = ops.Mul(tmp18, tmp8)\n"
            "tmp20 = ops.Mul(tmp19, tmp10)\n"
            "tmp21 = ops.Mul(tmp20, tmp10)\n"
            "tmp22 = ops.Mul(tmp0, tmp21)\n"
            "tmp23 = ops.Store(\"ReluGrad_0:0\", tmp22)\n");
}
