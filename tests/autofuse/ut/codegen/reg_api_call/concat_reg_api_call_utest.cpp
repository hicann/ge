...
TEST_F(ConcatRegApiCallUTest, Unaligned_B8) {
  ...
  EXPECT_EQ(result,
            ...
            "concat::ConcatExtend<int8_t, 2>((int8_t *)local_3.GetPhyAddr(), concat_src_addrs, tmp_buf, concat_tiling);\n");
...
TEST_F(ConcatRegApiCallUTest, Unaligned_B8ToB16) {
  ...
  EXPECT_EQ(result,
            ...
            "concat::ConcatExtend<uint16_t, 2>((uint16_t *)local_3.GetPhyAddr(), concat_src_addrs, tmp_buf, concat_tiling);\n");
}
...
TEST_F(ConcatRegApiCallUTest, Unaligned_B16) {
  ...
  EXPECT_EQ(result,
            ...
            "concat::ConcatExtend<half, 2>((half *)local_3.GetPhyAddr(), concat_src_addrs, tmp_buf, concat_tiling);\n");
}
...
TEST_F(ConcatRegApiCallUTest, Unaligned_B32) {
  ...
  EXPECT_EQ(result,
            ...
            "concat::ConcatExtend<int32_t, 2>((int32_t *)local_3.GetPhyAddr(), concat_src_addrs, tmp_buf, concat_tiling);\n");
}
...
TEST_F(ConcatRegApiCallUTest, Unalign_B64) {
  ...
  EXPECT_EQ(result,
            ...
            "concat::ConcatExtend<uint32_t, 2>((uint32_t *)local_3.GetPhyAddr(), concat_src_addrs, tmp_buf, concat_tiling);\n");
}
