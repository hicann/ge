...
TEST(CodegenKernel, BinaryTmpApicall) {
  ...
  *logical_and_op.y.strides = {s1, One};
  ...
  EXPECT_EQ(result, std::string{
    "LogicalAnd(local_3[0], local_0[0], local_1[0], local_0_actual_size, tmp_buf);\n"
  });
}
...
TEST(CodegenKernel, BinaryTmpApicallLogicalOrWithFloatUbScalar) {
  ...
  *logical_or_op.y.strides = {s1, One};
  ...
  call.Generate(tpipe, current_axis, result);
  EXPECT_EQ(result, std::string{
    "LogicalOrScalarExtend(local_3[0], local_0[0], (float)local_1_ub_scalar, local_0_actual_size, tmp_buf);\n"
  });
}
...
TEST(CodegenKernel, BinaryTmpApicallLogicalOrWithUint8UbScalar) {
  ...
  *logical_or_op.y.strides = {s1, One};
  ...
  call.Generate(tpipe, current_axis, result);
  EXPECT_EQ(result, std::string{
    "LogicalOrScalarExtend(local_3[0], local_0[0], (uint8_t)local_1_ub_scalar, local_0_actual_size, tmp_buf);\n"
  });
}
...
TEST(CodegenKernel, BinaryTmpApicallLogicalOrWhenBothAreTensor) {
  ...
  *logical_or_op.y.strides = {s1, One};
  ...
  call.Generate(tpipe, current_axis, result);
  EXPECT_EQ(result, std::string{
    "LogicalOr(local_3[0], local_0[0], local_1[0], local_0_actual_size, tmp_buf);\n"
  });
}
...
TEST(CodegenKernel, BinaryTmpApicallBitwiseAnd) {
  ...
  *logical_and_op.y.strides = {s1, One};
  ...
  call.Generate(tpipe, current_axis, result);
  EXPECT_EQ(result, std::string{
    "BitwiseAnd(local_3[0], local_0[0], local_1[0], local_0_actual_size, tmp_buf);\n"
  });
}
