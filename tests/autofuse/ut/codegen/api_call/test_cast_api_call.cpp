...
TEST(CodegenKernel, CastApiCall_Zero_Stride) {
  ...
  *cast_op.y.strides = {s2, Zero, One};
  ...
  EXPECT_EQ(result, std::string{"CastExtend(local_1[0], local_0[0], local_0_actual_size, tmp_buf);\n"});
}
...
TEST(CodegenKernel, CastApiCall) {
  ...
  *cast_op.y.strides = {s1, One};
  ...
  EXPECT_EQ(result, std::string{
    "CastExtend(local_1[0], local_0[0], local_0_actual_size, tmp_buf);\n"
  });
}
...
TEST(CodegenKernel, CastApiCallTwoDimension) {
  ...
  *cast_op.y.strides = {s1 + s1, One};
  ...
  call.Generate(tpipe, current_axis, result);
  EXPECT_EQ(result, std::string{
    "CastExtend(local_1[0], local_0[0], t->s0, t->s1, (ConvertToUint32((16 * Ceiling((Rational(1 , 16) * t->s1))))), (ConvertToUint32((8 * Ceiling((Rational(1 , 8) * t->s1))))), 4, tmp_buf);\n"
  });
}
...
TEST(CodegenKernel, CastApiCallThreeDimension) {
  ...
  *cast_op.y.strides = {s1 * s2 + s1 * s2 + s1 * s2 , s2 + s2, One};
  ...
  call.Generate(tpipe, current_axis, result);
  EXPECT_EQ(result, std::string{
    "for(int outer_for_0 = 0; outer_for_0 < t->s0; outer_for_0++) {\nCastExtend(local_1[outer_for_0 * (ConvertToUint32((16 * Ceiling((Rational(1 , 8) * t->s2)) * t->s1)))], local_0[outer_for_0 * (ConvertToUint32((16 * Ceiling((Rational(1 , 16) * t->s2)) * t->s1)))], t->s1, t->s2, (ConvertToUint32((16 * Ceiling((Rational(1 , 16) * t->s2))))), (ConvertToUint32((8 * Ceiling((Rational(1 , 8) * t->s2))))), 4, tmp_buf);\n\n}\n"
  });
}
...
TEST(CodegenKernel, CastApiCall_Offset) {
  ...
  *cast_op.y.strides = {s1 * s2, s2, One};
  ...
  call.Generate(tpipe, current_axis, result);
  EXPECT_EQ(result, std::string{
    "CastExtend(local_1[0], local_0[0], t->s1, t->s2, (ConvertToUint32((16 * Ceiling((Rational(1 , 16) * t->s2))))), (ConvertToUint32((16 * Ceiling((Rational(1 , 16) * t->s2))))), 4, tmp_buf);\n"
  });
}
...
TEST(CodegenKernel, CastApiCall_WithMaskMode) {
  ...
  for (const auto &t : x_y_max_size_list) {
    ...
    *cast_op.y.strides = {s1 * s2, s2, One};
    ...
    std::string result;
    call.Generate(tpipe, current_axis, result);
    std::string expect = "CastExtend(local_1[0], local_0[0], t->s1, t->s2, (ConvertToUint32((16 * Ceiling((Rational(1 , 16) * t->s2))))), (ConvertToUint32((16 * Ceiling((Rational(1 , 16) * t->s2))))), " + max_size + ", tmp_buf);\n";
