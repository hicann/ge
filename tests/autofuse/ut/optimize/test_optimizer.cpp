...
TEST_F(TestOptimizer, TestSplitConcatAxisPass) {
  ...
  *g.y.repeats = {s0, s1 + s2};
  ...
  Exp j("j");
  j.attr.sched.axis = {z0.id, z1.id};
  j.x = a.y;
  *j.y.axis = {z0.id, z1.id};
  j.y.dtype = ge::DT_FLOAT;
  *j.y.strides = {s1, ge::ops::One};
  *j.y.repeats = {s0, s1};
  ...
  *h.y.repeats = {s0, s1 + s2};
  ...
  EXPECT_EQ(j_node->attr.sched.axis, size_c_in0);
  EXPECT_EQ(j_node->outputs[0].attr.axis, size_c_in0);
...
TEST_F(TestOptimizer, GatherLastAxisTest) {
  ...
  *gather.y.strides = {One, Zero};
  gather.attr.tmp_buffers = {{{ge::Symbol(8192), -1}, MemAttr()}};
...
TEST_F(TestOptimizer, ReducePartition) {
  ...
  *store_op1.y.repeats = {s0, s1};
  ...
  auto phase2_workspace2 = impl_graph_sum_phase2.FindNode("sum_to_broadcast_Workspace_0");
  auto sub_workspace = impl_graph_sub.FindNode("sum_to_broadcast_Workspace_0");
...
TEST_F(TestOptimizer, ReducePartitionLoad) {
  ...
  *b3_store.y.strides = {s3, One};
  ...
  auto max_phase2_workspace2 = impl_graph_max_phase2.FindNode("b0_max_to_b1_broadcast_Workspace_0");
  ...
  auto div_workspace = impl_graph_div.FindNode("b2_sum_to_b3_broadcast_Workspace_0");
...
TEST_F(TestOptimizer, ReducePartition4) {
  ...
  *store_op1.y.repeats = {s0, s1};
  ...
  auto phase2_workspace1 = impl_graph_phase2.FindNode("reduce_partition_0_r_multicore_phase_2_graph_workspace");
  auto phase2_workspace2 = impl_graph_phase2.FindNode("b2_sum_to_cast_Workspace_0");
  auto brc_workspace = impl_graph_brc.FindNode("b2_sum_to_cast_Workspace_0");
  ASSERT_NE(phase1_workspace, nullptr);
  ASSERT_NE(phase2_workspace1, nullptr);
  ASSERT_NE(phase2_workspace2, nullptr);
...
TEST_F(TestOptimizer, JustMutmul) {
...
TEST_F(TestOptimizer, MutmulAndAdd) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, MutmulAndBroadcastAdd) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, JustMutmulBias) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, JustMutmulOffset) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, JustMutmulBaisOffset) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, JustBatchMutmul) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, BatchMutmulAndAdd) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, BatchMutmulAndBroadcastAdd) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, MatmulAndCastBroadcastAdd) {
...
TEST_F(TestOptimizer, JustBatchMutmulBias) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, JustBatchMutmulOffset) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, JustBatchMutmulBaisOffset) {
  ge::AscGraph graph("mutmul");
...
TEST_F(TestOptimizer, MatmulAddExpAddAdd) {
  ge::AscGraph graph("matmul");
  auto s0 = graph.CreateSizeVar(64);
  auto s1 = graph.CreateSizeVar(64);
  auto z0 = graph.CreateAxis("z0", s0);
...
TEST_F(TestOptimizer, MatmulAndCastAdd) {
  ge::AscGraph graph("matmul");
...
TEST_F(TestOptimizer, MatmulAndCastMultiRefsAdd) {
  ge::AscGraph graph("matmul");
...
TEST_F(TestOptimizer, MatmulAndBrcLoadMultiRefsAdd) {
  ge::AscGraph graph("matmul");
...
TEST_F(TestOptimizer, MatmulAndCastBrcMultiRefsAdd) {
  ge::AscGraph graph("matmul");
