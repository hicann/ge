...
void ConstructReduceWithScalarData(AscGraph &graph) {
  ...
  *sum.y.strides = {ge::ops::Zero, ge::ops::Zero};
  ...
  ge::ascir_op::ScalarData scalar_data("scalar_data", graph);
  ...
  *store_op.y.strides = {ge::ops::Zero, ge::ops::Zero};
  *store_op.y.repeats = {ge::ops::One, ge::ops::One};
...
TEST_F(ReduceScheduleCaseGeneratorTest, TestReduce_ScalarData_Input) {
  ge::AscGraph graph("reduce_scalar_data_input");
