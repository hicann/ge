...
TEST_F(TestPyAscirTypes, HintComputeGraph_GetName) {
...
TEST_F(TestPyAscirTypes, FusedScheduledResult_IsCubeType) {
...
TEST_F(TestPyAscirTypes, FusedScheduledResult_IsCubeType_False) {
  PyObject *obj = pyascir::FusedScheduledResult::New(&pyascir::FusedScheduledResult::type, nullptr, nullptr);
  EXPECT_NE(obj, nullptr);
  pyascir::FusedScheduledResult::Init(obj, nullptr, nullptr);
...
TEST_F(TestPyAscirTypes, FusedScheduledResult_IsCubeType_Null) {
  PyObject *obj = pyascir::FusedScheduledResult::New(&pyascir::FusedScheduledResult::type, nullptr, nullptr);
  EXPECT_NE(obj, nullptr);
  pyascir::FusedScheduledResult::Init(obj, nullptr, nullptr);
