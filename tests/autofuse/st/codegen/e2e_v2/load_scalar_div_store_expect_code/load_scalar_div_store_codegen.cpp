...
TEST_F(LoadScalarDivStoreTest, LoadScalarDivStoreCodegen) {
  ...
  ge::AscGraph test_graph("load_scalar_div_store");
  std::string tilig_stub = R"(
#define REGISTER_TILING_DEFAULT(tiling)
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
)";
  LoadScalarDivStore_BeforeAutofuse(test_graph, ge::DT_FLOAT, ge::DT_FLOAT);
  LoadScalarDivStore_AfterInferOutput(test_graph, ge::DT_FLOAT, ge::DT_FLOAT);

  std::vector<ge::AscGraph> test_impl_graphs = {ge::AscGraph("load_scalar_div_store_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = ge::AscendString("load_scalar_div_store");
