...
double AxesReorderSolvercase0::GetPerf() {
  ...
  double AIV_MTE2 = ((15.8900003433228 * block_dim) + (2 * TenaryOp((4 * z0z1t_size) < 25000, TenaryOp(IsEqual(False, 0), ((4 * z0z1t_size / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818), ((512 / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818)), ((4 * z0z1t_size / (((15.8959999084473 / (block_dim)) + 9.90740013122559))) + 27.0100002288818)) * z0z1Tb_size) + 882.090026855469);
  double AIV_MTE3 = ((TenaryOp(IsEqual(Mod(z0z1t_size, 8), 0), ((4 * z0z1t_size / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879), TenaryOp((-512 + z0z1t_size) < 0, TenaryOp((-8 + z0z1t_size) < 0, (((-2.20000004768372 - (0.101000003516674 * block_dim)) * 4 * z0z1t_size) + (8.89000034332275 * block_dim) + 108.329998016357), ((2.0 * z0z1t_size) + 1.29999995231628)), (((256 - ((512 / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879)) * 1.0) + (4 * z0z1t_size / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879))) * z0z1Tb_size) + 497.359985351562);
...
/*
 ...
 Exe time & Perf time used for tiling case 0 is:
  ...
  Add_out0_graph/Load_0_AIV_MTE2_perf:TenaryOp((4 * z0z1t_size) < 25000, TenaryOp(IsEqual(False, 0), ((4 * z0z1t_size / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818), ((512 / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818)), ((4 * z0z1t_size / (((15.8959999084473 / (block_dim)) + 9.90740013122559))) + 27.0100002288818))
  Add_out0_graph/Load_0_exe_time:z0z1Tb_size
  Add_out0_graph/Load_1_AIV_MTE2_perf:TenaryOp((4 * z0z1t_size) < 25000, TenaryOp(IsEqual(False, 0), ((4 * z0z1t_size / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818), ((512 / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818)), ((4 * z0z1t_size / (((15.8959999084473 / (block_dim)) + 9.90740013122559))) + 27.0100002288818))
  Add_out0_graph/Load_1_exe_time:z0z1Tb_size
  Add_out0_graph/Store_0_AIV_MTE3_perf:TenaryOp(IsEqual(Mod(z0z1t_size, 8), 0), ((4 * z0z1t_size / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879), TenaryOp((-512 + z0z1t_size) < 0, TenaryOp((-8 + z0z1t_size) < 0, (((-2.20000004768372 - (0.101000003516674 * block_dim)) * 4 * z0z1t_size) + (8.89000034332275 * block_dim) + 108.329998016357), ((2.0 * z0z1t_size) + 1.29999995231628)), (((256 - ((512 / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879)) * 1.0) + (4 * z0z1t_size / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879)))
...
void DoApiTiling(AutofuseTilingData &tiling_data) {
  ...
  double GetAIV_MTE2(AutofuseTilingData& tiling_data) {
    ...
    return ((15.8900003433228 * block_dim) + (2 * TenaryOp((4 * z0z1t_size) < 25000, TenaryOp(IsEqual(False, 0), ((4 * z0z1t_size / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818), ((512 / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + 27.0100002288818)), ((4 * z0z1t_size / (((15.8959999084473 / (block_dim)) + 9.90740013122559))) + 27.0100002288818)) * z0z1Tb_size) + 882.090026855469);
  }
  ...
  double GetAIV_MTE3(AutofuseTilingData& tiling_data) {
    ...
    return ((TenaryOp(IsEqual(Mod(z0z1t_size, 8), 0), ((4 * z0z1t_size / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879), TenaryOp((-512 + z0z1t_size) < 0, TenaryOp((-8 + z0z1t_size) < 0, (((-2.20000004768372 - (0.101000003516674 * block_dim)) * 4 * z0z1t_size) + (8.89000034332275 * block_dim) + 108.329998016357), ((2.0 * z0z1t_size) + 1.29999995231628)), (((256 - ((512 / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879)) * 1.0) + (4 * z0z1t_size / (((3.78999996185303 / (block_dim)) + 9.96000003814697))) + 12.0900001525879))) * z0z1Tb_size) + 497.359985351562);
  }
