...
class LoadGather_B_T_AbsStoreST : public testing::Test {
};

TEST_F(LoadGather_B_T_AbsStoreST, LoadGather_B_T_AbsStoreCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  LoadGather_B_T_AbsStore_AfterAutofuse(impl_graph, ge::DT_FLOAT);
