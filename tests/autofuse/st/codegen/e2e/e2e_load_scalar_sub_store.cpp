...
void LoadScalarSubStore_BeforeAutofuse(ge::AscGraph &graph, ge::DataType in_data_type, ge::DataType out_data_type) {
...
void LoadScalarSubStore_AfterInferOutput(ge::AscGraph &graph, ge::DataType in_data_type, ge::DataType out_data_type) {
...
void LoadScalarSubStore_AfterGetApiInfo(ge::AscGraph &graph) {
  auto x1 = graph.FindNode("x1");
...
void LoadScalarSubStore_AfterScheduler(ge::AscGraph &graph) {
...
void LoadScalarSubStore_AfterQueBufAlloc(ge::AscGraph &graph) {
  auto x1 = graph.FindNode("x1");
