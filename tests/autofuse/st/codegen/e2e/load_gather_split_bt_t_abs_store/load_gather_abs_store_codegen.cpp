...
class LoadGather_BT_T_AbsStoreST : public testing::Test {
};

TEST_F(LoadGather_BT_T_AbsStoreST, LoadGather_BT_T_AbsStoreCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  LoadGather_BT_T_AbsStore_AfterAutofuse(impl_graph, ge::DT_FLOAT);
