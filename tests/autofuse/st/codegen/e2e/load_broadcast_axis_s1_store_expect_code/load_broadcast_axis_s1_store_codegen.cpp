...
TEST_F(LoadBroadcastAxisS1StoreTest, LoadBroadcastAxisS1StoreCodegen) {
  ...
  ge::AscGraph graph("load_broadcast_axis_s1_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  ge::AscGraph impl_graph("load_broadcast_axis_s1_store_general_0_nil_0_nil");
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = ge::AscendString("load_broadcast_axis_s1_store");
