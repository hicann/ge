...
TEST_F(LoadStoreUT, DiscreteStoreMergeAxisCodegen) {
  ...
  ge::AscGraph test_graph("discrete_store_merge_axis");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<ge::AscGraph> test_impl_graphs = {ge::AscGraph("discrete_store_merge_axis_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = ge::AscendString("discrete_store_merge_axis");
