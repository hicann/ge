...
#include "codegen.h"
#include "e2e_load_transpose_store.h"
...
class LoadTransposeStoreTest : public testing::Test {
};

TEST_F(LoadTransposeStoreTest, LoadTransposeStoreCodegen) {

  bool gen_success= true;
  ge::AscGraph test_graph("load_transpose_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData *)tiling;
  ...
  std::vector<ge::AscGraph> test_impl_graphs = {ge::AscGraph("load_transpose_store_general_0_nil_0_nil")};
  ...
  std::string kernel_src_file_name = parts[0];      // load_transpose_store_kernel.cpp
  std::string tiling_src_file_name = parts[1];      // load_transpose_store_tiling.cpp
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = ge::AscendString("load_transpose_store");
