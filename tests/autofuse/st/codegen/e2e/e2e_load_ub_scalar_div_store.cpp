...
void LoadUbScalarDivStore_BeforeAutofuse(ge::AscGraph &graph, ge::DataType in_data_type, ge::DataType out_data_type) {
...
void LoadUbScalarDivStore_AfterInferOutput(ge::AscGraph &graph, ge::DataType in_data_type, ge::DataType out_data_type) {
...
void LoadUbScalarDivStore_AfterGetApiInfo(ge::AscGraph &graph) {
    auto x1 = graph.FindNode("x1");
...
void LoadUbScalarDivStore_AfterScheduler(ge::AscGraph &graph) {
...
void LoadUbScalarDivStore_AfterQueBufAlloc(ge::AscGraph &graph) {
    auto x1 = graph.FindNode("x1");
