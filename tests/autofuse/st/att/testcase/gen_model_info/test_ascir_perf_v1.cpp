...
TEST_F(STestAscirPerfV1, TestMicroApiPerfTableSize) {
  AbsAscIrAttImpl default_ir_att_v1;
  EXPECT_NE(default_ir_att_v1.GetAscendCApiPerfTable(), nullptr);
}

TEST_F(STestAscirPerfV1, TestGetMicroApiPerf) {
  AbsAscIrAttImpl default_ir_att_v1;
  EXPECT_NE(default_ir_att_v1.GetMicroApiPerf(), nullptr);
}
...
TEST_F(STestAscirPerfV1, TestGetAddApiPerf) {
  ...
  EXPECT_NE(add_ir_att_v1.GetMicroApiPerf(), nullptr);
