...
TEST_F(TestAscendcApiPerf, TestLoadApiForTypev1) {
  ...
  EXPECT_EQ(Str(iter->second),
            "TenaryOp(z1t_size < z0t_size, (TenaryOp((4 * z0t_size * z1t_size) < 25000, TenaryOp(IsEqual(False, 0), "
            "((0.0700000002980232 * Mod(((64 * z0t_size) + -64), 256) * z0t_size) + (4 * z0t_size * z1t_size / "
            ...
            "Mod(((64 * z0t_size) + -64), 256) * z0t_size) + (4 * z0t_size * z1t_size / (((15.8959999084473 / "
            "(block_dim)) + 9.90740013122559))) + 27.0100002288818)) * z1t_size), (TenaryOp((256 * z1t_size) < 25000, "
            "TenaryOp(IsEqual(False, 0), ((256 * z1t_size / (((7.30999994277954 / (block_dim)) + 7.90520000457764))) + "
