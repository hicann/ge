...
class TestSelectModel : public ::testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    config.scenario_type = TilingScenarioType::ATT_TOOLS;
    ...
    std::system("g++ -DDEBUG tiling_func_select_main.cpp OpTest3_*_tiling_func.cpp -I ./ -o tiling_func_select_main");
  }
