...
class TestBackendCompareX2TensorE2e : public testing::Test {
};

TEST_F(TestBackendCompareX2TensorE2e, CompareX2TensorE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::CompareFusedGraph(2, true, ge::DT_FLOAT, "gt");
