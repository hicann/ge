...
class TestBackendCompareX2TensorInt32E2e : public testing::Test {
};

TEST_F(TestBackendCompareX2TensorInt32E2e, CompareX2TensorInt32E2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::CompareFusedGraph(2, true, ge::DT_INT32, "gt");
