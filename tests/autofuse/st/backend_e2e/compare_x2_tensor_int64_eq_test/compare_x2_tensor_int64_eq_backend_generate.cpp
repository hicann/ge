...
class TestBackendCompareX2TensorInt64EqE2e : public testing::Test {
};

TEST_F(TestBackendCompareX2TensorInt64EqE2e, CompareX2TensorInt64EqE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::CompareFusedGraph(2, true, ge::DT_INT64, "eq");
