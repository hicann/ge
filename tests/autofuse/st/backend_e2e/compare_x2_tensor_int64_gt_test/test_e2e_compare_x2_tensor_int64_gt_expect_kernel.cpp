...
class E2E_BackendCompareX2TensorInt64Gt_Code : public testing::Test, public testing::WithParamInterface<std::vector<int>> {
};

TEST_P(E2E_BackendCompareX2TensorInt64Gt_Code, CalculateCorrect) {
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_BackendCompareX2TensorInt64Gt_Code,
    ::testing::Values(std::vector<int>{32, 7}, // 用例输入的维度需要与构图接口的dims_size匹配
                      std::vector<int>{32, 40},
                      std::vector<int>{2, 72}
                      ));
