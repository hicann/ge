...
class TestBackendConcatAllAlignedE2e : public testing::Test {
 protected:
};

TEST_F(TestBackendConcatAllAlignedE2e, ConcatE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  ge::AscGraph graph("concat_all_aligned_test");
  ascir::ShareGraph::ConcatAscGraph(graph, {"100", "8"});
