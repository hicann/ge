...
class TestBackendCompareE2e : public testing::Test {
};

TEST_F(TestBackendCompareE2e, CompareE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::CompareFusedGraph(2, false, ge::DT_FLOAT, "eq");
