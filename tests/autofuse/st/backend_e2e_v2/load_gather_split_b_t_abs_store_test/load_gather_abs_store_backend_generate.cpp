...
class TestBackendGatherAbsStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendGatherAbsStoreE2e, LoadGather_B_T_AbsStoreCodegen) {
  bool gen_success = true;
  std::string tilig_stub = R"(
#define REGISTER_TILING_DEFAULT(tiling)
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
)";
  auto graph = ascir::ShareGraph::LoadGatherAbsStore(2, ge::DT_FLOAT);
