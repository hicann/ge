...
class TestBackendFloorDivMulLessEqualSelectE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendFloorDivMulLessEqualSelectE2e, FloorDivMulLessEqualSelectE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::FloorDivMulLessEqualSelectFusedGraph(3);
