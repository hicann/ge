...
class TestBackendBrcReduceAddE2e : public testing::Test {
  void SetUp() override {
...
TEST_F(TestBackendBrcReduceAddE2e, BrcReduceE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::BrcReduceFusedGraph(3);
