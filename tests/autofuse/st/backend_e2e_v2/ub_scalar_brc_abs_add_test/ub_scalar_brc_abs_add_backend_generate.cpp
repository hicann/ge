...
class TestBackendUbScalarBrcAbsAddE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendUbScalarBrcAbsAddE2e, UbScalarBrcAbsAddE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::UbScalarBrcAbsAddFusedGraph(2);
