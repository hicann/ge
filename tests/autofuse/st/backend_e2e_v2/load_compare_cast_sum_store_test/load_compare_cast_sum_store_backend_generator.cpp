...
class TestBackendLoadCompareCastSumStoreE2e : public testing::Test {
  protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadCompareCastSumStoreE2e, LoadCompareCastSumStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadCompareCastSumStoreFusedGraph(3);
