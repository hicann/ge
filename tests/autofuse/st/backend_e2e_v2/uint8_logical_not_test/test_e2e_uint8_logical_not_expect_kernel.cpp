...
class E2E_BackendUint8LogicalNot_Code : public testing::Test, public testing::WithParamInterface<std::vector<int>> {
};

TEST_P(E2E_BackendUint8LogicalNot_Code, CalculateCorrect) {
  ...
  uint8_t* x = (uint8_t *)AscendC::GmAlloc(test_size * sizeof(uint8_t) + 32);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_BackendUint8LogicalNot_Code,
