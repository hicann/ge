...
class E2E_BackendInt32LogicalNot_Code : public testing::Test, public testing::WithParamInterface<std::vector<int>> {
};

TEST_P(E2E_BackendInt32LogicalNot_Code, CalculateCorrect) {
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_BackendInt32LogicalNot_Code,
