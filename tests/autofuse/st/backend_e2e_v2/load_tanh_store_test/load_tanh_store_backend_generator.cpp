...
class TestBackendLoadTanhStoreE2e : public testing::Test {
  protected:
  void SetUp() override {
...
TEST_F(TestBackendLoadTanhStoreE2e, LoadTanhStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadTanhStoreFusedGraph(2);
