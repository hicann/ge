...
extern "C" __global__ __aicore__ void abs_brc_add_test(GM_ADDR x0, GM_ADDR output, GM_ADDR workspace, GM_ADDR gm_tiling_data);
...
TEST_P(E2E_ScalarBrcAdd_Code, CalculateCorrect){
 ...
 ICPU_RUN_KF(abs_brc_add_test, tiling_data.block_dim, (uint8_t *)x0, (uint8_t *)y, nullptr, (uint8_t*)&tiling_data);
