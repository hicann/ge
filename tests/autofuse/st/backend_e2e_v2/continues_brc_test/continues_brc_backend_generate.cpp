...
class TestBackendContinuesBrcAddE2e : public testing::Test {
  void SetUp() override {
...
TEST_F(TestBackendContinuesBrcAddE2e, ContinuesBrcE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::map<std::string, std::string> shape_info(
        { {"s0", "stub_s0"}, {"s1", "stub_s1"}, {"s2", "stub_s2"}, {"s3", "stub_s3"}, {"s4", "stub_s4"} }
    );
  auto graph = ascir::ShareGraph::ContinuesBrcFusedGraph(5);
