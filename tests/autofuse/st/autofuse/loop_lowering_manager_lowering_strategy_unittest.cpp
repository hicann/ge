...
class LoopGraphLoweringStrategyST : public testing::Test {
 public:
 protected:
  void SetUp() override {
...
class LoopGraphLoweringStrategySTV2 : public testing::Test {
public:
protected:
  void SetUp() override {
...
TEST_F(LoopGraphLoweringStrategyST, SimpleIn2Out1Lowering) {
  [this]() {
...
TEST_F(LoopGraphLoweringStrategyST, RealizeAsTooManyOps) {
  size_t num_ops = 50U;
  [this, num_ops]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, RealizeAsTooManyLoads) {
  size_t num_ops = 50U;
  [this, num_ops]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, RealizeAsReduction) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, RealizeAsReductionFailure) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, SkipReductionAsDisabled) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto axis = CreateConst(*es_graph_, ge::DT_INT32, {1}, std::vector<int32_t>{1});
...
TEST_F(LoopGraphLoweringStrategyST, SkipConcatAsDisabled) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
...
TEST_F(LoopGraphLoweringStrategySTV2, SkipSplitAsDisabled) {
  [this]() {
...
TEST_F(LoopGraphLoweringStrategyST, SkipSliceOutputNoSymbolic) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
...
TEST_F(LoopGraphLoweringStrategyST, SkipSliceAsDisabled) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"192", "64", "33"});
    std::vector<int64_t> begin = {0, 0, 1};
...
TEST_F(LoopGraphLoweringStrategyST, SkipGatherAsDisabled) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto data1 = es_graph_->CreateInput(1, "data1", nullptr);
...
TEST_F(LoopGraphLoweringStrategyST, SkippedFuseToAscBackendAsTooFewAscIrNodes) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    auto data1 = es_graph_->CreateInput(1, "data1", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, FuseToAscBackendAsConfigured) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    auto data1 = es_graph_->CreateInput(1, "data1", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, OriginComputeGraphIsCorrect) {
  size_t num_ops = 2U;
  [this, num_ops]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, SkipFuseAsDifferentStreamLabel) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, FuseAsSameStreamLabel) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto exp1 = es::Abs(data0);
...
TEST_F(LoopGraphLoweringStrategyST, FuseAsOnesideStreamLabelCase1) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto exp1 = es::Abs(data0);
...
TEST_F(LoopGraphLoweringStrategyST, FuseAsOnesideStreamLabelCase2) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto exp1 = es::Abs(data0);
...
TEST_F(LoopGraphLoweringStrategyST, FuseCaseStreamLabelLabel1ThenNULLThenLabel2) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto exp1 = es::Abs(data0);
...
TEST_F(LoopGraphLoweringStrategyST, NodeWithControlIfLoweringNotUseInputData) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, NodeInputCanRealizeEvenLoweringNotUseInputData) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, NodeLiftSucceedIfLoweringNotUseInputData) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, LiftingOneNodeAsOnlyOneCanfusePointwise) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto abs = es::Abs(data0);
...
TEST_F(LoopGraphLoweringStrategyST, LiftingOneNodeAsOnlyOneCanfuseReduction) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, LiftingOneNodeAsOutputDontUseInputData) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto abs = es::Abs(data0);
...
TEST_F(LoopGraphLoweringStrategyST, LiftingOneNodeAsOutputDontUseInputDataButFused) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto abs = es::Abs(data0);
...
TEST_F(LoopGraphLoweringStrategyST, LiftingCombinedOneNodeAscBackendOp) {
  size_t num_ops = 3U;
  [this, num_ops]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, DynamicOutputLiftingAsAllNodesNeedLifting) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, DynamicOutputSkipLiftingAsOneNodesFused) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
    auto n = es::DynamicQuant(data0);  // Don't care op type, Just for multi output
...
TEST_F(LoopGraphLoweringStrategyST, TriggerRealizeAsControlEdges) {
  [this]() {
...
TEST_F(LoopGraphLoweringStrategyST, SkipRealizeAsControlEdgesFromCF) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs1 = es::Abs(data);  // 3 inputs
...
TEST_F(LoopGraphLoweringStrategyST, TriggerRealizeAsHeavyOps) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, TriggerRealizeAsTooManyReaders) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs = es::Abs(data);
...
TEST_F(LoopGraphLoweringStrategyST, NotTriggerRealizeAsUnreachNumReaders) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs = es::Abs(data);
...
TEST_F(LoopGraphLoweringStrategyST, TriggerRealizeInputsAndLoweringAndSucceed) {
  [this]() {
...
TEST_F(LoopGraphLoweringStrategyST, TriggerRealizeInputsAsTooManyOpsAndLoweringAndSucceed) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs1 = es::Abs(data);  // 3 inputs
...
TEST_F(LoopGraphLoweringStrategyST, TriggerRealizeInputsAsTooManyOpsAndLoweringAndFallback) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs1 = es::Abs(data);  // 3 inputs
...
TEST_F(LoopGraphLoweringStrategyST, FallbackLoweringAsInSuperKernelScope1) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs1 = es::Abs(data);  // 3 inputs
...
TEST_F(LoopGraphLoweringStrategyST, FallbackLoweringAsInSuperKernelScope2) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs1 = es::Abs(data);  // 3 inputs
...
TEST_F(LoopGraphLoweringStrategyST, FallbackLoweringAsInDiableAutofuseScope) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, DropLoweringResultAsUnsupportedDtype) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, KeepLoweringResultAsSupportedDtype) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs1 = es::Abs(data);
...
TEST_F(LoopGraphLoweringStrategyST, DropLowerResultForScalarGraph) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({});
    auto abs = es::Abs(data);
...
TEST_F(LoopGraphLoweringStrategyST, DropLowerResultForScalarGraphShape1) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
...
TEST_F(LoopGraphLoweringStrategyST, InputOutputDescCopiedFromOriginBuffer) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"s0", "s1", "s2"});
    auto abs = es::Abs(data);
...
TEST_F(LoopGraphLoweringStrategyST, LoweringEmptyTensor1) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
...
TEST_F(LoopGraphLoweringStrategyST, LoweringEmptyTensor2) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
    data.SetSymbolShape({"0", "s0", "s1"});
    auto abs = es::Abs(data);
...
TEST_F(LoopGraphLoweringStrategyST, LoweringCheckDType) {
  [this]() {
    auto data = es_graph_->CreateInput(0, "data0", nullptr);
...
TEST_F(LoopGraphLoweringStrategyST, LoweringReduceSumFP16) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"s0", "s1", "s2"});
...
TEST_F(LoopGraphLoweringStrategyST, MatMul) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    auto data1 = es_graph_->CreateInput(1, "data1", nullptr);
...
TEST_F(LoopGraphLoweringStrategyST, BatchMatMul) {
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    auto data1 = es_graph_->CreateInput(1, "data1", nullptr);
    auto offset_w = es_graph_->CreateInput(2, "offset_w", nullptr);
