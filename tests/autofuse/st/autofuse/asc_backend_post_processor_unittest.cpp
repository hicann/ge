...
#include "post_process/scheduler_adapter/asc_backend_scheduler_adapter.h"
...
TEST_F(AscBackendPostProcessorTest, ImprovePrecision_BlackList1) {
  ...
  AscBackendPostProcessor post_processor;
  EXPECT_EQ(asc_adapt::GeFallback(compute_graph), SUCCESS);
  (void)setenv("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST", "Abs,", 0);
...
TEST_F(AscBackendPostProcessorTest, ImprovePrecision_BlackList2) {
  ...
  AscBackendPostProcessor post_processor;
  EXPECT_EQ(asc_adapt::GeFallback(compute_graph), SUCCESS);
  (void)setenv("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST", "Abs,Sqrt", 0);
  AutoFuseConfig::MutableConfig().GetMutableFusionStrategySolver().improve_precision_blacklist =
      ReadImprovePrecisionBlacklist("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST");
  (void)unsetenv("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST");
...
TEST_F(AscBackendPostProcessorTest, ImprovePrecision_BlackList3) {
  ...
  AscBackendPostProcessor post_processor;
  EXPECT_EQ(asc_adapt::GeFallback(compute_graph), SUCCESS);
  (void)setenv("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST", "Abs,Sqrt,Rsqrt", 0);
  AutoFuseConfig::MutableConfig().GetMutableFusionStrategySolver().improve_precision_blacklist =
      ReadImprovePrecisionBlacklist("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST");
  (void)unsetenv("EXPERIMENTAL_AUTOFUSE_ENHANCE_PRECISION_BLACKLIST");
  EXPECT_EQ(AutoFuseConfig::MutableConfig().GetMutableFusionStrategySolver().improve_precision_blacklist.find("Abs") !=
