...
void CheckComputeNodeOrderEqualToExecuteNodeOrder(const ge::ComputeGraphPtr &graph, const ExecutorStatistician *ess) {
  ...
  execute_node_order.emplace_back(ess->GetExecuteIndexByNodeNameAndKernelType("transdata_10", "LaunchKernelV2"));
  execute_node_order.emplace_back(
      ess->GetExecuteIndexByNodeNameAndKernelType("transdata_8_AtomicClean", "AtomicLaunchKernelV2"));
  execute_node_order.emplace_back(ess->GetExecuteIndexByNodeNameAndKernelType("transdata_8", "LaunchKernelV2"));
  execute_node_order.emplace_back(
      ess->GetExecuteIndexByNodeNameAndKernelType("transdata_4_AtomicClean", "AtomicLaunchKernelV2"));
  execute_node_order.emplace_back(ess->GetExecuteIndexByNodeNameAndKernelType("transdata_4", "LaunchKernelV2"));
  execute_node_order.emplace_back(
      ess->GetExecuteIndexByNodeNameAndKernelType("transdata_13_AtomicClean", "AtomicLaunchKernelV2"));
  execute_node_order.emplace_back(ess->GetExecuteIndexByNodeNameAndKernelType("transdata_13", "LaunchKernelV2"));
  execute_node_order.emplace_back(
      ess->GetExecuteIndexByNodeNameAndKernelType("transdata_15_AtomicClean", "AtomicLaunchKernelV2"));
  execute_node_order.emplace_back(ess->GetExecuteIndexByNodeNameAndKernelType("transdata_15", "LaunchKernelV2"));
  execute_node_order.emplace_back(
      ess->GetExecuteIndexByNodeNameAndKernelType("transdata_17_AtomicClean", "AtomicLaunchKernelV2"));
  execute_node_order.emplace_back(ess->GetExecuteIndexByNodeNameAndKernelType("transdata_17", "LaunchKernelV2"));
