...
TEST_F(Om2St, ConvertOm2Model_Ok_GenOm2WithAicoreNode) {
  ...
  const auto interface_buf = archive.ExtractToMem("fake_test/data/model_0/runtime/csrc/g1_internal.h", interface_size);
...
TEST_F(Om2St, ConvertOm2Model_Ok_GenOm2WithAtomicAicoreNode) {
  ...
  const std::set<std::string> expect_files = {
      ...
      "fake_test_atomic/data/model_0/runtime/csrc/om2_model_api.h",
