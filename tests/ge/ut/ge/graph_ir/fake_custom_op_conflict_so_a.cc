...
constexpr char kFakeSoMark[] = "fake-conflict-a";

class FakeConflictedOpA : public ge::BaseCustomOp {};

ge::BaseCustomOp *CreateFakeConflictedOpA() {
  return new (std::nothrow) FakeConflictedOpA();
}
...
extern "C" int32_t GetRegisteredCustomOpCreators(ge::CustomOpTypeToCreator *creators, const size_t creator_num,
  ...
  creators[0] = ge::CustomOpTypeToCreator{sizeof(ge::CustomOpTypeToCreator), kFakeOpType, &CreateFakeConflictedOpA,
