...
#include "host_kernels/array_ops/expanddims_kernel.h"
...
class UtestGraphPassesFoldingKernelExpandDimsKernel : public testing::Test {
 protected:
  ...
  void EXPECT_TestExpandDims(vector<int64_t> &data_vec, vector<inner_dim_type> &dim_value_vec, vector<int64_t> &result) {
  ...
  void EXPECT_TestInvalidExpandDims(vector<int64_t> &data_vec, vector<inner_dim_type> &dim_value_vec,
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Int8Int32Case0) {
  ...
  EXPECT_TestExpandDims<int8_t, DT_INT8, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Int16Int32) {
  ...
  EXPECT_TestExpandDims<int16_t, DT_INT16, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Int32Int32) {
  ...
  EXPECT_TestExpandDims<int32_t, DT_INT32, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Int64Int32) {
  ...
  EXPECT_TestExpandDims<int64_t, DT_INT64, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Uint8Int32) {
  ...
  vector<int32_t> dim_value_vec = {-1};
  vector<int64_t> result = {2, 3, 1};
  EXPECT_TestExpandDims<uint8_t, DT_UINT8, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Uint16Int32) {
  ...
  vector<int32_t> dim_value_vec = {-1};
  vector<int64_t> result = {3, 1};
  EXPECT_TestExpandDims<uint16_t, DT_UINT16, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Uint32Int32) {
  ...
  vector<int32_t> dim_value_vec = {3};
  vector<int64_t> result = {3, 3, 3, 1, 5, 6};
  EXPECT_TestExpandDims<uint32_t, DT_UINT32, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Uint64Int32) {
  ...
  vector<int32_t> dim_value_vec = {7};
  vector<int64_t> result = {6, 1, 12, 3, 4, 56, 7, 1};
  EXPECT_TestExpandDims<uint64_t, DT_UINT64, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, Fp16Int32) {
  ...
  vector<int32_t> dim_value_vec = {7};
  vector<int64_t> result = {6, 1, 12, 3, 4, 56, 7, 1};
  EXPECT_TestExpandDims<fp16_t, DT_FLOAT16, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, FloatInt32) {
  ...
  EXPECT_TestExpandDims<float, DT_FLOAT, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, DoubleInt32) {
  ...
  vector<int32_t> dim_value_vec = {7};
  vector<int64_t> result = {1, 1, 1, 11, 1, 1, 1, 1};
  EXPECT_TestExpandDims<double, DT_DOUBLE, int32_t, DT_INT32>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, DoubleInt64) {
  ...
  vector<int64_t> result = {1, 1, 1, 11, 1, 1, 1, 1};
  EXPECT_TestExpandDims<double, DT_DOUBLE, int64_t, DT_INT64>(data_vec, dim_value_vec, result);
}
...
TEST_F(UtestGraphPassesFoldingKernelExpandDimsKernel, InvalidFormat) {
  ...
  EXPECT_TestInvalidExpandDims<int32_t, DT_INT32, int32_t, DT_INT32, FORMAT_FRACTAL_Z>(data_vec, dim_value_vec, result);
}
