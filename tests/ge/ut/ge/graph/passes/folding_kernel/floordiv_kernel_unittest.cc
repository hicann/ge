...
TEST_F(UtestGraphPassedFoldingKernelFloorDivKernel, InvalidParam1) {
  vector<int64_t> dims_vec_0 = {2};
  vector<double> data_vec_0 = {3, 36};
  GeTensorDesc tensor_desc_0(GeShape(dims_vec_0), FORMAT_NCHW, DT_DOUBLE);
  ConstGeTensorPtr tensor_0 =
...
TEST_F(UtestGraphPassedFoldingKernelFloorDivKernel, Int64Success) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("floor_div", FLOORDIV);

  vector<int64_t> dims_vec_0 = {2, 3};
  vector<int64_t> data_vec_0 = {1, 6, 32, 9, -10, -7};
  ...
  vector<int64_t> dims_vec_1 = {2, 3};
  vector<int64_t> data_vec_1 = {2, -9, -9, -9, -9, -9};
...
TEST_F(UtestGraphPassedFoldingKernelFloorDivKernel, DoubleSuccess) {
  OpDescPtr op_desc_ptr = std::make_shared<OpDesc>("floor_div", FLOORDIV);
  ...
  vector<int64_t> dims_vec_1 = {2, 3};
  vector<double> data_vec_1 = {2, -9, -9, -9, -9, -9};
