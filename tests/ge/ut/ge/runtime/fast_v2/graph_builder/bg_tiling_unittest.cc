...
TEST_F(BgTilingUT, BgTiling_TopoCorrect) {
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_KnownWorkspace) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_FallibleTiling_MemCheck) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_FallibleTiling_MemCheck2) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_FallibleTiling_MemCheck3) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_MemCheck) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_MemCheck2) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_MemCheck3) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_MemCheck4) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_MemCheck5) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_JsonConstCorrect) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_Failed_NoCompileJson) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTiling_Failed_NodeIsNullptr) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgAtomicTiling_TopoCorrect) {
  ...
  ASSERT_EQ(FastNodeTopoChecker(tiling_node)
                .StrictConnectFrom({ws_size, output_0_size, output_1_size, {"TilingParse"}, {"PrepareTilingFwkData"}, {"InnerData"}, {"InnerData"}}),
            "success");
  auto tiling_parse_node = ge::ExecuteGraphUtils::FindFirstNodeMatchType(exe_graph, "TilingParse");
  ASSERT_NE(tiling_parse_node, nullptr);
...
TEST_F(BgTilingUT, BgAtomicTiling_JsonConstCorrect) {
  ge::ComputeGraphPtr graph;
  auto aac_node = BuildAtomicNode(graph);
  ASSERT_NE(aac_node, nullptr);
...
TEST_F(BgTilingUT, BgAtomicTiling_Failed_NoCompileJson) {
  ge::ComputeGraphPtr graph;
...
TEST_F(BgTilingUT, BgAtomicTiling_Failed_InvalidJonsFormat) {
  ge::ComputeGraphPtr graph;
...
TEST_F(BgTilingUT, BgTiling_TopoCorrect_CompatibleTilingV4) {
...
TEST_F(BgTilingUT, ConstructAutoTilingOk) {
  ...
  auto tiling_ret = Tiling(test_node, {data1_ret.out_shapes[0], data2_ret.out_shapes[0]}, {data2_ret.out_shapes[0]},
                           {platform, global_data, fake_launch_arg_});
  ASSERT_EQ(tiling_ret.size(), static_cast<size_t>(kernel::TilingExOutputIndex::kNum));
  EXPECT_EQ(tiling_ret[0]->GetFastNode()->GetType(), "Tiling");
}

TEST_F(BgTilingUT, GetCoreTypeMix) {
  std::string node_type = "bg_node_with_auto_tiling";
  auto graph = BuildTwoInputsGraph(node_type);
  auto test_node = graph->FindNode(node_type);
  AttrUtils::SetStr(test_node->GetOpDesc(), optiling::COMPILE_INFO_JSON, "{ key : value}");
...
TEST_F(BgTilingUT, GetFrameworkOpTypeUsingAutoTilingOk) {
...
TEST_F(BgTilingUT, GetInputNumUsingAllocRtArgOk) {
  ...
  auto launch_arg = bg::AllocRtArg(graph->FindNode("add1"), task_def.kernel_with_handle(), kMaxTilingSize);
...
TEST_F(BgTilingUT, AllocRtArgWithArgsInfo1_SUCCESS) {
  ...
  auto &task_def = compile_result->task_defs.back();
  constexpr char const *kMaxTilingSize = "op_para_size";
  auto launch_arg = bg::AllocRtArg(add_node, task_def.kernel(), kMaxTilingSize);
...
TEST_F(BgTilingUT, AllocRtArgWithArgsInfo2_SUCCESS) {
  auto graph = ShareGraph::AddWith4InputsAicoreGraph();
  auto root_model = GeModelBuilder(graph).BuildGeRootModel();
  auto ori_global_data = GlobalDataFaker(root_model).FakeWithoutHandleAiCore("Add", false).Build();
  auto add_node = graph->FindNode("add1");
...
TEST_F(BgTilingUT, AllocRtArg_ArgsInfoNumNotMatchNodeIoNum_SUCCESS) {
  auto graph = ShareGraph::AddWith4InputsAicoreGraph();
  auto root_model = GeModelBuilder(graph).BuildGeRootModel();
  auto ori_global_data = GlobalDataFaker(root_model).FakeWithoutHandleAiCore("Add", false).Build();
  auto add_node = graph->FindNode("add1");
...
TEST_F(BgTilingUT, AllocRtArg_CheckArgsInfo_Failed1) {
  auto graph = ShareGraph::AddWith4InputsAicoreGraph();
  auto root_model = GeModelBuilder(graph).BuildGeRootModel();
  auto ori_global_data = GlobalDataFaker(root_model).FakeWithoutHandleAiCore("Add", false).Build();
  auto add_node = graph->FindNode("add1");
...
TEST_F(BgTilingUT, AllocRtArg_CheckArgsInfo_Failed2) {
  auto graph = ShareGraph::AddWith4InputsAicoreGraph();
  auto root_model = GeModelBuilder(graph).BuildGeRootModel();
  auto ori_global_data = GlobalDataFaker(root_model).FakeWithoutHandleAiCore("Add", false).Build();
  auto add_node = graph->FindNode("add1");
...
TEST_F(BgTilingUT, AllocRtArg_CheckArgsInfo_Failed3) {
  auto graph = ShareGraph::AddWith4InputsAicoreGraph();
  auto root_model = GeModelBuilder(graph).BuildGeRootModel();
  auto ori_global_data = GlobalDataFaker(root_model).FakeWithoutHandleAiCore("Add", false).Build();
  auto add_node = graph->FindNode("add1");
...
TEST_F(BgTilingUT, AllocRtArg_CheckArgsInfo_Failed4) {
  auto graph = ShareGraph::AddWith4InputsAicoreGraph();
  auto root_model = GeModelBuilder(graph).BuildGeRootModel();
  auto ori_global_data = GlobalDataFaker(root_model).FakeWithoutHandleAiCore("Add", false).Build();
  auto add_node = graph->FindNode("add1");
...
TEST_F(BgTilingUT, AllocRtArg_CheckArgsInfo_Failed_Mix) {
  auto graph = ShareGraph::AddWith4InputsAicoreGraph();
  auto root_model = GeModelBuilder(graph).BuildGeRootModel();
  auto ori_global_data = GlobalDataFaker(root_model).FakeWithoutHandleAiCore("Add", false).Build();
  auto add_node = graph->FindNode("add1");
...
TEST_F(BgTilingUT, BgFallibleTiling_OutputsCountCorrect) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgFallibleTiling_OutputsCountCorrect_CompatibleV4) {
  std::string node_type = "bg_node_with_tiling_v4";
  auto graph = BuildTwoInputsGraph(node_type);
  auto test_node = graph->FindNode(node_type);
  AttrUtils::SetStr(test_node->GetOpDesc(), optiling::COMPILE_INFO_JSON, "{ key : value}");
  ...
  auto platform = AppendCoreTypeToPlatform(test_node, data_input.global_data);
  // use data2_out_shape as output_shapes of add_node
  auto tiling_ret = FallibleTiling(test_node, {data1_ret.out_shapes[0], data2_ret.out_shapes[0]},
                                   {data2_ret.out_shapes[0]}, {platform, *(data_input.global_data), fake_launch_arg_});
  auto frame = ValueHolder::PopGraphFrame();
  ASSERT_NE(frame, nullptr);
  auto exe_graph = frame->GetExecuteGraph().get();
  ASSERT_NE(exe_graph, nullptr);
...
TEST_F(BgTilingUT, BgFallibleTiling_Failed_WhenInputsIsNullptr) {
  auto in_shape0 = ValueHolder::CreateFeed(0);
  auto in_shape1 = ValueHolder::CreateFeed(1);
  auto out_shape = ValueHolder::CreateFeed(2);
  auto platform = ValueHolder::CreateFeed(3);
...
TEST_F(BgTilingUT, BgTilingLegacy_Ok_CompatibleTilingV4) {
    std::string node_type = "bg_node_with_tiling_v4";
  auto graph = BuildTwoInputsGraph(node_type);
  auto test_node = graph->FindNode(node_type);
  AttrUtils::SetStr(test_node->GetOpDesc(), optiling::COMPILE_INFO_JSON, "{ key : value}");
  ...
  auto tiling_ret = TilingLegacy(nullptr, {data1_ret.out_shapes[0], data2_ret.out_shapes[0]}, {data2_ret.out_shapes[0]},
                                 platform, global_data);
  ASSERT_EQ(tiling_ret.size(), TilingContext::kOutputNum);
  EXPECT_EQ(tiling_ret[0], nullptr);
  // 2. build tiling successfully
  tiling_ret = TilingLegacy(test_node, {data1_ret.out_shapes[0], data2_ret.out_shapes[0]},
                                 {data2_ret.out_shapes[0]}, platform, global_data);
  auto frame = ValueHolder::PopGraphFrame();
  ASSERT_NE(frame, nullptr);
  auto exe_graph = frame->GetExecuteGraph().get();
  ASSERT_NE(exe_graph, nullptr);
...
TEST_F(BgTilingUT, BgTilingLegacy_Ok_CoreNum) {
  std::string node_type = "bg_node_with_tiling_v4";
  auto graph = BuildTwoInputsGraph(node_type);
  auto test_node = graph->FindNode(node_type);
  AttrUtils::SetStr(test_node->GetOpDesc(), optiling::COMPILE_INFO_JSON, "{ key : value}");
...
TEST_F(BgTilingUT, BgTilingLegacy_Ok_CoreNumInvalid) {
  std::string node_type = "bg_node_with_tiling_v4";
  auto graph = BuildTwoInputsGraph(node_type);
  auto test_node = graph->FindNode(node_type);
  AttrUtils::SetStr(test_node->GetOpDesc(), optiling::COMPILE_INFO_JSON, "{ key : value}");
