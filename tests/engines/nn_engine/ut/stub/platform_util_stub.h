...
#ifndef LLT_FUSION_ENGINE_UT_STUB_PLATFORM_UTIL_STUB_H_
#define LLT_FUSION_ENGINE_UT_STUB_PLATFORM_UTIL_STUB_H_
...
#endif  // LLT_FUSION_ENGINE_UT_STUB_PLATFORM_UTIL_STUB_H_
