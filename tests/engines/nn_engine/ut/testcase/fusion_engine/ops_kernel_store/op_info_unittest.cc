 ...
 protected:
  ...
  virtual void SetUp() {
    ...
    FEOpsStoreInfo tbe_custom{
        2, "tbe_custom_opinfo", EN_IMPL_CUSTOM_TBE,
        GetCodeDir() +
...
TEST_F(OpKernelInfoTest, test_dtype_format_special) {
  ...
  FEOpsStoreInfo utest_opinfo{
      2, "utest_opinfo", EN_IMPL_CUSTOM_TBE,
...
TEST_F(OpKernelInfoTest, convert_list_list_attr_value_default_value_not_found) {
  OpContent op_content;
  op_content.op_type_ = "TestOp";
...
TEST_F(OpKernelInfoTest, init_attr_value_attr_list_not_found) {
  OpContent op_content;
  op_content.op_type_ = "TestOp";
  std::map<std::string, std::string> attr_map;
  attr_map["type"] = "int";
