...
class GRAPH_FUSION_UT : public testing::Test {
 protected:
  void SetUp() {
  ...
  FusionPassManagerPtr fusion_pass_mgr_;
...
std::vector<FusionPassOrRule> SortGraphFusionFun() {
  std::vector<FusionPassOrRule> sorted_quant_pass_vec;
...
TEST_F(GRAPH_FUSION_UT, converage_03) {
  int32_t priority = CUSTOM_CFG_DOWN_PRIORITY_MIN;
  EXPECT_EQ(fusion_priority_mgr_->AdjustDownStagePriority(priority), 12000);
...
TEST_F(GRAPH_FUSION_UT, converage_04) {
  ...
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortGraphFusion());
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortBufferFusion());
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortBufferFusion());
...
TEST_F(GRAPH_FUSION_UT, converage_compile_level) {
  std::vector<FusionPassOrRule> custom_pass_or_rule_vec;
  std::vector<FusionPassOrRule> built_in_pass_or_rule_vec;
  std::vector<FusionPassOrRule> sorted_graph_fusion_vec;
  fusion_priority_mgr_->SortFusionPassOrRule(true, custom_pass_or_rule_vec, built_in_pass_or_rule_vec,
...
TEST_F(GRAPH_FUSION_UT, PruningPassSuccess) {
...
TEST_F(GRAPH_FUSION_UT, PruningPassFailed) {
...
TEST_F(GRAPH_FUSION_UT, converage_05) {
...
TEST_F(GRAPH_FUSION_UT, converage_06) {
  std::vector<FusionPassOrRule> sorted_quant_pass_vec;
  sorted_quant_pass_vec = SortGraphFusionFun();
...
TEST_F(GRAPH_FUSION_UT, converage_07) {
  RegisterPassFunc(CreateFunc);
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortGraphFusion());
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  ge::GeTensorDesc tensor_desc(ge::GeShape({10}), ge::FORMAT_NCHW, ge::DT_FLOAT);
...
TEST_F(GRAPH_FUSION_UT, converage_08) {
  RegisterPassFunc(CreateFunc);
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortGraphFusion());
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(GRAPH_FUSION_UT, converage_09) {
...
TEST_F(GRAPH_FUSION_UT, converage_10) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(GRAPH_FUSION_UT, converage_11) {
  RegisterPassFunc(CreateFunc);
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortGraphFusion());
...
TEST_F(GRAPH_FUSION_UT, converage_12) {
...
TEST_F(GRAPH_FUSION_UT, converage_13) {
...
TEST_F(GRAPH_FUSION_UT, converage_16) {
  std::unordered_set<string> types = {CONSTANT};
  bool matched = false;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(GRAPH_FUSION_UT, converage_14) {
...
TEST_F(GRAPH_FUSION_UT, converage_17) {
  RegisterPassFunc(CreateFunc);
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortGraphFusion());
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  ge::GeTensorDesc tensor_desc(ge::GeShape({10}), ge::FORMAT_NCHW, ge::DT_FLOAT);
...
TEST_F(GRAPH_FUSION_UT, converage_18) {
  RegisterPassFunc(CreateFunc);
  EXPECT_EQ(SUCCESS, fusion_priority_mgr_->SortGraphFusion());
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  ge::GeTensorDesc tensor_desc(ge::GeShape({10}), ge::FORMAT_NCHW, ge::DT_FLOAT);
...
TEST_F(GRAPH_FUSION_UT, converage_19) {
...
TEST_F(GRAPH_FUSION_UT, converage_20) {
  ...
  string soc_version = "Ascend910B2";
...
TEST_F(GRAPH_FUSION_UT, GetNextInAnchorsOfSubNetOutput_NoParentNodeIndex) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
