...
class UTEST_split_c_to_n_optimize : public testing::Test {
 public:
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_suc_002) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph2(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_suc_003) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph4(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_suc_004) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph12(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_001) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph3(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_002) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph5(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_003) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph6(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_004) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph7(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_005) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph8(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_006) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph9(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_007) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph10(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(UTEST_split_c_to_n_optimize, split_c_to_n_no_task_fail_008) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph13(graph);
  SplitCToNOptimizer split_c_to_optimize;
  split_c_to_optimize.SetFusionVirtualOp(*graph);
