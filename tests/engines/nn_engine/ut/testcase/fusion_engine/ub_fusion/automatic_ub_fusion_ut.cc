...
TEST_F(UB_FUSION_UT_AUTO_FUSION, fuse_two_nodes_change_scope_id_failed) {
  ...
  // With 15+13=28 nodes (not > 28), ChangeScopeId succeeds without overflow.
  // The test exercises the FuseTwoNodes -> ChangeScopeId code path.
