...
FusionRuleAnchorPtr CreateAnchor(int anchor_idx, const string &anchor_name, FusionRuleNodePtr owner_node,
...
FusionRuleNodePtr CreateFusionRuleNode(const string &node_name, const vector<string> &node_types,
...
TEST_F(fusion_rule_manager_uttest, convert_to_attr_value_success) {
  ...
  Status ret =
      test_object.ConvertToAttrValue(test_object.tmp_value_, ge::GeAttrValue::VT_LIST_FLOAT, test_object.value_);
