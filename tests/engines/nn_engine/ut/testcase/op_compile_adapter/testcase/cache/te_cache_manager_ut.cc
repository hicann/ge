...
namespace te {
namespace fusion {
class TeCacheManagerUTest : public testing::Test
{
protected:
    ...
    static void TearDownTestSuite() {
        std::cout << "TeCacheManagerUTest TearDownTestSuite" << std::endl;
        GlobalMockObject::verify();
        GlobalMockObject::reset();
    }
};

TEST(TeCacheManagerUTest, init_cache_mode_and_dir_01)
{
...
TEST(TeCacheManagerUTest, init_cache_mode_and_dir_02)
{
    std::map<std::string, std::string> options;
    options.emplace(ge::SOC_VERSION, "Ascend910B1");
    options.emplace(ge::OP_COMPILER_CACHE_MODE, "enable");
...
TEST(TeCacheManagerUTest, init_cache_mode_and_dir_03)
{
    std::map<std::string, std::string> options;
    options.emplace(ge::SOC_VERSION, "Ascend910B1");
    options.emplace(ge::OP_COMPILER_CACHE_MODE, "enable");
...
TEST(TeCacheManagerUTest, init_cache_mode_and_dir_04)
{
...
TEST(TeCacheManagerUTest, init_cache_mode_and_dir_05)
{
    std::map<std::string, std::string> options;
    options.emplace(ge::SOC_VERSION, "Ascend910B1");
    options.emplace(ge::OP_COMPILER_CACHE_MODE, "enable");
...
TEST(TeCacheManagerUTest, init_cache_mode_and_dir_06)
{
    std::map<std::string, std::string> options;
    options.emplace(ge::SOC_VERSION, "Ascend910B1");
    options.emplace(ge::OP_COMPILER_CACHE_MODE, "enable");
...
TEST(TeCacheManagerUTest, init_cache_mode_and_dir_07)
{
    std::map<std::string, std::string> options;
    options.emplace(ge::SOC_VERSION, "Ascend910B1");
...
TEST(TeCacheManagerUTest, pre_compile_cache_01)
{
    TeCacheManager::Instance().cache_mode_ = CompileCacheMode::Enable;
...
TEST(TeCacheManagerUTest, compile_cache_01)
{
...
TEST(TeCacheManagerUTest, compile_cache_02)
{
    MOCKER_CPP(&te::fusion::PythonApiCall::GetBinFileSha256Value,
               bool(te::fusion::PythonApiCall::*)(const char *binData, const size_t, std::string &res) const)
        .stubs()
...
TEST(TeCacheManagerUTest, compile_cache_autofuse_02)
{
    system("g++ -fPIC -DENABLE_T -shared -o llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.so "
           "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/example.cc");
    CompileResultPtr com_ret4 = CompileResultUtils::ParseCompileResult("./llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/te_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.json");
    system("rm llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.so");
    EXPECT_EQ(TeCacheManager::Instance().SetCompileResult(com_ret4), false);
}

TEST(TeCacheManagerUTest, compile_cache_autofuse_faile_02)
{
    system("g++ -fPIC -shared -o llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.so "
            "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/example.cc");
    CompileResultPtr com_ret4 = CompileResultUtils::ParseCompileResult("./llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/te_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.json");
    system("rm llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abe.so");
    EXPECT_EQ(TeCacheManager::Instance().SetCompileResult(com_ret4), false);
...
TEST(TeCacheManagerUTest, compile_cache_autofuse_static_02)
{
    system("g++ -fPIC -DENABLE_T -shared -o llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abc.so "
        "llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/example.cc");
    CompileResultPtr com_ret4 = CompileResultUtils::ParseCompileResult("./llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/te_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abc.json");
    system("rm llt/atc/opcompiler/te_fusion/st/disk_cache/kernel_meta/libte_ascbackend_9865e0fbe56139e85cc42efcf59ac9ab77ee34c3f14e3272f0ea1e2bbedf8abc.so");
    EXPECT_EQ(TeCacheManager::Instance().SetCompileResult(com_ret4), false);
}
...
TEST(TeCacheManagerUTest, compile_cache_03)
{
    MOCKER_CPP(&te::fusion::PythonApiCall::GetBinFileSha256Value,
               bool(te::fusion::PythonApiCall::*)(const char *binData, const size_t, std::string &res) const)
        .stubs()
