...
class TeFusionPyObjUTest : public testing::Test {
 public:
  TeFusionPyObjUTest() {}
...
TEST(TeFusionPyObjUTest, GetPyConstValue) {
...
TEST(TeFusionPyObjUTest, AddDynTensorArgs) {
  std::vector<int64_t> shape;
  shape.push_back(4);
  shape.push_back(4);
  shape.push_back(4);
...
TEST(TeFusionPyObjUTest, AddAtomicAtrr) {
  std::vector<int64_t> shape;
  shape.push_back(4);
  shape.push_back(4);
  shape.push_back(4);
...
TEST(TeFusionPyObjUTest, GetPyAttr) {
