...
TEST_F(STestFusionConfigParser, fusion_switch_case) {
  ...
  vector<string> expect_graph_fusion_vec = {"BatchMultiClassNonMaxSuppressionEnableSubgraphFusionPass", "BatchMultiClassNonMaxSuppressionInsertNMSBucketizeFusionPass", "BatchMultiClassNonMaxSuppressionRefreshSubgraphConstNodeFusionPass", "BatchNormBnInferOnlyFusionPass", "CUSTOM_PASS1", "ConcatCOptimize", "Conv2DBackpropInputTransdataToFixpipeFusionPass", "Conv2DbpFilterMulFusionPass", "ConvToSplitConvDequantConcatFusionPass", "GatherV2ConcatV2FusionPass", "GridSampler2DFusionPass", "MatmulAllReduceAddRmsNormFusionPass", "MatmulNzInNdOutTransdataFusionPass", "MatmulReshapeFusionPass", "MatmulWeightPrefetchFusionPass", "MoeDistributeCombineAddRmsNormFusionPass", "MoeDistributeCombineV2FusionPass", "MoeDistributeDispatchV2FusionPass", "MulFusionOptimizeFusionPass", "ReduceMeanDTransnodeFusionPass", "SoftmaxSmallOpFusionPass", "SplitConvFusionPass", "StridedSliceConcatFusionPass", "StridedSliceDToSplitFusionPass", "SubMulConcatFusionPass", "WeightQuantBmmV2WeightPrefetchFusionPass", "ZConcatExt3FusionPass"};
  ...
  vector<string> expect_ub_fusion_vec = {"AutoSingleNormFusionPass", "AutoSingleReduceFusionPass", "MatmulToMatMulV3UBFusionPass", "TbeConvDequantSigmoidMulAddFusionPass", "UB_FUSION_PASS1"};
...
TEST_F(STestFusionConfigParser, fusion_switch_06) {
  ...
  vector<string> close_graph_fusion_vec;
  fusionConfigParserPtr->GetFusionPassNameBySwitch("GraphFusion", false, close_graph_fusion_vec);
  vector<string> expect_graph_fusion_vec = {"BatchMultiClassNonMaxSuppressionEnableSubgraphFusionPass", "BatchMultiClassNonMaxSuppressionInsertNMSBucketizeFusionPass", "BatchMultiClassNonMaxSuppressionRefreshSubgraphConstNodeFusionPass", "BatchNormBnInferOnlyFusionPass", "ConcatCOptimize", "Conv2DBackpropInputTransdataToFixpipeFusionPass", "Conv2DbpFilterMulFusionPass", "ConvToSplitConvDequantConcatFusionPass", "GatherV2ConcatV2FusionPass", "GridSampler2DFusionPass", "MatmulAllReduceAddRmsNormFusionPass", "MatmulNzInNdOutTransdataFusionPass", "MatmulReshapeFusionPass", "MatmulWeightPrefetchFusionPass", "MoeDistributeCombineAddRmsNormFusionPass", "MoeDistributeCombineV2FusionPass", "MoeDistributeDispatchV2FusionPass", "ReduceMeanDTransnodeFusionPass", "SoftmaxSmallOpFusionPass", "SplitConvFusionPass", "StridedSliceConcatFusionPass", "StridedSliceDToSplitFusionPass", "SubMulConcatFusionPass", "TbeMatmulFixPipeFusionPass", "WeightQuantBmmV2WeightPrefetchFusionPass", "ZConcatExt3FusionPass"};
  EXPECT_EQ(close_graph_fusion_vec, expect_graph_fusion_vec);
  vector<string> close_ub_fusion_vec;
  fusionConfigParserPtr->GetFusionPassNameBySwitch("UBFusion", false, close_ub_fusion_vec);
  vector<string> expect_ub_fusion_vec = {"AutoSingleNormFusionPass", "AutoSingleReduceFusionPass", "MatmulToMatMulV3UBFusionPass", "SplitConvFusionPass", "TbeConvDequantSigmoidMulAddFusionPass", "TbeMatmulFixPipeFusionPass"};
  EXPECT_EQ(close_ub_fusion_vec, expect_ub_fusion_vec);
}
...
TEST_F(STestFusionConfigParser, fusion_switch_07) {
  ...
  vector<string> close_graph_fusion_vec;
  fusionConfigParserPtr->GetFusionPassNameBySwitch("GraphFusion", false, close_graph_fusion_vec);
  vector<string> expect_graph_fusion_vec = { "BatchMultiClassNonMaxSuppressionEnableSubgraphFusionPass", "BatchMultiClassNonMaxSuppressionInsertNMSBucketizeFusionPass", "BatchMultiClassNonMaxSuppressionRefreshSubgraphConstNodeFusionPass", "BatchNormBnInferOnlyFusionPass", "ConcatCOptimize", "Conv2DBackpropInputTransdataToFixpipeFusionPass", "Conv2DbpFilterMulFusionPass", "ConvToSplitConvDequantConcatFusionPass", "GatherV2ConcatV2FusionPass", "GridSampler2DFusionPass", "MatmulAllReduceAddRmsNormFusionPass", "MatmulNzInNdOutTransdataFusionPass", "MatmulReshapeFusionPass", "MatmulWeightPrefetchFusionPass", "MoeDistributeCombineAddRmsNormFusionPass", "MoeDistributeCombineV2FusionPass", "MoeDistributeDispatchV2FusionPass", "ReduceMeanDTransnodeFusionPass", "SoftmaxSmallOpFusionPass", "SplitConvFusionPass", "StridedSliceConcatFusionPass", "StridedSliceDToSplitFusionPass", "SubMulConcatFusionPass", "WeightQuantBmmV2WeightPrefetchFusionPass", "ZConcatExt3FusionPass" };
  EXPECT_EQ(close_graph_fusion_vec, expect_graph_fusion_vec);
  vector<string> close_ub_fusion_vec;
  fusionConfigParserPtr->GetFusionPassNameBySwitch("UBFusion", false, close_ub_fusion_vec);
  vector<string> expect_ub_fusion_vec = { "AutoSingleNormFusionPass", "AutoSingleReduceFusionPass", "MatmulToMatMulV3UBFusionPass", "TbeConvDequantSigmoidMulAddFusionPass", "TbeMatmulFixPipeFusionPass" };
  EXPECT_EQ(close_ub_fusion_vec, expect_ub_fusion_vec);
}
