...
TEST_F(STEST_FE_TRANSOP_INSERT_COMPLEX_2, SwitchCastAndTransdata_C08InFront) {
...
TEST_F(STEST_FE_TRANSOP_INSERT_COMPLEX_2, SwitchCastAndTransdata_VerifyC0Fail) {
...
TEST_F(STEST_FE_TRANSOP_INSERT_COMPLEX_2, SwitchCastAndTransdata_C08AtTail) {
...
TEST_F(STEST_FE_TRANSOP_INSERT_COMPLEX_2, SwitchCastAndTransdata_AtTailUnsuccessful) {
