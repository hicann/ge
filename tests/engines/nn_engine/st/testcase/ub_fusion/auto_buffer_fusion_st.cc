...
class UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER : public testing::Test {
 public:
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, singel_reduce_fusion_01) {
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, singel_norm_fusion_01) {
  tbe_adapter_ptr_->TeFusion = TeFusionFusionCheckStub1;
  tbe_adapter_ptr_->WaitAllFinished = WaitAllFinishedFusionCheckdStub1;
  tbe_adapter_ptr_->GetOpInfo = get_tbe_opinfo_fusion_check_stub_succ;
  fusion_nodes_num = 0;
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, multiple_reduce_fusion_01) {
  tbe_adapter_ptr_->TeFusion = TeFusionFusionCheckStub1;
  tbe_adapter_ptr_->WaitAllFinished = WaitAllFinishedFusionCheckdStub1;
  tbe_adapter_ptr_->GetOpInfo = get_tbe_opinfo_fusion_check_stub_succ;
  fusion_nodes_num = 0;
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, multiple_reduce_fusion_03) {
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, multiple_reduce_and_dataaccess_fusion_01) {
  tbe_adapter_ptr_->TeFusion = TeFusionFusionCheckStub1;
  tbe_adapter_ptr_->WaitAllFinished = WaitAllFinishedFusionCheckdStub1;
  tbe_adapter_ptr_->GetOpInfo = get_tbe_opinfo_fusion_check_stub_succ;
  fusion_nodes_num = 0;
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, multiple_reduce_and_dataaccess_fusion_02) {
  tbe_adapter_ptr_->TeFusion = TeFusionFusionCheckStub1;
  tbe_adapter_ptr_->WaitAllFinished = WaitAllFinishedFusionCheckdStub1;
  tbe_adapter_ptr_->GetOpInfo = get_tbe_opinfo_fusion_check_stub_succ;
  fusion_nodes_num = 0;
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, multiple_reduce_and_dataaccess_fusion_03) {
  tbe_adapter_ptr_->TeFusion = TeFusionFusionCheckStub1;
  tbe_adapter_ptr_->WaitAllFinished = WaitAllFinishedFusionCheckdStub1;
  tbe_adapter_ptr_->GetOpInfo = get_tbe_opinfo_fusion_check_stub_succ;
  fusion_nodes_num = 0;
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, get_fusion_nodes_map) {
  ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  BuildGraph_07(graph);
...
TEST_F(UB_FUSION_ST_AUTO_FUSION_PASS_RUNNER, multiple_reduce_and_dataaccess_fusion_04) {
  ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  BuildGraph_05(graph);
