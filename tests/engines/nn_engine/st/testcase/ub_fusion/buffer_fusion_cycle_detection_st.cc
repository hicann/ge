...
TEST_F(BufferFusionCycleDetectionSt, testcase_02) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_02_1) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
/* Contains control cycle */
TEST_F(BufferFusionCycleDetectionSt, testcase_02_2) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_03) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_03_3) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  cycle_detection::BuildGraph03_1(graph);
  for (auto &node : graph->GetDirectNode()) {
 ...
 * */
TEST_F(BufferFusionCycleDetectionSt, testcase_04) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
 ...
 * */
TEST_F(BufferFusionCycleDetectionSt, testcase_05) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_05_1) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_05_2) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_05_3) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_05_4) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_06) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  cycle_detection::BuildGraph05_4(graph);
...
TEST_F(BufferFusionCycleDetectionSt, testcase_07) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
  cycle_detection::BuildGraph05_4(graph);
...
TEST_F(BufferFusionCycleDetectionSt, testcase_08) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_08_1) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_08_2) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, testcase_08_4) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
...
TEST_F(BufferFusionCycleDetectionSt, coverage_01) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test");
