...
TEST_F(FFTSPlusOpsKernelBuilderSTest, Case_Gen_Atomic_Context_Id)
{
  std::vector<ge::NodePtr> sub_graph_nodes;
  uint32_t thread_mode = 1;
  uint32_t window_size = 4;
...
TEST_F(FFTSPlusOpsKernelBuilderSTest, Case_Gen_AtStart_Atomic_Context_Id)
{
  std::vector<ge::NodePtr> sub_graph_nodes;
  uint32_t thread_mode = 1;
  uint32_t window_size = 4;
...
TEST_F(FFTSPlusOpsKernelBuilderSTest, AutoFillSerialDependency_SUCCESS)
{
...
TEST_F(FFTSPlusOpsKernelBuilderSTest, Case_Gen_Sub_Graph_Task_WithMemSet)
{
  std::vector<ge::NodePtr> sub_graph_nodes;
...
TEST_F(FFTSPlusOpsKernelBuilderSTest, Dynamic_Mode_SUCCESS)
{
  auto builder = ut::ComputeGraphBuilder("test");
...
TEST_F(FFTSPlusOpsKernelBuilderSTest, WITHOUT_SUB_STREAM_ID_SUCCESS)
{
  std::vector<ge::NodePtr> sub_graph_nodes;
  uint32_t thread_mode = 0;
  uint32_t window_size = 4;
...
TEST_F(FFTSPlusOpsKernelBuilderSTest, SAME_SUB_STREAM_ID_SUCCESS)
{
  std::vector<ge::NodePtr> sub_graph_nodes;
  uint32_t thread_mode = 0;
  uint32_t window_size = 4;
...
TEST_F(FFTSPlusOpsKernelBuilderSTest, SAME_SUB_STREAM_ID_GEN_TASK_SUCCESS)
{
  std::vector<ge::NodePtr> sub_graph_nodes;
  uint32_t thread_mode = 0;
  uint32_t window_size = 4;
