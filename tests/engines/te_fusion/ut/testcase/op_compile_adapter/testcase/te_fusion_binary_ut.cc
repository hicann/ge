...
void CreateOfile(std::string &fileName) {
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub";
...
bool GetOptionInfo_stub(te::fusion::TeFusionManager *This, bool isThreadLocal, const std::string &key,
                        std::string &value) {
...
TEST(TeFusionBinaryUTest, fuzzycompile_binary_path_version) {
  ...
  te::fusion::BinaryManager::Instance().GetBinaryVersionInfo(kernelPath1, binAdkVersion1, binOppVersion1);
}
...
bool GeneralizeOps_stub(const OpBuildTaskPtr &opTask, GeneralizedResult &generalizedResult) {
  ...
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/fill_opParams.json";
...
bool GeneralizeFusionOps_stub(const OpBuildTaskPtr &opTask, GeneralizedResult &generalizedResult) {
  ...
  std::string currentFilePath =
      GetCodeDir() +
      "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/fill_fusionOpParams.json";
  std::string path = te::fusion::RealPath(currentFilePath);
  te::fusion::TeFileUtils::GetJsonValueFromJsonFile(path, generalizedResult.dynamicJson);
  return true;
}
...
void GetBinaryPath_stub(te::fusion::BinaryManager *This, const OpBuildTaskPtr &opTask, bool isOm, bool isKernel,
  ...
  binaryPath =
      te::fusion::RealPath(GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub") +
      "/";
  return;
}
...
TEST(TeFusionBinaryUTest, fuzzycompile_binary_fileinvalid_fail) {
  ...
  std::string currentFilePath1 =
      GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/fill.json";
...
TEST(TeFusionBinaryUTest, test_MatchStaticKeyWithOptionalInputNull) {
  ...
  std::string currentFilePath1 =
      GetCodeDir() +
      "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose_op.json";
  ...
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose.json";
  std::string path = te::fusion::RealPath(currentFilePath);
  ...
  std::string currentFilePath2 =
      GetCodeDir() +
      "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose_fail.json";
...
bool GetBinaryInfoConfigPath_Stub(te::fusion::BinaryInfoBase *This, const string &configPath,
                                  std::string &configRealPath, bool isSuperKernel, const string &path) {
  printf("GetBinaryInfoConfigPath_Stub \r\n");

  std::string currentFilePath = GetCodeDir() +
                                "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/ai_core/tbe/"
...
TEST(TeFusionBinaryUTest, test_ParseBinaryInfo) {
  MOCKER_CPP(&te::fusion::BinaryInfoBase::GetBinaryInfoConfigPath,
             bool (te::fusion::BinaryInfoBase::*)(const std::string &, std::string &, const bool &, const std::string &)
                 const)
      .stubs()
...
TEST(TeFusionBinaryUTest, test_MatchSimpleKey2) {
  ...
  auto opTask1 = std::make_shared<te::fusion::OpBuildTask>(te::fusion::OpBuildTask{
      graphId, taskId, sgtThreadIndex, teGraphNode, opDescPtr, te::fusion::OP_TASK_STATUS::OP_TASK_PENDING});
...
TEST(TeFusionBinaryUTest, test_generate_simple_key_list_001) {
  ...
  nlohmann::json binaryListJson;
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/binary_list.json";
...
TEST(TeFusionBinaryUTest, test_generate_simple_key_list_002) {
  ...
  nlohmann::json binaryListJson;
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/binary_list_no_key.json";
  std::string path = te::fusion::RealPath(currentFilePath);
  te::fusion::TeFileUtils::GetJsonValueFromJsonFile(path, binaryListJson);
  nlohmann::json binaryList = binaryListJson["binaryList"];
  std::unordered_map<std::string, std::string> simpleKeyInfoMap;
...
TEST(TeFusionBinaryUTest, test_generate_simple_key_list_004) {
  ...
  std::string currentFilePath =
      GetCodeDir() +
      "/tests/engines/nn_engine/ut/testcase/op_compile_adapter/stub/binary_stub/binary_list_path_null.json";
  std::string path = te::fusion::RealPath(currentFilePath);
  te::fusion::TeFileUtils::GetJsonValueFromJsonFile(path, binaryListJson);
  nlohmann::json binaryList = binaryListJson["binaryList"];
  std::unordered_map<std::string, std::string> simpleKeyInfoMap;
