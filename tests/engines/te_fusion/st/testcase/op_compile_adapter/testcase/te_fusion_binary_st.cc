...
class TeFusionBinarySTest : public testing::Test {
 public:
  TeFusionBinarySTest() {}
...
void CreateOfile(std::string &fileName) {
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub";
...
TEST(TeFusionBinarySTest, createOfile) {
  printf("createOfile. \r\n");
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_path_version) {
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub";
  ...
  TeConfigInfo::Instance().config_str_item_vec_[static_cast<size_t>(TeConfigInfo::ConfigStrItem::SocVersion)] =
      "ascend910";
  TeConfigInfo::Instance().config_str_item_vec_[static_cast<size_t>(TeConfigInfo::ConfigStrItem::ShortSocVersion)] =
      "ascend910";
  TeConfigInfo::Instance().config_str_item_vec_[static_cast<size_t>(TeConfigInfo::ConfigStrItem::CoreType)] =
      "ascend910";
  const std::map<std::string, std::string> options = {{"op.binary.builtin", "6|/op_impl/built-in/ai_core/tbe/kernel/"},
  ...
  // check soc path
  std::string oppPath =
      te::fusion::RealPath(currentFilePath) + "/op_impl/built-in/ai_core/tbe/kernel/config/ascend910/";
  ...
  te::fusion::BinaryManager::Instance().GetBinaryVersionInfo(kernelPath, binCustomAdkVersion, binCustomOppVersion);
  // check version
...
bool GeneralizeOps_stub(const OpBuildTaskPtr &opTask, GeneralizedResult &generalizedResult) {
  ...
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/fill_opParams.json";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/fill_opParams.json";
  }
...
bool GeneralizeFusionOps_stub(const OpBuildTaskPtr &opTask, GeneralizedResult &generalizedResult) {
  ...
  std::string currentFilePath =
      GetCodeDir() +
      "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/fill_fusionOpParams.json";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath =
        "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/fill_fusionOpParams.json";
  }
...
bool GetSimpleKeyMode_stub(te::fusion::BinaryInfoBase *This, const std::string &opType,
...
void GetBinaryPath_stub(te::fusion::BinaryManager *This, const OpBuildTaskPtr &opTask, bool isOm, bool isKernel,
  ...
  binaryPath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/";
  if (te::fusion::RealPath(binaryPath).empty()) {
    printf("GetBinaryPath_stub empty \r\n");
    binaryPath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/ut/stub/binary_stub/";
  }
  return;
}

TEST(TeFusionBinarySTest, fuzzycompile_binary_reuse_singleop_success) {
  bool res = false;
  ...
  auto task = std::make_shared<te::fusion::OpBuildTask>(te::fusion::OpBuildTask{
      graphId, taskId, sgtThreadIndex, teGraphNode, opDescPtr, te::fusion::OP_TASK_STATUS::OP_TASK_PENDING});
  ...
  TeConfigInfo::Instance().config_str_item_vec_[static_cast<size_t>(TeConfigInfo::ConfigStrItem::BufferOptimize)] =
      "l1_optimize";
  ...
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_stub));
  ...
  EXPECT_EQ(jsonPath, jsonFilePath);
  GlobalMockObject::verify();
}

TEST(TeFusionBinarySTest, fuzzycompile_binary_reuse_fusionop_success) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeFusionOps_stub));
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_condition_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  // socInfo_.isHighPerformace is not normal
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_check_file_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  std::string name = te::fusion::GetTaskNodeName(task);
  EXPECT_EQ(name, "");
}

TEST(TeFusionBinarySTest, fuzzycompile_binary_graph_pattern_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_statickey_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
bool GetOpImplModeByOpNode_stub(const ge::Node *opNode, std::string &implMode) {
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_genstatickey_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_opparams_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  // int64mode fail
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_Int64mode_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, true);
  GlobalMockObject::verify();

  // range fail
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_range_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();

  // oriformat��orishape��addr_type��addr_offset... fail
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_oriformat_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();

  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_orishape_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();

  // SPLIT_INDEX
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_splitindex_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();

  // L1_fusion_type
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_l1fusiontype_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();
}
...
class ReuseTask {
 public:
  ...
  ReuseTask() : owner_graph(std::make_shared<ComputeGraph>("te")) {
    uint64_t graphId = 100;
    uint64_t taskId = static_cast<uint64_t>(rand());
    uint64_t sgtThreadIndex = 300;
...
void DoTestDeterministicReuse(char *deterministicInBin, char *deterministicInOpParam, bool expectReuse) {
  ...
  std::string stubPath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/";
  if (te::fusion::RealPath(stubPath).empty()) {
    stubPath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/ut/stub/";
  }
...
TEST(TeFusionBinarySTest, deterministicReuse_WhenCacheTrue_OptionTrue_WillReuse) {
  DoTestDeterministicReuse("true", "true", true);
}

TEST(TeFusionBinarySTest, deterministicReuse_WhenCacheIgnore_OptionFalse_WillReuse) {
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_singleopattrs_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_attrsnum_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();

  // dtype fail
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_attrdtype_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();

  // uint8 value fail
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_uint8attrvalue_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, true);
  GlobalMockObject::verify();

  // float32 value fail
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_float32attrvalue_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();

  // double value fail
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_doubleattrvalue_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();
}
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_fusionopattrs_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  MOCKER_CPP(te::fusion::ShapeGeneralization::GeneralizeOps).stubs().will(invoke(GeneralizeOps_graphopparamsnums_stub));
  res = te::fusion::BinaryManager::Instance().CanReuseBinaryKernel(task);
  EXPECT_EQ(res, false);
  GlobalMockObject::verify();
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_succ) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  auto task = std::make_shared<te::fusion::OpBuildTask>(te::fusion::OpBuildTask{
      graphId, taskId, sgtThreadIndex, teGraphNode, opDescPtr, te::fusion::OP_TASK_STATUS::OP_TASK_PENDING});
  auto task1 = std::make_shared<te::fusion::OpBuildTask>(te::fusion::OpBuildTask{
      graphId, taskId, sgtThreadIndex, teGraphNode1, opDescPtr1, te::fusion::OP_TASK_STATUS::OP_TASK_PENDING});
  task->buildType = FUZZILY_BUILD;
  ...
  TeConfigInfo::Instance().adkVersion_ = "1.73.t1.0.b010";
  TeConfigInfo::Instance().oppVersion_ = "1.73.t1.0.b010";
  TbeOpInfo opInfo("fill", "", "Fill", "AIcoreEngine");
  std::vector<std::pair<int64_t, int64_t>> range = {{1, 10}, {1, 10}};
  BinaryAddOpParamToTbeOpInfo({1, 2}, "float16", opName, "input0", range, true, opInfo);
  BinaryAddOpParamToTbeOpInfo({1, 2}, "int64", opName, "output0", range, false, opInfo);
  BinaryAddAttrToTbeOpInfo(opInfo);
  ...
  TbeOpInfo opInfo3("matmul", "", "MatMul", "AIcoreEngine");
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_fileinvalid_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  std::string currentFilePath1 =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/fill.json";
  if (te::fusion::RealPath(currentFilePath1).empty()) {
    currentFilePath1 = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/fill.json";
  }
  ...
  std::string stub_file_path = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter";
  if (te::fusion::RealPath(stub_file_path).empty()) {
    stub_file_path = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st";
  }
  stub_file_path = te::fusion::RealPath(stub_file_path);

  jsonFilePath = stub_file_path + "/" +
                 "stub/binary_stub/te_matmul_2ac1b9067af400eb161d75ccd6c6ca71bed7b97750d79c4476fb65ac9bedd762.json";
  jsonFilePath = te::fusion::RealPath(jsonFilePath);
  printf("fuzzycompile_binary_fileinvalid_fail jsonFilePath=%s.\r\n", jsonFilePath.c_str());
}

TEST(TeFusionBinarySTest, fuzzycompile_binary_reuse_singleop_om_success) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  ...
  std::string jsonFilePath = te::fusion::RealPath(currentFilePath) + "/" +
                             "te_matmul_2ac1b9067af400eb161d75ccd6c6ca71bed7b97750d79c4476fb65ac9bedd762.json";
  //    EXPECT_NE(jsonPath, jsonFilePath);
  GlobalMockObject::verify();
}

TEST(TeFusionBinarySTest, fuzzycompile_binary_reuse_fusionop_om_success) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_om_key_id_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_om_singleop_fail) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, deleteOfile) {
  printf("deleteOfile. \r\n");
...
TEST(TeFusionBinarySTest, BinaryGeneralizeFusionOps_001) {
  ...
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
  auto opTaskPtr = std::make_shared<te::fusion::OpBuildTask>(te::fusion::OpBuildTask{
      graphId, taskId, sgtThreadIndex, teGraphNode, opDescPtr1, te::fusion::OP_TASK_STATUS::OP_TASK_SUCC});
...
TEST(TeFusionBinarySTest, BinaryGeneralizeWithRegisterFuncFusionOp_01) {
  nlohmann::json binaryInfo;
  int idx = 0;
  std::vector<std::pair<int64_t, int64_t>> range;
  TbeOpInfo op_info("add", "", "Add", "AIcoreEngine");
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "input0", range, true, op_info);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "input1", range, true, op_info);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "output0", range, false, op_info);
  ...
  jsonData1["shape"] = "shape";
  jsonData1["format"] = "format";
  jsonData1["dtype"] = "dtype";
  jsonData2["shape"] = "shape";
  jsonData2["format"] = "format";
  jsonData2["dtype"] = "dtype";
  json.push_back(jsonData1);
  json.push_back(jsonData2);
  generalizedRes.push_back(json);

  bool res = te::fusion::ShapeGeneralization::BinaryGeneralizeWithRegisterFuncFusionOp(generalizedRes, binaryInfo, idx,
                                                                                       tbeOpInfo);
  EXPECT_EQ(res, true);

  TbeOpInfo op_info_bnu("BNTrainingUpdate", "", "BNTrainingUpdate", "AIcoreEngine");
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "x", range, true, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "sum", range, true, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "square_sum", range, true, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "scale", range, true, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "offset", range, true, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "mean", range, true, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "variance", range, true, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "y", range, false, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "mean", range, false, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "variance", range, false, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "batch_mean", range, false, op_info_bnu);
  AddOpParamToTbeOpInfoV3({1, 2, 3, 4}, "int64", "NHWC", "batch_variance", range, false, op_info_bnu);

  std::vector<TbeOpParam> inputs;
  op_info_bnu.GetInputs(inputs);
  ...
  tensors[0].SetConstValue(attrValue1);

  TbeAttrValue attr_factor("factor", std::numeric_limits<float>::quiet_NaN());
  TbeAttrValue attr_epsilon("epsilon", std::numeric_limits<float>::infinity());

  op_info_bnu.AddAttrValue(attr_factor);
  op_info_bnu.AddAttrValue(attr_epsilon);

  TbeOpInfoPtr tbeOpInfoBNU = std::make_shared<TbeOpInfo>(op_info_bnu);

  GeneralizedResult generalizedResult;
  res = te::fusion::ShapeGeneralization::GenerateNormalizeFusionAttrTmpJson(tbeOpInfoBNU, generalizedResult, true,
                                                                            generalizedRes);
  EXPECT_EQ(res, true);
}
...
TEST(TeFusionBinarySTest, test_fuzzy_om_reuse_path) {
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub";
...
TEST(TeFusionBinarySTest, test_resolve_path) {
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub";
...
TEST(TeFusionBinarySTest, test_fuzzy_om_reuse_version) {
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub";
  ...
  std::string binAdkVersion;
  std::string binOppVersion;
  te::fusion::BinaryManager::Instance().GetBinaryVersionInfo(filePath, binAdkVersion, binOppVersion);
  std::string binCustomAdkVersion;
  std::string binCustomOppVersion;
  te::fusion::BinaryManager::Instance().GetBinaryVersionInfo(filePath, binCustomAdkVersion, binCustomOppVersion);
...
TEST(TeFusionBinarySTest, test_fuzzy_om_compile_singleop_success) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, test_fuzzy_om_compile_fusionop_success) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, test_check_git_compile_success) {
  std::string opType = "Fill";
  ...
  opdesc_0 = CreateOpDesc(opNameTest, opType, 0, "RT_DEV_BINARY_MAGIC_ELF", 1, inputnameList0, 2, inputdescList0,
                          outputdescList0);
  ...
  printf("op_info_ptr1 is %x\n", op_info_ptr1);
  std::shared_ptr<TbeOpInfo> op_info_ptr2 =
      std::make_shared<te::TbeOpInfo>(nodePoint2->GetName(), "", nodePoint2->GetType(), "");
  printf("op_info_ptr2 is %x\n", op_info_ptr2);

  printf("UpdateTbeOpInfo, keyName1 is %s, op_info_ptr1 is %x\n", keyName1.c_str(), op_info_ptr1);
  TbeOpInfoCache::Instance().UpdateTbeOpInfo(keyName1, op_info_ptr1);
  printf("UpdateTbeOpInfo, keyName2 is %s, op_info_ptr2 is %x\n", keyName1.c_str(), op_info_ptr2);
  ...
  for (const auto &node : task->opNodes) {
    ConstTbeOpInfoPtr tbeOpInfo = TbeOpInfoCache::Instance().GetTbeOpInfoByNode(node);
    std::string keyName;
    bool bres = TbeOpInfoCache::Instance().GetOpKeyNameByNode(node, keyName);
    printf("tbeOpInfo is %x, GetOpJitCompile is %d, keyName is %s.\n", tbeOpInfo, tbeOpInfo->GetOpJitCompile(),
           keyName.c_str());
  }
  bres = te::fusion::BinaryManager::Instance().CheckJitCompileForBinReuse(task);
  EXPECT_EQ(bres, true);
...
TEST(TeFusionBinarySTest, test_non_fuzzy_reuse_success) {
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  uint64_t sgtThreadIndex = 300;
...
TEST(TeFusionBinarySTest, test_MatchStaticKeyWithOptionalInputNull) {
  ...
  std::vector<ge::Node *> teGraphNode;
  auto task = std::make_shared<te::fusion::OpBuildTask>(te::fusion::OpBuildTask{
      graphId, taskId, sgtThreadIndex, teGraphNode, nullptr, te::fusion::OP_TASK_STATUS::OP_TASK_PENDING});
  GeneralizedResult generalizedResult;

  std::string currentFilePath1 =
      GetCodeDir() +
      "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose_op.json";
  ...
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose.json";
  std::string path = te::fusion::RealPath(currentFilePath);
  nlohmann::json binListJson;
  te::fusion::TeFileUtils::GetJsonValueFromJsonFile(path, binListJson);
  bool bres =
      te::fusion::BinaryManager::Instance().MatchStaticKeyWithOptionalInputNull(task, binListJson, generalizedResult);
  EXPECT_EQ(bres, true);

  std::string currentFilePath2 =
      GetCodeDir() +
      "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose_fail.json";
  ...
  bres =
      te::fusion::BinaryManager::Instance().MatchStaticKeyWithOptionalInputNull(task, binListJson1, generalizedResult);
  EXPECT_EQ(bres, false);
}

bool GetBinaryInfoConfigPath_Stub(te::fusion::BinaryInfoBase *This, const string &configPath,
                                  std::string &configRealPath, bool isSuperKernel) {
  printf("GetBinaryInfoConfigPath_Stub \r\n");

  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_info_config.json";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    printf("GetBinaryInfoConfigPath_Stub is empty");
    currentFilePath =
        "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/binary_info_config.json";
  }
  configRealPath = currentFilePath;
  return true;
}

TEST(TeFusionBinarySTest, test_ParseBinaryInfo) {
  ...
  MOCKER_CPP(&te::fusion::BinaryInfoBase::GetBinaryInfoConfigPath,
             bool (te::fusion::BinaryInfoBase::*)(const string &, std::string &, const bool &, const std::string &)
                 const)
      .stubs()
...
TEST(TeFusionBinarySTest, test_ParseAllBinaryInfoConfigPath) {
...
TEST(TeFusionBinarySTest, test_GenerateAttrSimplifiedKey) {
  TeCacheSpaceManager &fusion_serial = TeCacheSpaceManager::Instance();
  std::vector<std::pair<int64_t, int64_t>> range = {{1, 10}, {1, 10}};
  ...
  bool res = generateKey.GenerateSimpleKeyStr(simpleKeystr);
  // EXPECT_EQ(res, true);
...
TEST(TeFusionBinarySTest, test_GetSimplifiedKey) {
...
TEST(TeFusionBinarySTest, test_GetInfoFailed) {
  TbeOpInfoCache::Instance().secondTbeOpInfoMap_.clear();
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  ...
  auto opTask = std::make_shared<te::fusion::OpBuildTask>(te::fusion::OpBuildTask{
      graphId, taskId, sgtThreadIndex, teGraphNode, opDescPtr, te::fusion::OP_TASK_STATUS::OP_TASK_PENDING});
  TeFusionManager *pInstance = te::fusion::TeFusionManager::GetInstance();
  std::string jsonFilePath;
...
TEST(TeFusionBinarySTest, test_GenerateSimpleKeyStrInputOutputFailed) {
  TeCacheSpaceManager &fusion_serial = TeCacheSpaceManager::Instance();
...
// TEST(TeFusionBinarySTest, test_CustomMode) {
//     TeCacheSpaceManager &fusion_serial = TeCacheSpaceManager::Instance();
...
//     TeConfigInfo::Instance().config_str_item_vec_[static_cast<size_t>(TeConfigInfo::ConfigStrItem::ShortSocVersion)]
//     = "910B"; BinaryInfoBasePtr binaryInfoPtr = std::make_shared<te::fusion::BinaryInfoBase>(); std::string
//     configJsonPath = ""; bool res = binaryInfoPtr->ParseBinaryInfoFile(configJsonPath, false);
//     TbeOpInfoCache::Instance().secondTbeOpInfoMap_.clear();
//     std::vector<std::pair<int64_t, int64_t>> range = {{1,10},{1,10}};
//     TbeOpInfo opInfo("padV2", "", "PadV2", "AIcoreEngine");
//     TbeOpInfoPtr pTbeOp = std::make_shared<TbeOpInfo>(opInfo);
...
//     res = generateKeyTest2.CheckParamSetDefaultVal();
//     EXPECT_EQ(res, false);
//     res = generateKeyTest3.CheckParamSetDefaultVal();
//     EXPECT_EQ(res, false);
//     std::string simpleKeystr;
//     res = generateKey.GenerateSimpleKeyStr(simpleKeystr);
//     EXPECT_EQ(res, false);
...
TEST(TeFusionBinarySTest, test_DtypeNormalize) {
  GenerateSimpleKey generateKey = {"PadV2", SimpleKeyModeType::COMPATIBLE_MODE, "high_performance", "false", true};
...
TEST(TeFusionBinarySTest, test_MatchSimpleKey) {
  TbeOpInfoCache::Instance().secondTbeOpInfoMap_.clear();
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
  ...
  BinaryManager::Instance().ParseAllBinaryInfoConfigPath();
  BinaryInfoBasePtr binaryInfoPtr = BinaryManager::Instance().binaryInfoPtrMap_[6];
  binaryInfoPtr->simpleKeyModeMap_ = {{"Mul", SimpleKeyModeType::SIMPLE_MODE}};
...
TEST(TeFusionBinarySTest, test_MatchSimpleKey2) {
  TbeOpInfoCache::Instance().secondTbeOpInfoMap_.clear();
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
...
TEST(TeFusionBinarySTest, test_MatchSimpleKey3) {
  TbeOpInfoCache::Instance().secondTbeOpInfoMap_.clear();
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
...
TEST(TeFusionBinarySTest, test_MatchSimpleKey4) {
  TbeOpInfoCache::Instance().secondTbeOpInfoMap_.clear();
  bool res = false;
  uint64_t graphId = 100;
  uint64_t taskId = static_cast<uint64_t>(rand());
...
TEST(TeFusionBinarySTest, test_opp_latest_env) {
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/ut/stub/binary_stub";
  }
  setenv("ASCEND_OPP_PATH", currentFilePath.c_str(), 1);
  ...
  const std::map<std::string, std::string> options = {
      ...
      {"op.binary.custom",
       "100|/vendors/customize/op_impl/ai_core/tbe/kernel/, 101|/vendors/mdc/op_impl/ai_core/tbe/kernel/"}};
  // get binary file path
...
TEST(TeFusionBinarySTest, test_generate_dtype_format_mode) {
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_001) {
  std::string opType = "Abs";
  nlohmann::json binaryListJson;
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list.json";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/binary_list.json";
  }
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_002) {
  std::string opType = "Abs";
  nlohmann::json binaryListJson;
  std::string currentFilePath =
      GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list_no_key.json";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath =
        "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/binary_list_no_key.json";
  }
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_003) {
  std::string opType = "Abs";
  nlohmann::json binaryListJson;
  std::string currentFilePath =
      GetCodeDir() +
      "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list_key_not_array.json";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath =
        "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/binary_list_key_not_array.json";
  }
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_004) {
  std::string opType = "Abs";
  nlohmann::json binaryListJson;
  std::string currentFilePath =
      GetCodeDir() +
      "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list_path_null.json";
  if (te::fusion::RealPath(currentFilePath).empty()) {
    currentFilePath =
        "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/binary_list_path_null.json";
  }
