...
ge::graphStatus FakeGetOptionGrouplist(ge::GEThreadLocalContext *that, const std::string &optionExec, std::string &dumpDebugValue)
{
...
ge::graphStatus FakeGetOptionError1(ge::GEThreadLocalContext *that, const std::string &optionExec, std::string &dumpDebugValue)
{
    if (optionExec == ge::OPTION_EXEC_HCOM_GROUPLIST) {
...
TEST_F(HcomExecutorTest, st_executor_initgroup)
{

    set_board_id(0x0000);
    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_executor_initgroup.json";
    ...
    // 走1910 4pring
    char* rank_table_file = "./st_executor_initgroup.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, st_executor_initgroup1)
{

    set_board_id(0x0000);
    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_executor_initgroup1.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(HcomExecutorTest, st_executor_initgroup1_error)
{

    set_board_id(0x0000);
    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_executor_initgroup1_error.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
    ...
    MOCKER_CPP(&ge::GEThreadLocalContext::GetOption)
    .stubs()
    .will(invoke(FakeGetOptionError1));
...
#if 1
TEST_F(HcomExecutorTest, st_executor_broadcast)
{
    set_board_id(0x0000);
    nlohmann::json rank_table = rank_table_910_1server_1rank;
...
TEST_F(HcomExecutorTest, st_executor_allreduce)
{
...
#endif
#if 1
TEST_F(HcomExecutorTest, st_executor_equeue_allreduce_mix)
{
...
#if 1
TEST_F(HcomExecutorTest, st_executor_equeue_allreduce)
{
...
#if 1
TEST_F(HcomExecutorTest, st_executor_equeue_reduce_scatter)
{

    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_executor_equeue_reduce_scatter.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcomExecutorTest, st_executor_equeue_broardcast)
{
...
#if 1
TEST_F(HcomExecutorTest, st_executor_equeue_allgather)
{
...
#if 1
TEST_F(HcomExecutorTest, st_executor_equeue_allgather_mutiInit)
{

    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_executor_equeue_allgather_mutiInit.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcomExecutorTest, st_executor_equeue_mutiInit)
{

    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_executor_equeue_mutiInit.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(HcomExecutorTest, st_executor_equeue_alltoallv)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
...
#if 1
TEST_F(HcomExecutorTest, st_executor_reduce)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
...
TEST_F(HcomExecutorTest, st_executor_runGather)
{
    MOCKER_CPP(&HcomExecutor::GatherMemCopyThread).stubs().with()
    .will(returnValue(HCCL_SUCCESS));
    ...
    s32 addrLength = -1;
    HcclResult result = hccl::HcomExecutor::GetInstance().RunGather(addrInfo, addrInfoCountPerRank, rankSize, sendCounts, sdispls, sendDevBuf, addrLength);
    EXPECT_EQ(result, HCCL_SUCCESS);
}

TEST_F(HcomExecutorTest, st_HcomExec) {
...
TEST_F(HcomExecutorTest, st_ExecuteAlltoAll) {
    ...
    MOCKER_CPP(HcomHcclAlltoAll)
    .stubs()
    .will(returnValue(HCCL_SUCCESS));

    MOCKER_CPP(HcomHcclAlltoAllV)
    .stubs()
    .will(returnValue(HCCL_SUCCESS));
