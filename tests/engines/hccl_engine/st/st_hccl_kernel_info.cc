...
protected:
    static void SetUpTestCase()
    {
        ...
        char file_name[] = "./st_HcomKernelInfoTest.json";
...
TEST_F(HcomKernelInfoTest, st_LoadTask_comm)
{
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(s8));
    sal_memset(sendbuf, 10 * sizeof(s8), 0, 10 * sizeof(s8));
    s8* recv = (s8*)sal_malloc(10 * sizeof(s8));
    ...
    nlohmann::json rank_table = rank_table_910_1server_1rank;
    char file_name_t[] = "./st_LoadTask_com.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
    ...
    // 走1910 4pring
    char* rank_table_file = "./st_LoadTask_com.json";
    char* rank_ID = "0";
...
TEST_F(HcomKernelInfoTest, st_Initialize_Finalize)
{
    ge ::Status ret;
...
TEST_F(HcomKernelInfoTest, st_GetHcomOpMemSize)
{
    HcclResult ret;
...
TEST_F(HcomKernelInfoTest, st_RefreshInputAddr)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_RefreshInputAddr2)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_RefreshInputAddr3)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_RefreshOutputAddr)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_RefreshOutputAddr2)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_GetHcomOutCCLbufferSize)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_RefreshOutputAddr3)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_hcom_loadtask_checkTaskID)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_hcom_loadtask_checkTaskID.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
    ...
    options.insert(pair<string,string> (ge::OPTION_EXEC_RANK_TABLE_FILE,"./st_hcom_loadtask_checkTaskID.json"));
...
TEST_F(HcomKernelInfoTest, st_unloadtask)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_unloadtask.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
    ...
    options.insert(pair<string,string> (ge::OPTION_EXEC_RANK_TABLE_FILE,"./st_unloadtask.json"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_RANK_ID,"0"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_DEPLOY_MODE,"0"));
    options.insert(pair<string,string> (ge::OPTION_GRAPH_RUN_MODE,"1"));
...
TEST_F(HcomKernelInfoTest, st_task_overflow)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_task_overflow.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
    ...
    options.insert(pair<string,string> (ge::OPTION_EXEC_RANK_TABLE_FILE,"./st_task_overflow.json"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_RANK_ID,"0"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_DEPLOY_MODE,"0"));
    options.insert(pair<string,string> (ge::OPTION_GRAPH_RUN_MODE,"1"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_PROFILING_MODE,"0"));
...
TEST_F(HcomKernelInfoTest, st_SaveReduceDumpTask)
{
...
#define HCCL_COM_DATA_SIZE 1024
TEST_F(HcomKernelInfoTest, st_hcom_loadtask_int64)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;

    char file_name_t[] = "./st_hcom_loadtask_int64.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
    ...
    options.insert(pair<string,string> (ge::OPTION_EXEC_RANK_TABLE_FILE,"./st_hcom_loadtask_int64.json"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_RANK_ID,"0"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_DEPLOY_MODE,"0"));
    options.insert(pair<string,string> (ge::OPTION_GRAPH_RUN_MODE,"1"));
    options.insert(pair<string,string> (ge::OPTION_EXEC_ENABLE_DUMP_DEBUG,"1"));
...
TEST_F(HcomKernelInfoTest, st_GetOpKernelLoopTime1)
{
    u64 count = 128;
    const std::string sGroup = HCCL_WORLD_GROUP;
    HcomOpsKernelInfoStore hcomKernelInfo;
...
TEST_F(HcomKernelInfoTest, st_GetOpKernelLoopTime2)
{
    u64 count = 128;
    const std::string sGroup = HCCL_WORLD_GROUP;
    HcomOpsKernelInfoStore hcomKernelInfo;
...
TEST_F(HcomKernelInfoTest, st_GetInputCCLbufPtrAndIndirectInCCLbufPtr_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    HcclResult ret;
    u32 shapeType = ORIGINAL_GRAPH_UNKNOWNSHAPE_TYPE;
    const std::string sGroup = HCCL_WORLD_GROUP;
...
TEST_F(HcomKernelInfoTest, st_GetAlltoAllVCParams_When_AllParamsValid_Expect_CorrectValues) 
{
    HCCL_KERNEL_INFO_PRIVATE_DEF privateDefBuf;
    strcpy_s((char *)privateDefBuf.group, 128, "hccl_world_group");
    privateDefBuf.nodeNameHash = 1234567890;
