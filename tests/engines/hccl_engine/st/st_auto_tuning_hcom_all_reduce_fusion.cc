...
TEST_F(AutoTuningHcomAllReduceFusionTest, utAddFusionMapInFusionJsonWithNonempty) {
  ...
  MOCKER(HcomOpUtils::CreateFusionConfigVersion).stubs().with(outBound(socVersion)).will(returnValue(HCCL_SUCCESS));
  ...
  nlohmann::json fusion_json = {{"modelhash", "3047522271241092779"},
                                {"modelvalue",
                                 {{"gradientSize",
                                   {16384000, 4000, 67108864, 16384, 150994944, 16384, 2359296, 1024, 3538944, 1024,
                                    2654208, 1536, 1843200, 768, 139392, 384}},
                                  {"gradientTime",
                                   {9833418590329, 15080, 100303, 86064, 408791, 246415, 634287, 686785, 103, 564542,
                                    100, 1686982, 117497, 3490117, 202901, 117711}}}}};
