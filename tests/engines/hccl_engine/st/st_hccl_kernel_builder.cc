...
protected:
    static void SetUpTestCase()
    {
        ...
        char file_name[] = "./st_HcomKernelBuilderTest.json";
...
TEST_F(HcomKernelBuilderTest, st_CalcOpRunningParam_common)
{
    ...
    char file_name_t[] = "./st_CalcOpRunningParam_common.json";
...
TEST_F(HcomKernelBuilderTest, st_CalcOpRunningParam_common_51)
{
    struct model_feature feature;
    u32 segment_num = 10;
    std::vector<u32> segment_index;
    ...
    char file_name_t[] = "./st_CalcOpRunningParam_common_51.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(HcomKernelBuilderTest, st_generateTask)
{
    ge::NodePtr nodeptr(new NodeTest);
...
TEST_F(HcomKernelBuilderTest, st_GenerateTask_unknown)
{
    ge::Status ret;
...
TEST_F(HcomKernelBuilderTest, st_CalcOpRunningParam_V51)
{
    struct model_feature feature;
    u32 segment_num = 10;
    std::vector<u32> segment_index;
    ...
    char file_name_t[] = "./st_CalcOpRunningParam_V51.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(HcomKernelBuilderTest, st_GenerateTask_AlltoAllVC)
{
    ge::NodePtr nodeptr(new NodeTest);
    HcomOpsKernelBuilder hcomKernelInfo;
...
TEST_F(HcomKernelBuilderTest, st_generateTask_by_comm_pytorch)
{
    ge::NodePtr nodeptr(new NodeTest);
    ge::Buffer tempBuffer;
    ge::RunContext runContext_dummy;
...
TEST_F(HcomKernelBuilderTest, st_generateTask_by_comm_pytorch2)
{
    ge::NodePtr nodeptr(new NodeTest);
    ge::Buffer tempBuffer;
    ge::RunContext runContext_dummy;
...
TEST_F(HcomKernelBuilderTest, st_offlinebuild_calcSubStreamNum)
{
    ge::Status ret;
    HcomOpsKernelBuilder hcomOpsKernelInfoStore_;
    ge::NodePtr nodeptr(new NodeTest);
...
TEST_F(HcomKernelBuilderTest, st_offlinebuild_calcSubStreamNumAllToAllVC)
{
    HcclResult ret;
...
TEST_F(HcomKernelBuilderTest, st_GenerateTaskDef)
{
    ge::NodePtr nodeptr(new NodeTest);
    HcomOpsKernelBuilder hcomKernelInfo;
...
TEST_F(HcomKernelBuilderTest, st_offlinebuild_calcSubStreamNumv2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    ge::Status ret;
    HcomOpsKernelBuilder hcomOpsKernelInfoStore_;
    ge::NodePtr nodeptr(new NodeTest);
...
TEST_F(HcomKernelBuilderTest, st_SetPrivateDefWithTensorInfo) {
    ge::NodePtr nodeptr(new NodeTest);
    std::string type = HCCL_KERNEL_OP_TYPE_ALLTOALLV;
    nodeptr->GetOpDesc()->SetType(type);
    std::string curGroup = "aa";
