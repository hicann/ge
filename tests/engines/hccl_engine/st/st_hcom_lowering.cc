...
TEST_F(HcomLoweringTest, st_node_recv_emptyNode)
{
    ge::NodePtr node;
    gert::bg::ValueHolderPtr valuePtr = nullptr;
	gert::bg::DevMemValueHolderPtr memValuePtr = nullptr;
...
TEST_F(HcomLoweringTest, st_hcomLaunchKernel_allgatherv_count0)
{
...
TEST_F(HcomLoweringTest, st_hcomLaunchKernel_reducescatterv_count0)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
...
TEST_F(HcomLoweringTest, st_hcomLaunchKernel_errortest1)
{
    MOCKER(GetHcomOpLaunchArgs)
    .stubs()
    .with(mockcpp::any())
...
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
    char file_name_t[] = "./st_hcomLaunchKernel_allreduce_multi_inpst_sess.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(HcomLoweringTest, st_launchHcomKernelInitComm_test)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
    char file_name_t[] = "./st_launchHcomKernelInitComm_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(HcomLoweringTest, st_HcomAllToAllGetOpAttr_test)
{
    ge::NodePtr node;
    HcomOpAttr opAttr;
...
TEST_F(HcomLoweringTest, st_HcomReduceScatterKernelV2) 
{
...
TEST_F(HcomLoweringTest, st_HcomCopyInputsToCCLbuff) 
{
    ...
    HcclResult result = HcomCopyInputsToCCLbuff(launchArgs, inputsNum, inputsOffset, inputsCount, cclBuff, cclBuffSize, commCount, inputAddrs);
    EXPECT_EQ(result, HCCL_SUCCESS);
