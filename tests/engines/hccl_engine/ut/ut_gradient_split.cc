...
TEST_F(HcomGradientSplitTuneTest, ut_Gradient_AutoTuning_E2E_Test_Profiling) {
  bool bErr = false;
...
TEST_F(HcomGradientSplitTuneTest, ut_Gradient_AutoTuning_E2E) {
  bool bErr = false;
  std::map<std::string, std::string> options;
  options.insert(pair<string, string>(ge::BUILD_MODE, "tuning"));
  options.insert(pair<string, string>(ge::TUNING_PATH, "./"));
  ...
  MOCKER_CPP(&AutoTuningHcomAllReduceFusion::SetGradientInformation).stubs().will(returnValue(HCCL_SUCCESS));
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_AllGather_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_AllReduce_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_Broadcast_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_AlltoAllx_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_InitAlltoAllHostMem) {
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_Reduce_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_ReduceScatter_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_Send_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_Receive_load) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  rtStream_t stream;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomGraphOptimizer) {
  ge ::Status ge_ret;
  std::map<std::string, std::string> options;
  ...
  MOCKER_CPP(&AutoTuningHcomAllReduceFusion::RecordGradientDataInfo).stubs().will(returnValue(HCCL_SUCCESS));
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomGraphOptimizer_jobType) {
  ge ::Status ge_ret;
  std::map<std::string, std::string> options;
  options.insert(pair<string, string>(ge::BUILD_MODE, "turning"));
  options.insert(pair<string, string>(ge::TUNING_PATH, "./"));
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_fusion_HcomGraphOptimizer_jobType) {
  ge ::Status ge_ret;
  std::map<std::string, std::string> options;
  options.insert(pair<string, string>(ge::BUILD_MODE, "turning"));
  options.insert(pair<string, string>(ge::TUNING_PATH, "./"));
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo) {
  HcclResult ret;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_PluginManager_one) {
  ge ::Status ge_ret;
  std::map<std::string, std::string> options;
  options.insert(pair<string, string>(ge::BUILD_MODE, "tuning"));
  options.insert(pair<string, string>(ge::TUNING_PATH, "./"));
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_PluginManager_two) {
  ge ::Status ge_ret;
  std::map<std::string, std::string> options;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_PluginManager_three) {
  ge ::Status ge_ret;
  std::map<std::string, std::string> options;
  options.insert(pair<string, string>(ge::BUILD_MODE, "tuning"));
  options.insert(pair<string, string>("ge.jobType", "4"));
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo_allreduce_unknownshape) {
  HcclResult ret;
  ...
  MOCKER(&ge::NodeUtils::GetNodeUnknownShapeStatus).stubs().with(outBound(true)).will(returnValue(ge::GRAPH_SUCCESS));
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo_allgather) {
  HcclResult ret;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo_broadcast) {
  HcclResult ret;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo_reduce) {
  HcclResult ret;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo_reducescatter) {
  HcclResult ret;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo_send) {
  HcclResult ret;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_RecordGradientDataInfo_receive) {
  HcclResult ret;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_HcomOpsKernelInfoStore_unloadTask) {
  ge::Status ge_ret;
  ge::GETaskInfo task;
  AutoTuningHcomOpsKernelInfoStore athcomOpsKernelInfo;
...
TEST_F(HcomGradientSplitTuneTest, ut_gradient_AddTraceNode) {
  HcclResult ret;
