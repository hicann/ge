...
TEST_F(FlowFuncManagerUTest, register_multi_func_name_null) {
...
TEST_F(FlowFuncManagerUTest, register_multi_func_null) {
  auto ret = RegisterMultiFunc("test_multi_func_null", MULTI_FUNC_CREATOR_FUNC());
  EXPECT_FALSE(ret);
}

TEST_F(FlowFuncManagerUTest, register_multi_func_with_q_name_null) {
...
TEST_F(FlowFuncManagerUTest, register_multi_func_with_q_null) {
