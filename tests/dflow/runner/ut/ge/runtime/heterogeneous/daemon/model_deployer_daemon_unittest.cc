...
class MockMmpaDeployer : public MmpaStubApiGe {
 public:
  virtual int32_t Sleep(UINT32 millSecond) override {
    return 0;
  }
  MOCK_METHOD3(RealPath, int32_t(const CHAR *, CHAR *, INT32));
