...
FMK_FUNC_HOST_VISIBILITY FMK_FUNC_DEV_VISIBILITY extern const std::string DUMP_WATCHER_MODEL;
...
REGISTER_OPTYPE_DECLARE(DROPOUTGENMASKV3, "DropOutGenMaskV3");
...
REGISTER_OPTYPE_DECLARE(SLICEWITHAXES, "SliceWithAxes");
...
REGISTER_OPTYPE_DECLARE(STRIDEDSLICED, "StridedSliceD");
REGISTER_OPTYPE_DECLARE(STRIDEDSLICEV2, "StridedSliceV2");
REGISTER_OPTYPE_DECLARE(STRIDEDSLICEV3, "StridedSliceV3");
...
REGISTER_OPTYPE_DECLARE(SPLITD, "SplitD");
REGISTER_OPTYPE_DECLARE(SPLITVD, "SplitVD");
...
REGISTER_OPTYPE_DECLARE(DYNAMICGETNEXT, "DynamicGetNext");
REGISTER_OPTYPE_DECLARE(DYNAMICGETNEXTV2, "DynamicGetNextV2");
...
REGISTER_OPTYPE_DECLARE(CONSTPLACEHOLDER, "ConstPlaceHolder");
...
REGISTER_OPTYPE_DECLARE(HCOMALLGATHERV, "HcomAllGatherV");
REGISTER_OPTYPE_DECLARE(HCOMALLREDUCE, "HcomAllReduce");
REGISTER_OPTYPE_DECLARE(HCOMREDUCESCATTER, "HcomReduceScatter");
REGISTER_OPTYPE_DECLARE(HCOMREDUCESCATTERV, "HcomReduceScatterV");
...
REGISTER_OPTYPE_DECLARE(NPUCLEARFLOATDEBUGSTATUS, "NPUClearFloatDebugStatus");
...
REGISTER_OPTYPE_DECLARE(EXPONENTIAL_DECAY_LR, "ExponentialDecayLR");
...
// Phony
REGISTER_OPTYPE_DECLARE(PHONYCONCAT, "PhonyConcat");
REGISTER_OPTYPE_DECLARE(PHONYSPLIT, "PhonySplit");

REGISTER_OPTYPE_DECLARE(CMO, "Cmo");
REGISTER_OPTYPE_DECLARE(TENSORMOVE, "TensorMove");
...
FMK_FUNC_HOST_VISIBILITY FMK_FUNC_DEV_VISIBILITY extern const std::string COMPILED_INFERENCE_RULE_BINARY;
FMK_FUNC_HOST_VISIBILITY FMK_FUNC_DEV_VISIBILITY extern const std::string NODE_NAME_GLOBAL_STEP;

constexpr uint64_t kRtMemoryUB = (1ULL << 15U);
