...
class ProfilingTaskUtils {
 ...
 private:
  // profiling interface
  static void AssembleTaskForProfilerTrace(const int64_t stream_id, const int64_t log_id, bool is_iteration_end,
                                           std::vector<domi::TaskDef> &task_def_list);
  static Status CalculateLogId(const std::vector<int64_t> &trace_nodes, const int64_t node_index,
