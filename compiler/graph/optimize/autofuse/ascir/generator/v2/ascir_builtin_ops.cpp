...
class AscIrAttStubV2 : public ge::ascir::AscIrAtt {
  ...
  void *GetMicroApiPerf() const override {
    return nullptr;
  }
...
const std::vector<std::string> v2_soc_versions{"Ascend910_9591", "Ascend910_950z", "Ascend910_957b", "Ascend910_957d",
                                               "Ascend910_9589", "Ascend910_958a", "Ascend910_958b", "Ascend910_9599",
                                               "Ascend910_9581", "Ascend910_9579", "Ascend910_957c"};
    ...
    .Impl(v2_soc_versions,
          {ge::ascir::AscIrImplCreator<ge::ascir::CastAscIrAttImplV2>(),
           ...
           {{"T1", OrderedTensorTypeList{DT_FLOAT,   DT_FLOAT,   DT_FLOAT,   DT_FLOAT,   DT_FLOAT,   DT_FLOAT,
                                         ...
                                         DT_INT64,   DT_INT64,   DT_BF16,    DT_BF16,    DT_UINT32,  DT_UINT16,
                                         DT_UINT64}},
            {"T2", OrderedTensorTypeList{DT_FLOAT,  DT_FLOAT16, DT_INT64,   DT_INT32, DT_INT16,   DT_BF16,
                                         ...
                                         DT_INT32,  DT_FLOAT,   DT_FLOAT,   DT_INT32,   DT_INT32, DT_INT16,
                                         DT_INT64}}}});
...
REG_ASC_IR(Max)
    .Impl(v2_soc_versions, {ge::ascir::AscIrImplCreator<ge::ascir::MaxAscIrAttImplV2>(),
                            ...
                            {{"T", TensorType{DT_FLOAT16, DT_FLOAT, DT_INT64}}}});
...
REG_ASC_IR(Sum)
    .Impl(v2_soc_versions, {ge::ascir::AscIrImplCreator<ge::ascir::SumAscIrAttImplV2>(),
                            ...
                            {{"T", TensorType{DT_FLOAT, DT_INT32, DT_INT64}}}});
...
REG_ASC_IR(LogicalOr)
    .Impl(v2_soc_versions,
          {ge::ascir::AscIrImplCreator<ge::ascir::LogicalOrAscIrAttImplV2>(),
...
REG_ASC_IR(LogicalAnd)
    .Impl(v2_soc_versions,
          {ge::ascir::AscIrImplCreator<ge::ascir::LogicalAndAscIrAttImplV2>(),
