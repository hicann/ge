...
#ifndef __AUTOFUSE_REG_LOAD_API_CALL_H__
#define __AUTOFUSE_REG_LOAD_API_CALL_H__
...
class LoadRegApiCall final : public ApiCall {
 public:
  ...
  Status GenDimensionParam(const CodegenApiParamPtr api_param, std::stringstream &ss) const override;
