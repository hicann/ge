...
#ifndef __AUTOFUSE_MICRO_LOAD_API_CALL_H__
#define __AUTOFUSE_MICRO_LOAD_API_CALL_H__
...
class MicroLoadApiCall final : public MicroApiCall {
 ...
 private:
  Status UpdateDistModeByStrideInfo(const TPipe &tpipe);
  std::string dist_ = "";
};
}  // namespace codegen
