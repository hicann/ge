...
#ifndef __AUTOFUSE_REG_STORE_API_CALL_H__
#define __AUTOFUSE_REG_STORE_API_CALL_H__

#include "../codegen_kernel.h"

namespace codegen {
class StoreRegApiCall final : public ApiCall {
 public:
  using ApiCall::Generate;
  explicit StoreRegApiCall(const std::string &api_name) : ApiCall(api_name) {}
  ~StoreRegApiCall() final = default;
 ...
 private:
  std::vector<ge::Expression> repeats_;
  ge::Expression offset_ = ge::ops::Zero;
};
}  // namespace codegen

#endif  // __AUTOFUSE_REG_STORE_API_CALL_H__
