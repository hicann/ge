...
void CreateBaseDmaCall(const TPipe &tpipe, const Tensor &input, const Tensor &output, const DmaParams &dma_param,
...
void CreateBaseEnhanceDmaCall(const TPipe &tpipe, const Tensor &input, const Tensor &output, const DmaParams &dma_param,
...
void CreateEnhanceDmaCall(const TPipe &tpipe, const Tensor &input, const Tensor &output, const string &gm_offset,
  ...
  if (total_len <= kDmaMaxLen) {
    CreateBaseDmaCall(tpipe, input, output, dma_param, padding_mode, ss, copy_in);
    return;
  }

  if (total_len > kDmaMaxLen && total_len <= kFourAxisNum) {
    CreateBaseEnhanceDmaCall(tpipe, input, output, dma_param, padding_mode, loop_mode_param, ss, copy_in);
    return;
  }
  ...
  CreateBaseEnhanceDmaCall(tpipe, input, output, dma_param, padding_mode, loop_mode_param, ss1, copy_in);
