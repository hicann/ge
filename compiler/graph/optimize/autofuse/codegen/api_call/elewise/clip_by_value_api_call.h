 ...
 */
#ifndef __AUTOFUSE_CLIP_BY_VALUE_API_CALL_H__
#define __AUTOFUSE_CLIP_BY_VALUE_API_CALL_H__
#include "../codegen_kernel.h"

namespace codegen {
class ClipByValueApiCall final : public ApiCall {
public:
  using ApiCall::Generate;
  explicit ClipByValueApiCall(const std::string &api_name) : ApiCall(api_name) {}
  ~ClipByValueApiCall() final = default;
