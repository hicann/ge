...
#ifndef __AUTOFUSE_LOAD_API_CALL_H__
#define __AUTOFUSE_LOAD_API_CALL_H__

#include "../codegen_kernel.h"

namespace codegen {
class LoadApiCall final : public ApiCall {
 public:
  using ApiCall::Generate;
  explicit LoadApiCall(const std::string &api_name) : ApiCall(api_name) {}
  ~LoadApiCall() final = default;
...
#endif  // __AUTOFUSE_LOAD_API_CALL_H__
