...
__aicore__ inline constexpr MatmulConfig CreatMatmulConfigWithRelu(T baseConfig) {
    ...
    mmCfg.enableRelu = true;
    return mmCfg;
}
// set enUnitFlag
constexpr MatmulConfig MM_CFG_NO_PRELOAD_TMP = GetMDLConfig(false, false, 0, false, false, false, true);
constexpr MatmulConfig MM_CFG_NO_PRELOAD = CreatMatmulConfigWithRelu(MM_CFG_NO_PRELOAD_TMP);
// set enUnitFlag false for split k n template
constexpr MatmulConfig MM_CFG_NO_PRELOAD_TMP_WITH_SPLIT_K_N = GetMDLConfig(false, false, 0, false, false, false, false);
constexpr MatmulConfig MM_CFG_NO_PRELOAD_WITH_SPLIT_K_N = CreatMatmulConfigWithRelu(MM_CFG_NO_PRELOAD_TMP_WITH_SPLIT_K_N);
// set enMultiBatch Info
constexpr MatmulConfig MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS_TMP = GetMMConfig<MatmulConfigMode::CONFIG_NORM>(batchBiasParams);
constexpr MatmulConfig MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS = CreatMatmulConfigWithRelu(MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS_TMP);
