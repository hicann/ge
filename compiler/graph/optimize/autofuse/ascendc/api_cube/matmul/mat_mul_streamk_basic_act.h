...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class A_LAYOUT, class B_LAYOUT, class C_LAYOUT,
          MatMulL0C2Out MATMUL_L0C2OUT, bool ENABLE_RELU = false>
    ...
    GM_ADDR cGM, GM_ADDR workspaceGM, const MatMulV3BasicTilingData& tilingData, int64_t batch = 0)
{
    ...
    using BlockMmad = Block::BlockMmadBuilder<
            ...
            L1TileShape, L0TileShape, BlockScheduler, MatmulMultiBlockWithStreamK<MATMUL_L0C2OUT, ENABLE_RELU>>;
    ...
    // 定义BlockEpilogue类型
    using BlockEpilogue =
        Block::BlockEpilogueStreamK<float, OutType, MatmulMultiBlockWithStreamK<MATMUL_L0C2OUT, ENABLE_RELU>>;
