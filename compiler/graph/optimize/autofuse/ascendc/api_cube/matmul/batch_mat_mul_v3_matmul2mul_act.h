...
/* !
 * \file batch_mat_mul_v3_matmul2mul_act.h
 * \brief
 */

#ifndef BATCH_MAT_MUL_V3_MATMUL2MUL_ACT_H
#define BATCH_MAT_MUL_V3_MATMUL2MUL_ACT_H

#include "include/matmul/kernel/kernel_batch_matmul_to_mul.h"
using namespace Act;
