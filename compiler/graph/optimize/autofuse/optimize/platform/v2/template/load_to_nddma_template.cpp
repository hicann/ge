 ...
 */
ge::Status LoadToNddmaTemplate::Generate(const ge::AscGraph &origin_graph, const ge::AscGraph &based_case,
...
bool LoadToNddmaTemplate::NeedDropBasedCase(const ge::AscGraph &origin_graph, const ge::AscGraph &based_case,
