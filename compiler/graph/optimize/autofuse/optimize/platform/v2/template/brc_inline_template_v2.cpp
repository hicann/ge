 ...
 */
ge::Status BrcInlineTemplateV2::Generate(const ge::AscGraph &origin_graph, const ge::AscGraph &based_case,
...
bool BrcInlineTemplateV2::NeedDropBasedCase(const ge::AscGraph &origin_graph, const ge::AscGraph &based_case,
