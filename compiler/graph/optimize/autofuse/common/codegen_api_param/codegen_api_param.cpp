...
ge::Status CodegenApiParam::Register(ge::AscNodePtr node, CodegenApiParamPtr api_param) {
...
CodegenApiParamPtr CodegenApiParam::GetNodeApiParam(ge::AscNodePtr node) {
  auto op_desc = node->GetOpDesc();
  GE_ASSERT_NOTNULL(op_desc);
