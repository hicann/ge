...
#ifndef SPLIT_FUSION_STRATEGY_H
#define SPLIT_FUSION_STRATEGY_H

#include "can_fuse/strategy/fusion_strategy.h"
namespace ge {
class SplitFusionStrategy : public FusionStrategy {
public:
  SplitFusionStrategy() = default;

  ~SplitFusionStrategy() override = default;

  SplitFusionStrategy(const SplitFusionStrategy &) = delete;
  SplitFusionStrategy &operator=(const SplitFusionStrategy &) = delete;
