...
HcclResult DlHcclFunction::initHcclGraphModeFunctions() {
  // 图模式相关函数
  dlHcclCreateOpParamGraphModeFunc =
      (HcclResult (*)(OpParamGraphModePtr *opParam))dlsym(dl_hccl_handle, "HcclCreateOpParamGraphMode");
  ...
  dlHcclDestroyOpParamGraphModeFunc =
      (HcclResult (*)(OpParamGraphModePtr opParam))dlsym(dl_hccl_handle, "HcclDestroyOpParamGraphMode");
  ...
  dlHcclSetOpParamGraphModeOpTypeFunc = (HcclResult (*)(OpParamGraphModePtr opParam, const char *opType))dlsym(
      dl_hccl_handle, "HcclSetOpParamGraphModeOpType");
  ...
  dlHcclSetOpParamGraphModeDataCountFunc = (HcclResult (*)(OpParamGraphModePtr opParam, const u64 *count))dlsym(
      dl_hccl_handle, "HcclSetOpParamGraphModeDataCount");
  ...
  dlHcclSetOpParamGraphModeRankSizeFunc = (HcclResult (*)(OpParamGraphModePtr opParam, const u32 *rankSize))dlsym(
      dl_hccl_handle, "HcclSetOpParamGraphModeRankSize");
  ...
  dlHcclSetOpParamGraphModeHCCLBufferSizeFunc =
      (HcclResult (*)(OpParamGraphModePtr opParam, const u64 *cclBufferSize))dlsym(
          dl_hccl_handle, "HcclSetOpParamGraphModeHCCLBufferSize");
  CHK_PRT_RET(dlHcclSetOpParamGraphModeHCCLBufferSizeFunc == nullptr,
              HCCL_RUN_WARNING("[DlHcclFunction]load HcclSetOpParamGraphModeHCCLBufferSize function fail."),
              HCCL_E_PTR);

  dlHcclSetOpParamGraphModeDataTypeFunc =
      (HcclResult (*)(OpParamGraphModePtr opParam, const HcclDataType dataType))dlsym(
          dl_hccl_handle, "HcclSetOpParamGraphModeDataType");
  ...
  dlHcclSetAivSelectOpParamGraphModeFunc = (HcclResult (*)(OpParamGraphModePtr opParam, u32 aivCoreLimit))dlsym(
      dl_hccl_handle, "HcclSetAivSelectOpParamGraphMode");
  ...
  dlHcclCalcOpResOfflineGraphModeFunc =
      (HcclResult (*)(OpParamGraphModePtr opParam, u64 *opMemSize, u32 *streamNum, u32 *taskNum, u32 *aivCoreNum))dlsym(
          dl_hccl_handle, "HcclCalcOpResOfflineGraphMode");
  ...
  dlHcclCalcOpResOnlineGraphModeFunc =
      (HcclResult (*)(OpParamGraphModePtr opParam, u64 *opMemSize, u32 *streamNum, u32 *taskNum, u32 *aivCoreNum))dlsym(
          dl_hccl_handle, "HcclCalcOpResOnlineGraphMode");
  ...
  dlHcclAllGatherGraphModeFunc =
      (HcclResult (*)(void *sendBuf, void *recvBuf, uint64_t count, HcclDataType dataType, const char *group,
                      void *stream, const char *tag, void **streams, size_t streamCount, void *scratchMemAddr,
                      uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclAllGatherGraphMode");
  ...
  dlHcclBroadcastGraphModeFunc =
      (HcclResult (*)(void *sendBuf, uint64_t count, HcclDataType dataType, uint32_t root, const char *group,
                      void *stream, const char *tag, void **streams, size_t streamCount, void *scratchMemAddr,
                      uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclBroadcastGraphMode");
  ...
  dlHcclReduceScatterVGraphModeFunc =
      (HcclResult (*)(void *sendBuf, const void *sendCounts, const void *sendDispls, void *recvBuf, uint64_t recvCount,
                      HcclDataType dataType, HcclReduceOp reduceOp, const char *group, void *stream, const char *tag,
                      void **streams, size_t streamCount, void *scratchMemAddr,
                      uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclReduceScatterVGraphMode");
  ...
  dlHcclAllGatherVGraphModeFunc = (HcclResult (*)(
      void *sendBuf, void *recvBuf, uint64_t sendCount, const void *recvCounts, const void *recvDispls,
      HcclDataType dataType, const char *group, void *stream, const char *tag, void **streams, size_t streamCount,
  ...
  dlHcclAlltoAllGraphModeFunc = (HcclResult (*)(
      const void *sendBuf, uint64_t sendCount, HcclDataType sendType, const void *recvBuf, uint64_t recvCount,
      HcclDataType recvType, const char *group, void *stream, const char *tag, void **streams, size_t streamCount,
  ...
  dlHcclAlltoAllVGraphModeFunc =
      (HcclResult (*)(const void *sendBuf, const void *sendCounts, const void *sendDispls, HcclDataType sendType,
                      const void *recvBuf, const void *recvCounts, const void *recvDispls, HcclDataType recvType,
                      const char *group, void *stream, const char *tag, void **streams, size_t streamCount,
                      void *scratchMemAddr, uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclAlltoAllVGraphMode");
  ...
  dlHcclAlltoAllVCGraphModeFunc = (HcclResult (*)(
      const void *sendBuf, const void *sendCountMatrix, HcclDataType sendType, const void *recvBuf,
      HcclDataType recvType, const char *group, void *stream, const char *tag, void **streams, size_t streamCount,
      void *scratchMemAddr, uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclAlltoAllVCGraphMode");
  ...
  dlHcclSendGraphModeFunc =
      (HcclResult (*)(void *sendBuf, uint64_t count, HcclDataType dataType, uint32_t destRank, const char *group,
                      void *stream, const char *tag, void **streams, size_t streamCount, void *scratchMemAddr,
                      uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclSendGraphMode");
  ...
  dlHcclRecvGraphModeFunc =
      (HcclResult (*)(void *recvBuf, uint64_t count, HcclDataType dataType, uint32_t srcRank, const char *group,
                      void *stream, const char *tag, void **streams, size_t streamCount, void *scratchMemAddr,
                      uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclRecvGraphMode");
  ...
  dlHcclAllReduceGraphModeFunc =
      (HcclResult (*)(void *sendBuf, void *recvBuf, uint64_t count, HcclDataType dataType, HcclReduceOp reduceOp,
                      const char *group, void *stream, const char *tag, void **streams, size_t streamCount,
                      void *scratchMemAddr, uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclAllReduceGraphMode");
  ...
  dlHcclReduceScatterGraphModeFunc = (HcclResult (*)(
      void *sendBuf, void *recvBuf, uint64_t count, HcclDataType dataType, HcclReduceOp reduceOp, const char *group,
      void *stream, const char *tag, void **streams, size_t streamCount, void *scratchMemAddr,
      uint64_t scratchMemSize))dlsym(dl_hccl_handle, "HcclReduceScatterGraphMode");
  ...
  dlHcclSetAivCoreLimitGraphModeFunc =
      (HcclResult (*)(const char *group, u32 aivCoreLimit))dlsym(dl_hccl_handle, "HcclSetAivCoreLimitGraphMode");
  ...
  dlHcclGetAlgExecParamGraphModeFunc =
      (HcclResult (*)(const char *tag, const char *group, u64 count, void *inputPtr, void *outputPtr,
                      HcclCMDType opType, bool clearEnable, HcclDataType dataType, HcclReduceOp op, void **commContext,
                      u64 *len, u32 aivCoreLimit))dlsym(dl_hccl_handle, "HcclGetAlgExecParamGraphMode");
...
HcclResult DlHcclFunction::dlHcclSetOpParamGraphModeHCCLBufferSize(OpParamGraphModePtr opParam,
                                                                   const u64 *hcclBufferSize) {
...
HcclResult DlHcclFunction::dlHcclCalcOpResOfflineGraphMode(OpParamGraphModePtr opParam, u64 *opMemSize, u32 *streamNum,
                                                           u32 *taskNum, u32 *aivCoreNum) {
  return dlHcclCalcOpResOfflineGraphModeFunc(opParam, opMemSize, streamNum, taskNum, aivCoreNum);
}

HcclResult DlHcclFunction::dlHcclCalcOpResOnlineGraphMode(OpParamGraphModePtr opParam, u64 *opMemSize, u32 *streamNum,
                                                          u32 *taskNum, u32 *aivCoreNum) {
  return dlHcclCalcOpResOnlineGraphModeFunc(opParam, opMemSize, streamNum, taskNum, aivCoreNum);
}

HcclResult DlHcclFunction::dlHcclAllGatherGraphMode(void *sendBuf, void *recvBuf, uint64_t sendCount,
                                                    HcclDataType dataType, const char *group, void *stream,
                                                    const char *optag, void **streams, size_t streamCount,
                                                    void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclAllGatherGraphModeFunc(sendBuf, recvBuf, sendCount, dataType, group, stream, optag, streams, streamCount,
                                      scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclBroadcastGraphMode(void *buf, uint64_t count, HcclDataType dataType, uint32_t root,
                                                    const char *group, void *stream, const char *optag, void **streams,
                                                    size_t streamCount, void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclBroadcastGraphModeFunc(buf, count, dataType, root, group, stream, optag, streams, streamCount,
                                      scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclReduceScatterVGraphMode(void *sendBuf, const void *sendCounts, const void *sendDispls,
                                                         void *recvBuf, uint64_t recvCount, HcclDataType dataType,
                                                         HcclReduceOp op, const char *group, void *stream,
                                                         const char *optag, void **streams, size_t streamCount,
                                                         void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclReduceScatterVGraphModeFunc(sendBuf, sendCounts, sendDispls, recvBuf, recvCount, dataType, op, group,
                                           stream, optag, streams, streamCount, scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclAllGatherVGraphMode(void *sendBuf, void *recvBuf, uint64_t sendCount,
                                                     const void *recvCounts, const void *recvDispls,
                                                     HcclDataType dataType, const char *group, void *stream,
                                                     const char *optag, void **streams, size_t streamCount,
                                                     void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclAllGatherVGraphModeFunc(sendBuf, recvBuf, sendCount, recvCounts, recvDispls, dataType, group, stream,
                                       optag, streams, streamCount, scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclAlltoAllGraphMode(const void *sendBuf, uint64_t sendCount, HcclDataType sendType,
                                                   const void *recvBuf, uint64_t recvCount, HcclDataType recvType,
                                                   const char *group, void *stream, const char *optag, void **streams,
                                                   size_t streamCount, void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclAlltoAllGraphModeFunc(sendBuf, sendCount, sendType, recvBuf, recvCount, recvType, group, stream, optag,
                                     streams, streamCount, scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclAlltoAllVGraphMode(const void *sendBuf, const void *sendCounts, const void *sdispls,
                                                    HcclDataType sendType, const void *recvBuf, const void *recvCounts,
                                                    const void *rdispls, HcclDataType recvType, const char *group,
...
HcclResult DlHcclFunction::dlHcclAlltoAllVCGraphMode(const void *sendBuf, const void *sendCountMatrix,
  ...
  return dlHcclAlltoAllVCGraphModeFunc(sendBuf, sendCountMatrix, sendType, recvBuf, recvType, group, stream, optag,
                                       streams, streamCount, scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclSendGraphMode(void *sendBuf, uint64_t count, HcclDataType dataType, uint32_t destRank,
                                               const char *group, void *stream, const char *tag, void **streams,
                                               size_t streamCount, void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclSendGraphModeFunc(sendBuf, count, dataType, destRank, group, stream, tag, streams, streamCount,
                                 scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclRecvGraphMode(void *recvBuf, uint64_t count, HcclDataType dataType, uint32_t srcRank,
                                               const char *group, void *stream, const char *tag, void **streams,
                                               size_t streamCount, void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclRecvGraphModeFunc(recvBuf, count, dataType, srcRank, group, stream, tag, streams, streamCount,
                                 scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclAllReduceGraphMode(void *sendBuf, void *recvBuf, uint64_t sendCount,
                                                    HcclDataType dataType, HcclReduceOp op, const char *group,
                                                    void *stream, const char *optag, void **streams, size_t streamCount,
                                                    void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclAllReduceGraphModeFunc(sendBuf, recvBuf, sendCount, dataType, op, group, stream, optag, streams,
                                      streamCount, scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclReduceGraphMode(void *sendBuf, void *recvBuf, uint64_t count, HcclDataType dataType,
                                                 HcclReduceOp op, uint32_t root, const char *group, void *stream,
                                                 const char *optag, void **streams, size_t streamCount,
                                                 void *scratchMemAddr, uint64_t scratchMemSize) {
  return dlHcclReduceGraphModeFunc(sendBuf, recvBuf, count, dataType, op, root, group, stream, optag, streams,
                                   streamCount, scratchMemAddr, scratchMemSize);
}

HcclResult DlHcclFunction::dlHcclReduceScatterGraphMode(void *sendBuf, void *recvBuf, uint64_t recvCount,
                                                        HcclDataType dataType, HcclReduceOp op, const char *group,
                                                        void *stream, const char *optag, void **streams,
                                                        size_t streamCount, void *scratchMemAddr,
                                                        uint64_t scratchMemSize) {
  return dlHcclReduceScatterGraphModeFunc(sendBuf, recvBuf, recvCount, dataType, op, group, stream, optag, streams,
                                          streamCount, scratchMemAddr, scratchMemSize);
}
...
HcclResult DlHcclFunction::dlHcclSelectAlgGraphMode(const char *group, u64 count, HcclDataType dataType,
                                                    HcclReduceOp op, HcclCMDType opType, int32_t aivCoreLimit,
...
HcclResult DlHcclFunction::dlHcclGetAlgExecParamGraphMode(const char *tag, const char *group, u64 count, void *inputPtr,
                                                          ...
                                                          HcclDataType dataType, HcclReduceOp op, void **commContext,
                                                          u64 *len, u32 aivCoreLimit) {
  return dlHcclGetAlgExecParamGraphModeFunc(tag, group, count, inputPtr, outputPtr, opType, clearEnable, dataType, op,
