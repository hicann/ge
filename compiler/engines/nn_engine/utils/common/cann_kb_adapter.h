...
using CannKbInitFunc = std::function<CannKb::CANN_KB_STATUS(const std::map<std::string, std::string> &,
                                                            const std::map<std::string, std::string> &)>;

using CannKbFinalizeFunc = std::function<CannKb::CANN_KB_STATUS()>;

using CannKbSearchFunc =
    std::function<CannKb::CANN_KB_STATUS(const std::string &, const std::map<std::string, std::string> &,
