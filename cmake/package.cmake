...
if("ge-compiler" IN_LIST BUILD_COMPONENT)
    ...
    install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/inc/external/ge/fusion/graph_rewriter.h
                  ...
                  ${CMAKE_CURRENT_SOURCE_DIR}/inc/external/ge/fusion/graph_fuse_inspector_utils.h
...
if("ge-executor" IN_LIST BUILD_COMPONENT)
    ...
    if(NOT MDC_COMPILE_RUNTIME)
        install(TARGETS ge_common ge_executor_shared ge_common_base davinci_executor hybrid_executor gert custom_op_runtime om2_executor
       ...
       # MDC 运行态编译
        install(TARGETS ge_common ge_common_base davinci_executor hybrid_executor gert custom_op_runtime register graph graph_base custom_op_registry_static acl_cblas hcom_executor
    ...
    install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/pkg_inc/register/amct_interface.h
                  ${CMAKE_CURRENT_SOURCE_DIR}/pkg_inc/register/amct_registry.h
