...
if (TARGET ascend_protobuf_build)
    return()
endif ()
...
if(ASCEND_PROTOBUF_SHARED_INCLUDE AND ASCEND_PROTOBUF_SHARED_LIBRARY)
    set(ascend_protobuf_shared_FOUND TRUE)
else()
    set(ascend_protobuf_shared_FOUND FALSE)
endif()
...
if(ascend_protobuf_shared_FOUND)
    ...
    elseif(EXISTS ${REQ_URL_BACK})
        ...
        list(APPEND PROTOBUF_EXTRA_ARGS
            DOWNLOAD_DIR ${CANN_3RD_LIB_PATH}/ascend_protobuf
        )
    endif()
    ...
    ExternalProject_Add(ascend_protobuf_build
                        ...
                        CONFIGURE_COMMAND ${CMAKE_COMMAND}
                            ...
                            -DCMAKE_INSTALL_PREFIX=${CANN_3RD_LIB_PATH}/ascend_protobuf
