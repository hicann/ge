...
FMK_FUNC_HOST_VISIBILITY FMK_FUNC_DEV_VISIBILITY ThreadPool::ThreadPool(uint32_t size) : ThreadPool("", size) {}

ThreadPool::ThreadPool(std::string thread_name_prefix, uint32_t size)
