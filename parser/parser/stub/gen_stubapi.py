...
"""
GE_ATTR = "GE_FUNC_DEV_VISIBILITY GE_FUNC_HOST_VISIBILITY PARSER_FUNC_VISIBILITY"
GE_ATTR_LIST = GE_ATTR.split(" ")
...
class H2CC(object):
    ...
    def implement_function(func):
        ...
        if return_type in GE_ATTR_LIST:
            start += 1
            return_type = all_items[start]
