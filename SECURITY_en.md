...
|  Dependency  | Not applicable  | cmake/third_party/json.cmake | https://gitcode.com/cann-src-third-party/json/releases/download/v3.12.0/include.zip | Download json source code from gitcode as build dependency |
