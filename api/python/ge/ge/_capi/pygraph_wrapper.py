...
graph_lib.GeApiWrapper_AttrValue_GetDataType.argtypes = [
    c_void_p,
...
graph_lib.GeApiWrapper_AttrValue_SetListString.argtypes = [
    c_void_p,
...
graph_lib.GeApiWrapper_AttrValue_SetListFloat.argtypes = [
    c_void_p,
...
graph_lib.GeApiWrapper_AttrValue_SetListBool.argtypes = [
    c_void_p,
...
graph_lib.GeApiWrapper_AttrValue_SetListInt.argtypes = [
    c_void_p,
    ctypes.POINTER(c_int64),
    c_int64,
]
...
graph_lib.GeApiWrapper_AttrValue_SetListDataType.argtypes = [
    c_void_p,
    ctypes.POINTER(c_int32),
    c_int64,
]
...
graph_lib.GeApiWrapper_Graph_GetDirectNode.argtypes = [
    c_void_p,
    ctypes.POINTER(c_size_t),
]

graph_lib.GeApiWrapper_Graph_RemoveEdge.restype = c_int
graph_lib.GeApiWrapper_Graph_RemoveEdge.argtypes = [
    c_void_p,
    c_void_p,
    c_int32,
    c_void_p,
...
graph_lib.GeApiWrapper_Graph_AddDataEdge.argtypes = [
    c_void_p,
    c_void_p,
    c_int32,
    c_void_p,
...
graph_lib.GeApiWrapper_Graph_FindNodeByName.argtypes = [
    c_void_p,
    c_char_p,
...
graph_lib.GeApiWrapper_Graph_GetAllSubgraphs.argtypes = [
    c_void_p,
    ctypes.POINTER(c_size_t),
]
...
graph_lib.GeApiWrapper_GNode_GetInControlNodes.argtypes = [
    c_void_p,
    ctypes.POINTER(c_size_t),
]

graph_lib.GeApiWrapper_GNode_GetInDataNodesAndPortIndexes.restype = c_int
graph_lib.GeApiWrapper_GNode_GetInDataNodesAndPortIndexes.argtypes = [
    c_void_p,
    c_int32,
    ctypes.POINTER(c_void_p),
    ctypes.POINTER(c_int32),
...
graph_lib.GeApiWrapper_GNode_GetOutDataNodesAndPortIndexes.argtypes = [
    c_void_p,
    c_int32,
    ctypes.POINTER(ctypes.POINTER(c_void_p)),
    ctypes.POINTER(ctypes.POINTER(c_int32)),
    ctypes.POINTER(c_int),
]

graph_lib.GeApiWrapper_GNode_GetOutControlNodes.restype = ctypes.POINTER(c_void_p)
graph_lib.GeApiWrapper_GNode_GetOutControlNodes.argtypes = [
    c_void_p,
    ctypes.POINTER(c_size_t),
]
...
graph_lib.GeApiWrapper_GNode_GetInputAttr.argtypes = [
    c_void_p,
    c_char_p,
    c_uint32,
    c_void_p,
...
graph_lib.GeApiWrapper_GNode_SetInputAttr.argtypes = [
    c_void_p,
    c_char_p,
    c_uint32,
    c_void_p,
...
graph_lib.GeApiWrapper_GNode_GetOutputAttr.argtypes = [
    c_void_p,
    c_char_p,
    c_uint32,
    c_void_p,
...
graph_lib.GeApiWrapper_GNode_SetOutputAttr.argtypes = [
    c_void_p,
    c_char_p,
    c_uint32,
    c_void_p,
...
graph_lib.GeApiWrapper_TensorDesc_Create.argtypes = [
    ctypes.POINTER(c_int64),
    c_size_t,
    c_int,
    c_int,
...
graph_lib.GeApiWrapper_TensorDesc_GetShape.argtypes = [
    c_void_p,
    ctypes.POINTER(ctypes.POINTER(c_int64)),
    ctypes.POINTER(c_size_t),
]

graph_lib.GeApiWrapper_TensorDesc_SetShape.restype = c_int
graph_lib.GeApiWrapper_TensorDesc_SetShape.argtypes = [
    c_void_p,
    ctypes.POINTER(c_int64),
    c_size_t,
]
...
graph_lib.GeApiWrapper_TensorDesc_GetOriginShape.argtypes = [
    c_void_p,
    ctypes.POINTER(ctypes.POINTER(c_int64)),
    ctypes.POINTER(c_size_t),
]
...
graph_lib.GeApiWrapper_TensorDesc_SetOriginShape.argtypes = [
    c_void_p,
    ctypes.POINTER(c_int64),
    c_size_t,
]
...
graph_lib.GeApiWrapper_Tensor_GetShape.argtypes = [
    c_void_p,
    ctypes.POINTER(ctypes.POINTER(c_int64)),
    ctypes.POINTER(c_size_t),
]
