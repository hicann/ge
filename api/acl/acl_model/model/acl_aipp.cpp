...
static aclError CheckAippDataIndex(const uint32_t modelId, const size_t idx, const aclmdlDesc *const modelDesc)
{
    ...
    if (type == ge::DYNAMIC_AIPP_NODE) {
        ...
        const auto mdlRet = aclmdlGetInputIndexByNameImpl(modelDesc, ACL_DYNAMIC_AIPP_NAME, &indexInModel);
        if (mdlRet != ACL_SUCCESS) {
...
aclmdlAIPP *aclmdlCreateAIPPImpl(uint64_t batchSize)
{
...
aclError aclmdlDestroyAIPPImpl(const aclmdlAIPP *aippParmsSet)
{
...
aclError aclmdlGetAippDataSizeImpl(uint64_t batchSize, size_t *size)
{
...
aclError aclmdlSetAIPPInputFormatImpl(aclmdlAIPP *aippParmsSet, aclAippInputFormat inputFormat)
{
...
aclError aclmdlSetAIPPCscParamsImpl(aclmdlAIPP *aippParmsSet, int8_t cscSwitch,
...
aclError aclmdlSetAIPPRbuvSwapSwitchImpl(aclmdlAIPP *aippParmsSet, int8_t rbuvSwapSwitch)
{
...
aclError aclmdlSetAIPPAxSwapSwitchImpl(aclmdlAIPP *aippParmsSet, int8_t axSwapSwitch)
{
...
aclError aclmdlSetAIPPSrcImageSizeImpl(aclmdlAIPP *aippParmsSet, int32_t srcImageSizeW, int32_t srcImageSizeH)
{
...
aclError aclmdlSetAIPPScfParamsImpl(aclmdlAIPP *aippParmsSet, int8_t scfSwitch,
...
aclError aclmdlSetAIPPCropParamsImpl(aclmdlAIPP *aippParmsSet, int8_t cropSwitch,
...
aclError aclmdlSetAIPPPaddingParamsImpl(aclmdlAIPP *aippParmsSet, int8_t paddingSwitch,
...
aclError aclmdlSetAIPPDtcPixelMeanImpl(aclmdlAIPP *aippParmsSet,
...
aclError aclmdlSetAIPPDtcPixelMinImpl(aclmdlAIPP *aippParmsSet,
...
aclError aclmdlSetAIPPPixelVarReciImpl(aclmdlAIPP *aippParmsSet,
                            ...
                            const aclmdlAIPP *aippParmsSet)
{
    ...
    const aclDataBuffer *const buff = aclmdlGetDatasetBufferImpl(dataset, index);
    if (buff == nullptr) {
