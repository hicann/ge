...
ACL_FUNC_VISIBILITY aclError aclmdlSetDatasetTensorDescImpl(aclmdlDataset *dataset, aclTensorDesc *tensorDesc,
                                                            size_t index);
...
ACL_FUNC_VISIBILITY aclError aclmdlLoadFromFileWithMemImpl(const char *modelPath, uint32_t *modelId, void *workPtr,
                                                           size_t workSize, void *weightPtr, size_t weightSize);

ACL_FUNC_VISIBILITY aclError aclmdlLoadFromMemWithMemImpl(const void *model, size_t modelSize, uint32_t *modelId,
                                                          void *workPtr, size_t workSize, void *weightPtr,
                                                          size_t weightSize);

ACL_FUNC_VISIBILITY aclError aclmdlLoadFromFileWithQImpl(const char *modelPath, uint32_t *modelId,
...
ACL_FUNC_VISIBILITY aclError aclmdlExecuteAsyncV2Impl(uint32_t modelId, const aclmdlDataset *input,
                                                      aclmdlDataset *output, aclrtStream stream,
                                                      const aclmdlExecConfigHandle *handle);

ACL_FUNC_VISIBILITY aclError aclmdlExecuteAsyncImpl(uint32_t modelId, const aclmdlDataset *input, aclmdlDataset *output,
                                                    aclrtStream stream);
...
ACL_FUNC_VISIBILITY aclError aclmdlSetInputAIPPImpl(uint32_t modelId, aclmdlDataset *dataset, size_t index,
                                                    const aclmdlAIPP *aippParmsSet);

ACL_FUNC_VISIBILITY aclError aclmdlSetAIPPByInputIndexImpl(uint32_t modelId, aclmdlDataset *dataset, size_t index,
                                                           const aclmdlAIPP *aippParmsSet);

ACL_FUNC_VISIBILITY aclError aclmdlGetAippTypeImpl(uint32_t modelId, size_t index, aclmdlInputAippType *type,
...
ACL_FUNC_VISIBILITY aclError aclmdlCreateAndGetOpDescImpl(uint32_t deviceId, uint32_t streamId, uint32_t taskId,
