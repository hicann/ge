...
#include "acl_cblas_prof_api_reg.h"
#include <mutex>
...
namespace {
    ...
    static const std::map<acl::AclCblasProfType, std::string> CBLAS_PROF_TYPE_TO_NAMES = {
        {acl::AclCblasProfType::AclblasGemmEx,                            "aclblasGemmEx"},
        {acl::AclCblasProfType::AclblasCreateHandleForGemmEx,             "aclblasCreateHandleForGemmEx"},
        {acl::AclCblasProfType::AclblasCreateHandleForHgemm,              "aclblasCreateHandleForHgemm"},
        {acl::AclCblasProfType::AclblasHgemm,                             "aclblasHgemm"},
        {acl::AclCblasProfType::AclblasS8gemm,                            "aclblasS8gemm"},
        {acl::AclCblasProfType::AclblasCreateHandleForS8gemm,             "aclblasCreateHandleForS8gemm"},
        {acl::AclCblasProfType::AclblasGemvEx,                            "aclblasGemvEx"},
        {acl::AclCblasProfType::AclblasCreateHandleForGemvEx,             "aclblasCreateHandleForGemvEx"},
        {acl::AclCblasProfType::AclblasHgemv,                             "aclblasHgemv"},
        {acl::AclCblasProfType::AclblasCreateHandleForHgemv,              "aclblasCreateHandleForHgemv"},
        {acl::AclCblasProfType::AclblasCreateHandleForS8gemv,             "aclblasCreateHandleForS8gemv"},
        {acl::AclCblasProfType::AclblasS8gemv,                            "aclblasS8gemv"},
    };

    static aclError RegisterProfType() {
        for (auto &iter : CBLAS_PROF_TYPE_TO_NAMES) {
...
namespace acl {
    ...
    AclCblasProfilingReporter::AclCblasProfilingReporter(const AclCblasProfType apiId) : aclApi_(apiId)
    {
    ...
    AclCblasProfilingReporter::~AclCblasProfilingReporter() noexcept
    {
