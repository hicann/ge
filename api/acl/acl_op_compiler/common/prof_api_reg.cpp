...
namespace {
    ...
    static const std::map<acl::AclOpCompileProfType, std::string> OP_COMPILE_PROF_TYPE_TO_NAMES = {
        {acl::AclOpCompileProfType::AclopCompile,                             "aclopCompile"},
        {acl::AclOpCompileProfType::AclopCompileAndExecute,                   "aclopCompileAndExecute"},
        {acl::AclOpCompileProfType::AclopCompileAndExecuteV2,                 "aclopCompileAndExecuteV2"},
        {acl::AclOpCompileProfType::AclGenGraphAndDumpForOp,                  "aclGenGraphAndDumpForOp"},
        {acl::AclOpCompileProfType::OpCompile,                                "opCompile"},
        {acl::AclOpCompileProfType::OpCompileAndDump,                         "opCompileAndDump"},
    };

    static aclError RegisterProfType() {
        for (auto &iter : OP_COMPILE_PROF_TYPE_TO_NAMES) {
...
namespace acl {
    ...
    AclOpCompilerProfilingReporter::AclOpCompilerProfilingReporter(const AclOpCompileProfType apiId) : aclApi_(apiId)
    {
    ...
    AclOpCompilerProfilingReporter::~AclOpCompilerProfilingReporter() noexcept
    {
