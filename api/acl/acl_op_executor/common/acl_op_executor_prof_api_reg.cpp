...
#include "acl_op_executor_prof_api_reg.h"
#include <mutex>
...
namespace {
    ...
    static const std::map<acl::AclOpExecProfType, std::string> OP_EXEC_PROF_TYPE_TO_NAMES = {
        {acl::AclOpExecProfType::AclopLoad,                                "aclopLoad"},
        {acl::AclOpExecProfType::AclopExecute,                             "aclopExecute"},
        {acl::AclOpExecProfType::AclopCreateHandle,                        "aclopCreateHandle"},
        {acl::AclOpExecProfType::AclopDestroyHandle,                       "aclopDestroyHandle"},
        {acl::AclOpExecProfType::AclopExecWithHandle,                      "aclopExecWithHandle"},
        {acl::AclOpExecProfType::AclopExecuteV2,                           "aclopExecuteV2"},
        {acl::AclOpExecProfType::AclopCreateKernel,                        "aclopCreateKernel"},
        {acl::AclOpExecProfType::AclopUpdateParams,                        "aclopUpdateParams"},
        {acl::AclOpExecProfType::AclopInferShape,                          "aclopInferShape"},
        {acl::AclOpExecProfType::AclopCast,                                "aclopCast"},
        {acl::AclOpExecProfType::AclopCreateHandleForCast,                 "aclopCreateHandleForCast"},
        {acl::AclOpExecProfType::AclopCreateAttr,                          "aclopCreateAttr"},
        {acl::AclOpExecProfType::AclopDestroyAttr,                         "aclopDestroyAttr"},
    };

    static aclError RegisterProfType() {
        for (auto &iter : OP_EXEC_PROF_TYPE_TO_NAMES) {
...
namespace acl {
    ...
    AclOpExecProfilingReporter::AclOpExecProfilingReporter(const AclOpExecProfType apiId) : aclApi_(apiId)
    {
    ...
    AclOpExecProfilingReporter::~AclOpExecProfilingReporter() noexcept
    {
