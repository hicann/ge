...
graphStatus Node::NodeImpl::AddLinkFrom(const uint32_t &index, const ge::Node::NodePtr &input_node,
                                        const uint32_t &input_node_index, const ge::Node::NodePtr &owner_node) {
  GE_CHECK_NOTNULL(input_node);
  // Input_node ---> this
  auto out_anchors = input_node->GetAllOutDataAnchors();
