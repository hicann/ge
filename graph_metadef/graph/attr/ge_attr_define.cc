...
const std::string ATTR_NAME_WEIGHT_SHA256 = "_value_sha256";
...
const std::string ATTR_NAME_ATOMIC_MEMSET_SIZES = "sizes";
const std::string ATTR_NAME_ATOMIC_MEMSET_DTYPES = "dtypes";
const std::string ATTR_NAME_ATOMIC_MEMSET_VALUES_INT = "values_int";
...
const std::string ATTR_NAME_INIT_VALUE = "_init_value";
...
const std::string ATTR_MODEL_ATTR_VALUE_ENUM = "attr_value_enum";

const std::string ATTR_MODEL_ATTRS_USE_STRING_VALUE = "attrs_use_string_value";
...
const std::string ATTR_NAME_OUTPUT_MEMORY_SCOPE = "_output_memory_scope";
const std::string ATTR_NAME_TENSOR_MEMORY_SCOPE = "_tensor_memory_scope";
...
const std::string ATTR_NAME_RESHAPE_TYPE_MASK = "_reshape_type_mask";
...
const std::string ATTR_NAME_CUSTOM_TASK_ARGS_MODE = "_custom_task_args_mode";
...
const std::string ATTR_NAME_IS_OP_GENERALIZED = "_is_op_generalized";
...
const std::string ATTR_NAME_BLOCKING_OP_TIMEOUT = "_blocking_op_timeout";
...
const std::string ATTR_NAME_REDUNDANT_DEPLOY_DEVICE_ID = "_redundant_device_id";
...
const std::string ATTR_NAME_FLOW_ATTR_IO_PLACEMENT = "_flow_attr_io_placement";
...
const std::string ATTR_NAME_NEED_GENTASK_ATOMIC = "need_gentask_atomic";
...
const std::string ATTR_NAME_REDUNDANT_LOGIC_DEV_ID = "_redundant_logic_device_id";
...
const std::string ATTR_NAME_DISABLE_ATTACHED_RESOURCE = "_disable_attached_resource";
...
const std::string ATTR_NAME_ATTACHED_NOTIFY_NUM = "_attached_notify_num";
...
const std::string ATTR_NAME_ATTACHED_SYNC_RES_KEY = "_attached_sync_res_key";
const std::string ATTR_NAME_ATTACHED_STREAM_DEPEND_VALUE_LIST = "_attached_stream_depend_value_list";

// 由引擎归一打到op_desc上，类型为list_name_attr
const std::string ATTR_NAME_ATTACHED_STREAM_INFO_LIST = "_attached_stream_info_list";
const std::string ATTR_NAME_ATTACHED_SYNC_RES_INFO_LIST = "_attached_sync_res_info_list";
// 下面的属性是在ATTR_NAME_ATTACHED_STREAM_INFO_LIST跟ATTR_NAME_ATTACHED_SYNC_RES_INFO_LIST的属性内部，为name_attr类型，不要直接打在op_desc上
...
const std::string ATTR_NAME_ATTACHED_RESOURCE_FORCE_REUSE = "_attached_resource_force_reuse";
const std::string ATTR_NAME_ATTACHED_RESOURCE_DEPEND_VALUE_LIST_INT = "_attached_resource_depend_value_list_int";
const std::string ATTR_NAME_ATTACHED_RESOURCE_REQUIRED_FLAG = "_attached_resource_required_flag";
const std::string ATTR_NAME_ATTACHED_RESOURCE_ID = "_attached_resource_id";
const std::string ATTR_NAME_ATTACHED_RESOURCE_IS_VALID = "_attached_resource_is_valid";
// 仅针对ATTR_NAME_ATTACHED_SYNC_RES_INFO_LIST属性内部，标识event/notify类型，默认为event类型
const std::string ATTR_NAME_ATTACHED_RESOURCE_TYPE = "_attached_resource_type";

// skip prune
const std::string ATTR_NAME_SKIP_PRUNE_OPTIMIZE = "_force_skip_prune";
...
// for infer shape
const std::string ATTR_NAME_PRESET_OUTPUT_SHAPES = "_preset_output_shapes";

// session options
const std::string ATTR_NAME_SESSION_OPTIONS = "SessionOptions";

// graph options
const std::string ATTR_NAME_GRAPH_OPTIONS = "GraphOptions";
...
// 需要分档输入索引
const std::string ATTR_NAME_DYNAMIC_BATCH_UNKNOWN_DATA_INDEX = "_dynamic_batch_unknown_data_index";
// 分档中shape是-1的dim_index
const std::string ATTR_NAME_DYNAMIC_BATCH_UNKNOWN_DIM_INDEX = "_dynamic_batch_unknown_dim_index";

// for inplace ability
const std::string ATTR_NAME_OUTPUT_INPLACE_ABILITY = "_output_inplace_ability";

// for opp_kernel
const std::string ATTR_NAME_BINARY_SOURCE = "_opp_path";

const std::string ATTR_NAME_DO_NOT_CONSTANT_FOLDING = "_do_not_constant_folding";

// for super kernel
const std::string ATTR_NAME_SUPER_KERNEL_SCOPE = "_super_kernel_scope";
const std::string ATTR_NAME_SUPER_KERNEL_OPTIONS = "_super_kernel_options";
