...
| MatMul+Add fused to GEMM custom pass example (Python version, demonstrating `@pattern` expression syntax) | [README](1_fuse_matmul_add_pass/python/README.md) |
...
| PatternMatcherConfig feature usage (Python version, demonstrating `@pattern` expression syntax) | [README](3_fuse_matmul_add_pass_with_pattern_matcher_config/python/README.md) |
...
| Custom pass example for custom operators (Python version, demonstrating `@pattern` expression syntax) | [README](5_add_zero_pass_in_custom_op/python/README.md) |
