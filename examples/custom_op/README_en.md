...
| `pypto_add_custom` | PyPTO operator enters graph through Python custom operator | GE online execution (RT2 dynamic execution) | PyPTO | JIT warm-up compiled on main thread + in-process cache | Not involved | [README](./pypto_add_custom/README_en.md) |
