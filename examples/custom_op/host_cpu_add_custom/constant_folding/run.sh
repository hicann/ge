...
ES_CUSTOM_LIBRARY_PATH="${BUILD_DIR}/es_output/lib64/libes_custom.so"
...
if [[ ! -f "${ES_CUSTOM_LIBRARY_PATH}" ]]; then
  error "ES custom api library was not generated: ${ES_CUSTOM_LIBRARY_PATH}"
  exit 1
fi
